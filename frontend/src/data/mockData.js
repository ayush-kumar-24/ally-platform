...
export const MOCK_PLANS = [
  {
    ...
    features: [
      ...
      'Book a call · ₹300 / 15 min',
    ],
  },
  {
    id: 'basic', name: 'Basic', price: 199, mrp: 300, period: '/mo',
    tag: 'One diagnosis, one report, three clear next steps',
    popular: false, cta: 'Start Basic',
    features: [
  ...
  {
    id: 'starter', name: 'Starter', price: 450, mrp: 600, period: '/mo',
