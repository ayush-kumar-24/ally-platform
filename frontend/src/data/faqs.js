...
export const FAQS = [
  ...
  {
    q: 'How do plans work?',
    a: 'There are three: Starter (₹199, paid once), Plus (₹499/month) and Pro (₹999/month). All three include one adaptive diagnosis, your Clarity Report, voice in the diagnosis, and booking a discovery call at ₹300 per 30 minutes. Plus adds Talk to Ally (3,500 tokens a day), voice in chat, your Next Critical Steps, Set your Goals and Plan Your Day. Pro raises chat to 8,000 tokens a day and adds Ally recommending your steps, Build your Vision Board, working a framework with Ally, email reminders and priority call booking.',
