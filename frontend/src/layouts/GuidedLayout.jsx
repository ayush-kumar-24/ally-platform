...
export default function GuidedLayout() {
  ...
  // The shell's sizing lives in .guided-shell (platform.css), including why
  // its overflow-x is `clip` rather than `hidden` and why the profile chat --
  // and only the profile chat -- is capped to the viewport there.
  return (
