...
const Resume = lazy(() => import('./pages/guided/Resume'));
const Expectation = lazy(() => import('./pages/guided/Expectation'));
const Welcome = lazy(() => import('./pages/guided/Welcome'));
const AllyIntro = lazy(() => import('./pages/guided/AllyIntro'));
const ProfileBuild = lazy(() => import('./pages/guided/ProfileBuild'));
const Tour = lazy(() => import('./pages/guided/Tour'));
const Summary = lazy(() => import('./pages/guided/Summary'));
const Validate = lazy(() => import('./pages/guided/Validate'));
const Problem = lazy(() => import('./pages/guided/Problem'));
...
const KnowMyEnergy = lazy(() => import('./pages/KnowMyEnergy'));
