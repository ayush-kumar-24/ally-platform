...
class LLMNextQuestionAdvisor(NextQuestionAdvisor):
    ...
    def _build_request(self, answered_question, answer_text, shortlist, history,
        ...
        system = (
            ...
            "A WORKING THING WITH A CAVEAT IS STILL GREEN. Founders volunteer "
            "the limits of their own good practice -- it is what honest ones do "
            "-- and demoting them for it punishes exactly the behaviour this "
            "interview depends on. \"We have written prep lists and two cooks "
            "who can run a full service without me, though the dal still "
            "varies\" describes something that WORKS. Green. Ask whether the "
            "thing asked about is in good shape, not whether the answer "
            "contains any imperfection at all -- almost every true answer "
            "does.\n"
            ...
            "and still red. Green is for answers describing something that is "
            "actually working -- and when one does, give it green. This rule "
            "stops candour EARNING a good grade; it is not a reason to withhold "
            "one from a founder who is genuinely doing the thing well.\n"
