"""Framework Usage API dependencies."""
...
def get_framework_usage_service(db: Session = Depends(get_db)) -> FrameworkUsageService:
    return container.framework_usage_service(db)
