# -*- coding: utf-8 -*-
"""Batch 6 (industries 26-30, A-Z order). Nine problems per industry: one for each
...
# Batch 6, in the canonical A-Z order.
INDUSTRIES = [
    ("retail",             "RTL", "Retail (offline & online)"),
    ("sports_fitness",     "SPF", "Sports, Fitness & Wellness"),
    ("telecom",            "TEL", "Telecommunications"),
    ("textiles",           "TXT", "Textiles"),
    ("transport_delivery", "DLV", "Transportation & Delivery"),
]
