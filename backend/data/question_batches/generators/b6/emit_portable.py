# -*- coding: utf-8 -*-
"""Batch 6, emitted with NO hardcoded ids.
...
from i26_retail import RETAIL
from i27_fitness import FITNESS
from i28_telecom import TELECOM
from i29_textiles import TEXTILES
from i30_delivery import DELIVERY

CONTENT = {"retail": RETAIL, "sports_fitness": FITNESS, "telecom": TELECOM,
           "textiles": TEXTILES, "transport_delivery": DELIVERY}
...
path = os.path.join(B, "ally_batch6_PORTABLE_no_ids.sql")
open(path, "w").write("\n".join(out) + "\n")
print("written:", path)
