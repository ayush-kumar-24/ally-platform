# -*- coding: utf-8 -*-
"""Batch 4 (industries 16-20, A-Z order). Nine problems per industry: one for each
...
# Batch 4, in the canonical A-Z order.
INDUSTRIES = [
    ("hrtech",              "HRT", "Human Resources & HRTech"),
    ("trade_import_export", "TRD", "Import / Export & Trade"),
    ("manufacturing",       "MFG", "Industrial & Manufacturing"),
    ("saas",                "SAS", "Information Technology & Software (SaaS)"),
    ("legaltech",           "LGL", "Legal & LegalTech"),
]
