# -*- coding: utf-8 -*-
"""Batch 4, emitted with NO hardcoded ids.
...
from i16_hrtech import HRTECH
from i17_trade import TRADE
from i18_manufacturing import MANUFACTURING
from i19_saas import SAAS
from i20_legaltech import LEGALTECH

CONTENT = {"hrtech": HRTECH, "trade_import_export": TRADE, "manufacturing": MANUFACTURING,
           "saas": SAAS, "legaltech": LEGALTECH}
...
path = os.path.join(B, "ally_batch4_PORTABLE_no_ids.sql")
open(path, "w").write("\n".join(out) + "\n")
print("written:", path)
