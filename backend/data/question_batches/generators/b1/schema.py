# -*- coding: utf-8 -*-
"""Batch 1 (industries 1-5, A-Z order). Nine problems per industry: one for each
...
# Batch 1, in the canonical A-Z order.
INDUSTRIES = [
    ("agritech",             "AGR", "Agriculture & AgriTech"),
    ("automotive",           "AUT", "Automotive & Mobility"),
    ("fintech",              "BFS", "BFSI / FinTech"),
    ("beauty_personal_care", "BPC", "Beauty & Personal Care"),
    ("proptech",             "PRP", "Construction & Real Estate / PropTech"),
]
