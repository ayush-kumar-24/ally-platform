# -*- coding: utf-8 -*-
"""Batch 2 (industries 6-10, A-Z order). Nine problems per industry: one for each
...
# Batch 2, in the canonical A-Z order.
INDUSTRIES = [
    ("consumer_electronics", "CEL", "Consumer Electronics"),
    ("ecommerce_d2c",        "ECM", "E-Commerce & D2C"),
    ("edtech",               "EDU", "Education & EdTech"),
    ("cleantech_energy",     "ENR", "Energy, CleanTech & Renewables"),
    ("media_entertainment",  "MED", "Entertainment & Media"),
]
