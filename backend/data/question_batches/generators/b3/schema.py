# -*- coding: utf-8 -*-
"""Batch 3 (industries 11-15, A-Z order). Nine problems per industry: one for each
...
# Batch 3, in the canonical A-Z order.
INDUSTRIES = [
    ("fashion_apparel",    "FSH", "Fashion & Apparel"),
    ("foodtech",           "FNB", "Food & Beverage / FoodTech"),
    ("gaming",             "GAM", "Gaming"),
    ("healthtech",         "HLT", "Healthcare & HealthTech / MedTech"),
    ("travel_hospitality", "TRV", "Hospitality, Travel & Tourism"),
]
