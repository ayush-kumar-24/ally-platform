# -*- coding: utf-8 -*-
"""Batch 3, emitted with NO hardcoded ids.
...
from i11_fashion import FASHION
from i12_foodtech import FOODTECH
from i13_gaming import GAMING
from i14_healthtech import HEALTHTECH
from i15_travel import TRAVEL

CONTENT = {"fashion_apparel": FASHION, "foodtech": FOODTECH, "gaming": GAMING,
           "healthtech": HEALTHTECH, "travel_hospitality": TRAVEL}
...
path = os.path.join(B, "ally_batch3_PORTABLE_no_ids.sql")
open(path, "w").write("\n".join(out) + "\n")
print("written:", path)
