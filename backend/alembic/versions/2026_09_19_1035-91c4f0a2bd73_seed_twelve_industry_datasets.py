"""seed eight industry diagnostic datasets
...
industry seed files, creates eight industry master rows, inserts the eight
...
('RC-AGR-019', 'AGR-005', 'No Paying Pilot Run Yet', 'Operational', 'No test has been run where farmers actually paid for the product.', 0.63, 'external', 'Stage 0→1'),
('RC-AGR-020', 'AGR-005', 'Free or Discounted Users Treated as Validated', 'Behavioural', 'Users who got the product free or cheap are being counted as proof of demand.', 0.65, 'external', 'Stage 0→1'),
('RC-AGR-021', 'AGR-005', 'No Plan to Test at Full Price', 'Strategic', 'There is no defined plan for when or how full pricing will actually be tested.', 0.62, 'external', 'Stage 0→1'),
('RC-AGR-022', 'AGR-005', 'Early Users May Not Represent Target Farmers', 'Knowledge', 'The farmers who tried the product so far may differ meaningfully from the real target customer.', 0.60, 'external', 'Stage 0→1'),
('RC-AGR-023', 'AGR-005', 'No Repeat-Usage Data Collected', 'Operational', 'There is no data on whether early users came back to use the product again on their own.', 0.60, 'external', 'Stage 0→1'),
('RC-AGR-024', 'AGR-006', 'No Real Distribution Partner Tested', 'Operational', 'No dealer, agent, or cooperative has actually been used to deliver the product.', 0.65, 'external', 'Stage 0→1'),
('RC-AGR-025', 'AGR-006', 'Assuming Digital-Only Reach', 'Strategic', 'The plan assumes farmers will be reached online, with no physical distribution component.', 0.63, 'external', 'Stage 0→1'),
('RC-AGR-026', 'AGR-006', 'Distribution Costs Not Accounted For', 'Operational', 'The real cost of paying a field agent or dealer to reach one farmer has not been calculated.', 0.62, 'external', 'Stage 0→1'),
('RC-AGR-027', 'AGR-006', 'Time-to-Reach New Areas Untested', 'Operational', 'There is no real measurement of how long it takes to enter and reach a brand-new village or area.', 0.60, 'external', 'Stage 0→1'),
('RC-AGR-028', 'AGR-007', 'Pricing Modeled on Monthly Billing', 'Strategic', 'Pricing follows a standard monthly billing pattern that does not match harvest-linked income.', 0.63, 'external', 'Stage 0→1'),
('RC-AGR-029', 'AGR-007', 'No Deferred Payment Option Tested', 'Operational', 'Letting farmers pay after harvest, rather than upfront, has not been tried.', 0.62, 'external', 'Stage 0→1'),
('RC-AGR-030', 'AGR-007', 'Real Disposable Farmer Income Not Estimated', 'Knowledge', 'The amount of cash a farmer actually has left after paying for inputs has not been calculated.', 0.63, 'external', 'Stage 0→1'),
('RC-AGR-031', 'AGR-007', 'No Comparison Against Current Alternatives', 'Knowledge', 'There is no comparison between this price and what farmers currently spend on alternatives.', 0.60, 'external', 'Stage 0→1'),
('RC-AGR-032', 'AGR-007', 'Price Sensitivity Assumed Uniform', 'Strategic', 'The plan assumes all farmer income levels respond to price the same way.', 0.58, 'external', 'Stage 0→1'),
('RC-AGR-033', 'AGR-008', 'No FPO Relationship Tested in Practice', 'Operational', 'No actual working relationship with a farmer cooperative or FPO has been tested.', 0.63, 'external', 'Stage 0→1'),
('RC-AGR-034', 'AGR-008', 'Aggregator Assumed to Represent Farmers Reliably', 'Knowledge', 'It is assumed the cooperative genuinely represents farmer interests, without confirming this.', 0.60, 'external', 'Stage 0→1'),
('RC-AGR-035', 'AGR-008', 'No Backup Plan if Aggregator Relationship Fails', 'Strategic', 'There is no plan for what happens if the cooperative or aggregator partnership ends.', 0.62, 'external', 'Stage 0→1'),
('RC-AGR-036', 'AGR-008', 'Aggregator Incentives Not Understood', 'Knowledge', 'What the aggregator itself gains from this relationship has not been examined.', 0.60, 'external', 'Stage 0→1'),
('RC-AGR-037', 'AGR-009', 'Only Tested in One Region or Crop', 'Operational', 'Validation has only happened in one region, soil type, or crop so far.', 0.63, 'external', 'Stage 0→1'),
('RC-AGR-038', 'AGR-009', 'No Second-Region Test Planned', 'Strategic', 'There is no plan to validate in a second, different region before scaling.', 0.62, 'external', 'Stage 0→1'),
('RC-AGR-039', 'AGR-009', 'Regional Practice Differences Not Researched', 'Knowledge', 'Differences in farming practice or belief in other target regions have not been researched.', 0.60, 'external', 'Stage 0→1'),
('RC-AGR-040', 'AGR-009', 'Infrastructure Assumed Similar Elsewhere', 'Strategic', 'It is assumed logistics and infrastructure will be similar in every region the business expands to.', 0.60, 'external', 'Stage 0→1'),
('RC-AGR-041', 'AGR-010', 'No Repeatable Regional Playbook', 'Operational', 'There is no documented, repeatable process for setting up distribution in a new region.', 0.65, 'external', 'Stage 1→10+'),
('RC-AGR-042', 'AGR-010', 'Dealer Performance Not Tracked Centrally', 'Operational', 'Dealer performance is managed independently per region with no central visibility.', 0.63, 'external', 'Stage 1→10+'),
('RC-AGR-043', 'AGR-010', 'No Regional Owner Structure', 'Operational', 'No specific person is accountable for distribution performance in each region.', 0.62, 'external', 'Stage 1→10+'),
('RC-AGR-044', 'AGR-010', 'Inconsistent Dealer Incentives', 'Operational', 'Dealer incentive structures vary region to region rather than following one design.', 0.60, 'external', 'Stage 1→10+'),
('RC-AGR-045', 'AGR-010', 'Quality Control Degrading With Growth', 'Operational', 'Product or service quality is becoming harder to maintain consistently as the network expands.', 0.63, 'external', 'Stage 1→10+'),
('RC-AGR-046', 'AGR-011', 'No Credit-Risk Scoring Model', 'Knowledge', 'There is no systematic way to assess which farmers are higher risk for credit or financing default.', 0.68, 'external', 'Stage 1→10+'),
('RC-AGR-047', 'AGR-011', 'Default Rates Not Tracked', 'Operational', 'The actual rate of loan or financing default is not being systematically measured.', 0.65, 'external', 'Stage 1→10+'),
('RC-AGR-048', 'AGR-011', 'Lending Decisions Relationship-Based', 'Behavioural', 'Credit decisions are made based on personal trust rather than consistent data criteria.', 0.63, 'external', 'Stage 1→10+'),
('RC-AGR-049', 'AGR-011', 'No Bad-Debt Reserve', 'Strategic', 'No financial reserve has been set aside to absorb expected credit losses.', 0.65, 'external', 'Stage 1→10+'),
('RC-AGR-050', 'AGR-011', 'Growth Outpacing Risk Capacity', 'Strategic', 'Credit or financing volume is growing faster than the team''s ability to manage that risk.', 0.63, 'external', 'Stage 1→10+'),
('RC-AGR-051', 'AGR-012', 'No Compliance Mapping Before Expansion', 'Operational', 'New markets or products are entered without first mapping the compliance requirements involved.', 0.65, 'external', 'Stage 1→10+'),
('RC-AGR-052', 'AGR-012', 'Certification Requirements Not Understood', 'Knowledge', 'Organic, export, or other certification requirements are not well understood by the team.', 0.62, 'external', 'Stage 1→10+'),
('RC-AGR-053', 'AGR-012', 'Food Safety Requirements Not Tracked', 'Operational', 'Food safety compliance is not being actively tracked as the business scales.', 0.63, 'external', 'Stage 1→10+'),
('RC-AGR-054', 'AGR-012', 'No Dedicated Compliance Owner', 'Operational', 'Nobody is specifically responsible for regulatory compliance; it falls to whoever has time.', 0.62, 'external', 'Stage 1→10+'),
('RC-AGR-055', 'AGR-013', 'No Cooperative Performance Evaluation', 'Operational', 'There is no consistent method for assessing how well each cooperative or aggregator is performing.', 0.63, 'external', 'Stage 1→10+'),
('RC-AGR-056', 'AGR-013', 'Underperformance Identified Too Late', 'Operational', 'Struggling cooperative relationships are typically noticed only once they become a serious problem.', 0.62, 'external', 'Stage 1→10+'),
('RC-AGR-057', 'AGR-013', 'No Escalation Plan for Weakening Relationships', 'Strategic', 'There is no defined next step when a cooperative relationship starts to weaken.', 0.60, 'external', 'Stage 1→10+'),
('RC-AGR-058', 'AGR-013', 'Network Growth Outpacing Management Capacity', 'Operational', 'The number of cooperative relationships has grown faster than the team''s ability to manage them well.', 0.62, 'external', 'Stage 1→10+'),
('RC-AGR-059', 'AGR-014', 'Systems Assume Reliable Connectivity', 'Operational', 'Core systems are built assuming internet connectivity that does not exist in all operating regions.', 0.65, 'external', 'Stage 1→10+'),
('RC-AGR-060', 'AGR-014', 'No Offline Functionality', 'Operational', 'The product does not function in areas with poor or no internet signal.', 0.65, 'external', 'Stage 1→10+'),
('RC-AGR-061', 'AGR-014', 'Infrastructure Untested at Real Volume', 'Operational', 'Technology infrastructure has not actually been load-tested at the volume the business now operates at.', 0.62, 'external', 'Stage 1→10+'),
('RC-AGR-062', 'AGR-014', 'No Technology Scaling Plan', 'Strategic', 'There is no plan for how technology infrastructure will keep pace with continued farmer growth.', 0.60, 'external', 'Stage 1→10+'),
('RC-AGR-063', 'AGR-015', 'Revenue Concentration Not Tracked', 'Operational', 'The business does not measure how much revenue depends on its largest partners.', 0.65, 'external', 'Stage 1→10+'),
('RC-AGR-064', 'AGR-015', 'No Diversification Plan', 'Strategic', 'There is no active plan to reduce dependence on the largest existing partners.', 0.63, 'external', 'Stage 1→10+'),
('RC-AGR-065', 'AGR-015', 'Heavy Dependence on Few Large Contracts', 'Strategic', 'A small number of large contracts or partners account for a disproportionate share of revenue.', 0.63, 'external', 'Stage 1→10+'),
('RC-AGR-066', 'AGR-015', 'No Early-Warning System for Partner Loss', 'Operational', 'There is no system in place that would give advance warning if a major partner intended to leave.', 0.60, 'external', 'Stage 1→10+')
...
('S01-AGR-001', 'AGR-005', 'RC-AGR-020', 'Did farmers pay full price during your test, or was it free or discounted?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-002', 'AGR-005', 'RC-AGR-021', 'If you asked today''s users to pay full price starting tomorrow, how many would still say yes?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-003', 'AGR-005', 'RC-AGR-022', 'Are the farmers who tried this actually similar to the ones you eventually want as customers?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-004', 'AGR-005', 'RC-AGR-023', 'Have any of your early users come back to use this a second time on their own?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-005', 'AGR-006', 'RC-AGR-024', 'Have you actually delivered this through a real dealer, agent, or cooperative -- or only tested it yourself?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-006', 'AGR-006', 'RC-AGR-025', 'Does your plan assume farmers will find this online, without any physical way to reach them?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-007', 'AGR-006', 'RC-AGR-026', 'Have you worked out what it costs to pay a field agent or dealer to reach one farmer?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-008', 'AGR-006', 'RC-AGR-027', 'How long would it take you to reach a brand-new village you''ve never worked in before?', 3, 'CORE', 'Stage 0→1'),
('S01-AGR-009', 'AGR-007', 'RC-AGR-028', 'Does your pricing assume farmers pay upfront, or have you checked when they actually have cash available?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-010', 'AGR-007', 'RC-AGR-029', 'Have you tested letting farmers pay after harvest instead of upfront?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-011', 'AGR-007', 'RC-AGR-030', 'After paying for seeds, fertilizer, and other inputs, how much money does your target farmer actually have left?', 3, 'CORE', 'Stage 0→1'),
('S01-AGR-012', 'AGR-007', 'RC-AGR-031', 'What do farmers currently spend money on instead of this, and how does your price compare?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-013', 'AGR-008', 'RC-AGR-033', 'Have you actually worked with a farmer cooperative or FPO in practice, or only assumed they''d help?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-014', 'AGR-008', 'RC-AGR-034', 'Are you confident the cooperative you''re relying on genuinely represents what farmers want?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-015', 'AGR-008', 'RC-AGR-035', 'What would you do if your cooperative or aggregator partnership fell apart tomorrow?', 3, 'CORE', 'Stage 0→1'),
('S01-AGR-016', 'AGR-008', 'RC-AGR-036', 'Do you understand what the aggregator gets out of working with you, beyond helping farmers?', 2, 'SUPPLEMENTARY', 'Stage 0→1'),
('S01-AGR-017', 'AGR-009', 'RC-AGR-037', 'Has this only been tested in one region, crop, or soil type so far?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-018', 'AGR-009', 'RC-AGR-038', 'Do you have a plan to test this in a second, different region before assuming it will scale?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-019', 'AGR-009', 'RC-AGR-039', 'Have you looked into whether farming practices or beliefs are different in other regions you might expand to?', 2, 'CORE', 'Stage 0→1'),
('S01-AGR-020', 'AGR-009', 'RC-AGR-040', 'Are you assuming the same logistics and infrastructure will exist everywhere you expand?', 2, 'SUPPLEMENTARY', 'Stage 0→1'),
('S10-AGR-001', 'AGR-010', 'RC-AGR-041', 'Has your dealer or distribution approach been written down as a repeatable process, or does each region get set up differently?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-002', 'AGR-010', 'RC-AGR-042', 'Do you track dealer performance centrally, or does each region manage that on its own?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-003', 'AGR-010', 'RC-AGR-043', 'Is there a specific person accountable for each region''s distribution performance?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-004', 'AGR-010', 'RC-AGR-044', 'Are dealer incentives consistent across regions, or does each one negotiate separately?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-005', 'AGR-010', 'RC-AGR-045', 'Has product or service quality gotten harder to maintain as you''ve added more regions?', 3, 'CORE', 'Stage 1→10+'),
('S10-AGR-006', 'AGR-011', 'RC-AGR-046', 'Do you have any way to score or predict which farmers are likely to default on credit or financing?', 3, 'CORE', 'Stage 1→10+'),
('S10-AGR-007', 'AGR-011', 'RC-AGR-047', 'Do you track your actual default rate, or would that require digging to find out?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-008', 'AGR-011', 'RC-AGR-048', 'Are lending decisions made based on data, or mostly on relationship and trust?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-009', 'AGR-011', 'RC-AGR-049', 'Have you set aside a reserve for expected bad debt, or does a default just hit as a surprise?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-010', 'AGR-011', 'RC-AGR-050', 'Is your growth in farmer credit outpacing your ability to actually manage that risk?', 3, 'CORE', 'Stage 1→10+'),
('S10-AGR-011', 'AGR-012', 'RC-AGR-051', 'Before expanding into a new product or market, do you map out what compliance or certification you''ll need?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-012', 'AGR-012', 'RC-AGR-052', 'Do you understand what organic or export certification would require if you needed it?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-013', 'AGR-012', 'RC-AGR-053', 'Are you confident you''re meeting food safety requirements as you''ve scaled?', 3, 'CORE', 'Stage 1→10+'),
('S10-AGR-014', 'AGR-012', 'RC-AGR-054', 'Is there someone specifically responsible for compliance, or does it fall on whoever has time?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-015', 'AGR-013', 'RC-AGR-055', 'Do you have a consistent way to evaluate how well each cooperative or aggregator is performing?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-016', 'AGR-013', 'RC-AGR-056', 'Would you know a cooperative was underperforming early, or only once it became a real problem?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-017', 'AGR-013', 'RC-AGR-057', 'If one cooperative started underperforming, would you have a clear next step, or figure it out as you go?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-018', 'AGR-013', 'RC-AGR-058', 'Has managing your growing number of cooperative relationships gotten harder than your team can keep up with?', 3, 'CORE', 'Stage 1→10+'),
('S10-AGR-019', 'AGR-014', 'RC-AGR-059', 'Do your systems assume internet connectivity that doesn''t actually exist in all your operating regions?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-020', 'AGR-014', 'RC-AGR-060', 'Does your product work at all when a farmer or field agent has no signal?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-021', 'AGR-014', 'RC-AGR-061', 'Has your technology actually been tested at the volume you''re now operating at?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-022', 'AGR-014', 'RC-AGR-062', 'Is there a real plan for your technology to keep up as you keep adding farmers?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-023', 'AGR-015', 'RC-AGR-063', 'What percentage of your revenue comes from just your top two or three partners?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-024', 'AGR-015', 'RC-AGR-064', 'Do you have a real plan to reduce dependence on your largest partners?', 2, 'CORE', 'Stage 1→10+'),
('S10-AGR-025', 'AGR-015', 'RC-AGR-066', 'If your biggest partner left tomorrow, would you have any advance warning, or would it just happen?', 3, 'CORE', 'Stage 1→10+')
...
('RC-AUT-019', 'AUT-005', 'No Prototype-to-Production Transition Plan', 'Strategic', 'There is no documented plan for moving from the prototype method to a real production method.', 0.65, 'external', 'Stage 0→1'),
('RC-AUT-020', 'AUT-005', 'Design Not Reviewed for Manufacturability', 'Operational', 'The design has not been reviewed by anyone with real manufacturing expertise.', 0.65, 'external', 'Stage 0→1'),
('RC-AUT-021', 'AUT-005', 'No Production-Volume Supplier Engaged', 'Operational', 'No supplier capable of production-volume manufacturing has actually been engaged.', 0.63, 'external', 'Stage 0→1'),
('RC-AUT-022', 'AUT-005', 'Assuming Prototype Just Needs Scaling Up', 'Knowledge', 'The founder assumes the current prototype method can simply be scaled without changing how it is made.', 0.62, 'external', 'Stage 0→1'),
('RC-AUT-023', 'AUT-005', 'Prototype Relies on One-Off Fabrication', 'Operational', 'The prototype depends on hand-assembly or one-off fabrication methods that cannot scale.', 0.63, 'external', 'Stage 0→1'),
('RC-AUT-024', 'AUT-006', 'No Real-World Testing Conducted', 'Operational', 'No testing has been done outside of a controlled setting.', 0.65, 'external', 'Stage 0→1'),
('RC-AUT-025', 'AUT-006', 'Testing Limited to Ideal Conditions', 'Operational', 'All testing so far has happened under best-case, ideal conditions.', 0.63, 'external', 'Stage 0→1'),
('RC-AUT-026', 'AUT-006', 'No Plan for Weather, Terrain, or Load Variation', 'Strategic', 'There is no plan to test the product across realistic variation in operating conditions.', 0.62, 'external', 'Stage 0→1'),
('RC-AUT-027', 'AUT-006', 'Assuming Lab Results Hold in the Field', 'Knowledge', 'The founder assumes results from lab or bench testing will translate directly to real-world use.', 0.62, 'external', 'Stage 0→1'),
('RC-AUT-028', 'AUT-007', 'Certification Requirements Known but Filing Not Started', 'Operational', 'The founder knows what is required but has not actually begun the filing process.', 0.65, 'external', 'Stage 0→1'),
('RC-AUT-029', 'AUT-007', 'No Application Submitted', 'Operational', 'No formal application has actually been submitted to the certifying body.', 0.65, 'external', 'Stage 0→1'),
('RC-AUT-030', 'AUT-007', 'Certification Treated as a Later Task', 'Behavioural', 'Certification keeps getting deferred as something to handle later rather than now.', 0.62, 'external', 'Stage 0→1'),
('RC-AUT-031', 'AUT-007', 'No Dedicated Certification Owner', 'Operational', 'Nobody is specifically responsible for pushing the certification process forward.', 0.60, 'external', 'Stage 0→1'),
('RC-AUT-032', 'AUT-008', 'Early Testers Are Personal Network', 'Operational', 'The people testing the product so far are mostly friends or the founder''s own network.', 0.65, 'external', 'Stage 0→1'),
('RC-AUT-033', 'AUT-008', 'Early Testers Are Enthusiasts, Not Typical Buyers', 'Knowledge', 'Current testers are enthusiasts rather than representative of the real target buyer.', 0.62, 'external', 'Stage 0→1'),
('RC-AUT-034', 'AUT-008', 'No Outside Paying Customer Converted', 'Operational', 'No paying customer outside the founder''s own network has been converted yet.', 0.65, 'external', 'Stage 0→1'),
('RC-AUT-035', 'AUT-008', 'Feedback Skewed by Relationship Bias', 'Behavioural', 'Feedback from testers may be overly positive because they do not want to disappoint the founder.', 0.60, 'external', 'Stage 0→1'),
('RC-AUT-036', 'AUT-008', 'No Plan to Test Outside the Network', 'Strategic', 'There is no plan to specifically test with someone outside the founder''s existing network.', 0.60, 'external', 'Stage 0→1'),
('RC-AUT-037', 'AUT-009', 'Unit Cost Only Calculated at Prototype Scale', 'Operational', 'Cost per unit has only ever been calculated at the small, prototype scale.', 0.65, 'external', 'Stage 0→1'),
('RC-AUT-038', 'AUT-009', 'No Production-Volume Supplier Quote', 'Operational', 'No real quote has been obtained from a supplier at the actual production volume needed.', 0.65, 'external', 'Stage 0→1'),
('RC-AUT-039', 'AUT-009', 'Assuming Costs Drop at Scale Without Verification', 'Knowledge', 'The founder assumes per-unit cost will fall at scale without confirming by how much.', 0.62, 'external', 'Stage 0→1'),
('RC-AUT-040', 'AUT-009', 'Margin Assumptions Untested at Real Pricing', 'Strategic', 'Margin assumptions have not been checked against what real volume pricing would actually deliver.', 0.62, 'external', 'Stage 0→1'),
('RC-AUT-041', 'AUT-010', 'No Systematic QC Process', 'Operational', 'There is no consistent, documented quality control process applied to production.', 0.65, 'external', 'Stage 1→10+'),
('RC-AUT-042', 'AUT-010', 'Defect Rate Not Tracked', 'Operational', 'The actual defect rate is not being systematically measured.', 0.65, 'external', 'Stage 1→10+'),
('RC-AUT-043', 'AUT-010', 'No Root-Cause Process for Defects', 'Operational', 'Recurring defects are not traced back to a root cause in any systematic way.', 0.62, 'external', 'Stage 1→10+'),
('RC-AUT-044', 'AUT-010', 'Quality Standards Vary by Shift or Line', 'Operational', 'Quality outcomes differ depending on which shift or production line handled the unit.', 0.60, 'external', 'Stage 1→10+'),
('RC-AUT-045', 'AUT-010', 'No Pre-Ship Quality Checkpoint', 'Operational', 'There is no final quality checkpoint before a unit ships to a customer.', 0.63, 'external', 'Stage 1→10+'),
('RC-AUT-046', 'AUT-011', 'No Authorized Service Network', 'Operational', 'No formal network of authorized service providers has been built out.', 0.65, 'external', 'Stage 1→10+'),
('RC-AUT-047', 'AUT-011', 'No Spare Parts Distribution Plan', 'Operational', 'There is no plan for getting spare parts to wherever the product actually is.', 0.63, 'external', 'Stage 1→10+'),
('RC-AUT-048', 'AUT-011', 'Warranty Claims Handled Ad Hoc', 'Operational', 'Warranty claims are processed case by case rather than through a defined process.', 0.62, 'external', 'Stage 1→10+'),
('RC-AUT-049', 'AUT-011', 'No Fleet-Wide Service Visibility', 'Operational', 'There is no visibility into service issues occurring across the whole fleet of units.', 0.60, 'external', 'Stage 1→10+'),
('RC-AUT-050', 'AUT-012', 'No Market-Entry Regulatory Checklist', 'Strategic', 'There is no checklist defining what regulatory work is needed before entering a new market.', 0.63, 'external', 'Stage 1→10+'),
('RC-AUT-051', 'AUT-012', 'Market Regulatory Differences Not Researched', 'Knowledge', 'Differences in regulation between target markets have not been researched.', 0.62, 'external', 'Stage 1→10+'),
('RC-AUT-052', 'AUT-012', 'Assuming One Certification Covers Multiple Markets', 'Knowledge', 'It is assumed a single certification will be valid across multiple markets, without confirming this.', 0.62, 'external', 'Stage 1→10+'),
('RC-AUT-053', 'AUT-012', 'No Per-Market Regulatory Owner', 'Operational', 'Nobody specifically tracks regulatory changes for each market the business operates in.', 0.60, 'external', 'Stage 1→10+'),
('RC-AUT-054', 'AUT-013', 'No Recall Response Plan', 'Strategic', 'There is no plan for how a recall would actually be executed if one were needed.', 0.68, 'external', 'Stage 1→10+'),
('RC-AUT-055', 'AUT-013', 'No Unit Traceability', 'Operational', 'There is no way to trace which specific units are affected by a given issue.', 0.65, 'external', 'Stage 1→10+'),
('RC-AUT-056', 'AUT-013', 'No Customer Communication Plan for Safety Issues', 'Strategic', 'There is no plan for communicating with affected customers if a safety issue arose.', 0.63, 'external', 'Stage 1→10+'),
('RC-AUT-057', 'AUT-013', 'No Internal Escalation Process for Safety Issues', 'Operational', 'There is no clear process for escalating a safety concern internally before it grows.', 0.62, 'external', 'Stage 1→10+'),
('RC-AUT-058', 'AUT-013', 'Recall Cost and Complexity Underestimated', 'Knowledge', 'The true cost and operational complexity of a real recall is not well understood.', 0.60, 'external', 'Stage 1→10+'),
('RC-AUT-059', 'AUT-014', 'Single-Source Dependency on Critical Component', 'Strategic', 'A critical component depends entirely on a single supplier.', 0.65, 'external', 'Stage 1→10+'),
('RC-AUT-060', 'AUT-014', 'No Qualified Backup Supplier', 'Operational', 'No alternative, qualified supplier exists for critical components.', 0.63, 'external', 'Stage 1→10+'),
('RC-AUT-061', 'AUT-014', 'Supplier''s Own Risk Not Understood', 'Knowledge', 'There is no visibility into the risks within the supplier''s own supply chain.', 0.60, 'external', 'Stage 1→10+'),
('RC-AUT-062', 'AUT-014', 'No Safety Stock for Critical Components', 'Operational', 'No buffer stock exists for components that are critical to production continuity.', 0.62, 'external', 'Stage 1→10+'),
('RC-AUT-063', 'AUT-015', 'No Capital Plan Tied to Expansion Milestones', 'Strategic', 'There is no capital plan explicitly linked to specific expansion milestones.', 0.65, 'external', 'Stage 1→10+'),
('RC-AUT-064', 'AUT-015', 'Facility or Tooling Capital Needs Underestimated', 'Knowledge', 'The capital required for new facilities or tooling has been underestimated.', 0.63, 'external', 'Stage 1→10+'),
('RC-AUT-065', 'AUT-015', 'Assuming Software-Style Funding Will Cover Hardware Scaling', 'Knowledge', 'The founder assumes typical software startup funding patterns will cover hardware scaling needs.', 0.62, 'external', 'Stage 1→10+'),
('RC-AUT-066', 'AUT-015', 'No Relationships With Hardware-Suited Capital Sources', 'Operational', 'No relationships exist with capital sources genuinely suited to hardware or manufacturing scaling.', 0.60, 'external', 'Stage 1→10+')
  ) AS v(root_cause_code, problem_code, root_cause_name, root_cause_category, explanation, confidence_weight, layer, primary_stage_group)
  JOIN new_problems p ON p.problem_code = v.problem_code
  RETURNING root_cause_id, root_cause_code
),
...
('S01-AUT-001', 'AUT-005', 'RC-AUT-019', 'Can your current prototype actually be manufactured at volume, or does it rely on methods that won''t scale?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-002', 'AUT-005', 'RC-AUT-020', 'Has anyone with real manufacturing experience reviewed your design for manufacturability?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-003', 'AUT-005', 'RC-AUT-021', 'Have you engaged a supplier who can actually produce at the volume you''ll eventually need?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-004', 'AUT-005', 'RC-AUT-022', 'Are you assuming your prototype just needs to be built bigger or faster, without changing how it''s made?', 3, 'CORE', 'Stage 0→1'),
('S01-AUT-005', 'AUT-006', 'RC-AUT-024', 'Has this been tested in real-world conditions, or only in a controlled setting?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-006', 'AUT-006', 'RC-AUT-025', 'Has your testing so far only happened under ideal, best-case conditions?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-007', 'AUT-006', 'RC-AUT-026', 'Do you have a plan to test this across different weather, terrain, or load conditions?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-008', 'AUT-006', 'RC-AUT-027', 'Are you assuming your lab or bench results will hold up once this is used in the real world?', 3, 'CORE', 'Stage 0→1'),
('S01-AUT-009', 'AUT-007', 'RC-AUT-029', 'Have you actually filed anything with the certifying body, or is this still just research?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-010', 'AUT-007', 'RC-AUT-030', 'Is certification something you''re actively working on, or something you keep planning to start?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-011', 'AUT-007', 'RC-AUT-031', 'Is there someone specifically responsible for pushing your certification forward?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-012', 'AUT-007', 'RC-AUT-028', 'What''s actually stopping you from submitting your certification application this month?', 3, 'SUPPLEMENTARY', 'Stage 0→1'),
('S01-AUT-013', 'AUT-008', 'RC-AUT-032', 'Are your early testers real potential customers, or mostly friends and your own network?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-014', 'AUT-008', 'RC-AUT-033', 'Are the people testing this enthusiasts, or the kind of buyer you''d actually need at scale?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-015', 'AUT-008', 'RC-AUT-034', 'Have you converted a single paying customer who wasn''t already connected to you personally?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-016', 'AUT-008', 'RC-AUT-035', 'Could the positive feedback you''re getting be because people testing this don''t want to disappoint you?', 3, 'CORE', 'Stage 0→1'),
('S01-AUT-017', 'AUT-008', 'RC-AUT-036', 'Do you have a plan to test this with someone completely outside your existing network?', 2, 'SUPPLEMENTARY', 'Stage 0→1'),
('S01-AUT-018', 'AUT-009', 'RC-AUT-037', 'Does your cost per unit at prototype scale look anything like what it would be at real production volume?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-019', 'AUT-009', 'RC-AUT-038', 'Have you gotten a real supplier quote at the volume you''d actually need to sell at?', 2, 'CORE', 'Stage 0→1'),
('S01-AUT-020', 'AUT-009', 'RC-AUT-039', 'Are you assuming your per-unit cost will drop at scale without knowing by how much?', 2, 'CORE', 'Stage 0→1'),
('S10-AUT-001', 'AUT-010', 'RC-AUT-041', 'Do you have any systematic quality control process, or does it depend on who''s checking that day?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-002', 'AUT-010', 'RC-AUT-042', 'Do you track your defect rate, or would you have to go find out?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-003', 'AUT-010', 'RC-AUT-043', 'When a defect shows up, is there a process to trace it back to its root cause?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-004', 'AUT-010', 'RC-AUT-044', 'Does quality look the same across every shift or production line, or does it vary?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-005', 'AUT-010', 'RC-AUT-045', 'Is there a checkpoint that catches quality problems before a unit ships?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-006', 'AUT-011', 'RC-AUT-046', 'If your product breaks in a city you don''t have a service center in, what happens to that customer?', 3, 'CORE', 'Stage 1→10+'),
('S10-AUT-007', 'AUT-011', 'RC-AUT-047', 'Do you have a plan for getting spare parts to wherever your product actually is?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-008', 'AUT-011', 'RC-AUT-048', 'Are warranty claims handled through a real process, or dealt with case by case?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-009', 'AUT-011', 'RC-AUT-049', 'Do you have visibility into service issues happening across your whole fleet, or only what gets reported to you directly?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-010', 'AUT-012', 'RC-AUT-050', 'Do you have a checklist for what regulatory work is needed before entering a new market?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-011', 'AUT-012', 'RC-AUT-051', 'Have you researched what changes when you sell into a new state or country?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-012', 'AUT-012', 'RC-AUT-052', 'Are you assuming one certification will cover you in multiple markets?', 3, 'CORE', 'Stage 1→10+'),
('S10-AUT-013', 'AUT-012', 'RC-AUT-053', 'Is someone specifically tracking regulatory changes in each market you operate in?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-014', 'AUT-013', 'RC-AUT-054', 'If you had to recall units already sold, do you have any plan for how that would actually work?', 3, 'CORE', 'Stage 1→10+'),
('S10-AUT-015', 'AUT-013', 'RC-AUT-055', 'If one unit had a defect, could you trace exactly which other units share that same issue?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-016', 'AUT-013', 'RC-AUT-056', 'Do you have a plan for how you''d communicate with affected customers if a safety issue came up?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-017', 'AUT-013', 'RC-AUT-057', 'Is there a clear process for escalating a safety concern internally before it becomes a crisis?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-018', 'AUT-013', 'RC-AUT-058', 'Have you thought through how much a real recall would actually cost you, in money and time?', 3, 'SUPPLEMENTARY', 'Stage 1→10+'),
('S10-AUT-019', 'AUT-014', 'RC-AUT-059', 'Is there a single supplier that, if they failed, would stop your whole production line?', 3, 'CORE', 'Stage 1→10+'),
('S10-AUT-020', 'AUT-014', 'RC-AUT-060', 'Do you have a qualified backup supplier for your most critical components?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-021', 'AUT-014', 'RC-AUT-061', 'Do you know how vulnerable your own suppliers are to their own supply chain risks?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-022', 'AUT-014', 'RC-AUT-062', 'Do you keep any safety stock of critical components, or do you rely on just-in-time delivery?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-023', 'AUT-015', 'RC-AUT-063', 'Do you know how much capital your next expansion phase will need, and where it will come from?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-024', 'AUT-015', 'RC-AUT-064', 'Have you underestimated what it costs to add new facilities or tooling as you''ve scaled?', 2, 'CORE', 'Stage 1→10+'),
('S10-AUT-025', 'AUT-015', 'RC-AUT-065', 'Are you assuming your funding approach can look like a typical software startup''s, even though this is hardware?', 3, 'CORE', 'Stage 1→10+')
  ) AS v(question_code, problem_code, root_cause_code, question_text, difficulty_level, priority, stage_group)
  JOIN new_problems p ON p.problem_code = v.problem_code
  JOIN new_root_causes rc ON rc.root_cause_code = v.root_cause_code
  RETURNING question_id, question_code
...
('RC-BFS-019', 'BFS-005', 'Application Requirements Known but Not Submitted', 'Operational', 'The founder knows what is required but has not actually submitted the application.', 0.65, 'external', 'Stage 0→1'),
('RC-BFS-020', 'BFS-005', 'No Dedicated Application Owner', 'Operational', 'Nobody is specifically responsible for driving the filing forward.', 0.62, 'external', 'Stage 0→1'),
('RC-BFS-021', 'BFS-005', 'Application Treated as a Someday Task', 'Behavioural', 'Submitting the application keeps getting deferred as something to handle later.', 0.60, 'external', 'Stage 0→1'),
('RC-BFS-022', 'BFS-005', 'Missing Documentation Delaying Submission', 'Operational', 'Required documentation is incomplete, delaying the actual filing.', 0.62, 'external', 'Stage 0→1'),
('RC-BFS-023', 'BFS-006', 'No Real Transaction Testing', 'Operational', 'No testing has been conducted using actual, real transactions.', 0.65, 'external', 'Stage 0→1'),
('RC-BFS-024', 'BFS-006', 'Testing Uses Dummy Money Only', 'Operational', 'All testing so far has used fake or simulated money, not real transactions.', 0.65, 'external', 'Stage 0→1'),
('RC-BFS-025', 'BFS-006', 'No Real Small-Value Test Plan', 'Strategic', 'There is no plan to test with real, small-value transactions before scaling.', 0.62, 'external', 'Stage 0→1'),
('RC-BFS-026', 'BFS-006', 'Assuming Dummy Results Hold With Real Money', 'Knowledge', 'The founder assumes results from dummy-money testing will hold once real money is involved.', 0.62, 'external', 'Stage 0→1'),
('RC-BFS-027', 'BFS-006', 'Regulatory Risk Fear Preventing Real Testing', 'Behavioural', 'Fear of regulatory consequences is preventing any real-money testing from happening.', 0.60, 'external', 'Stage 0→1'),
('RC-BFS-028', 'BFS-007', 'No Third-Party Security Audit', 'Operational', 'No external party has ever audited the product''s security.', 0.68, 'external', 'Stage 0→1'),
('RC-BFS-029', 'BFS-007', 'No Penetration Testing Conducted', 'Operational', 'No penetration test has ever been run against the product.', 0.65, 'external', 'Stage 0→1'),
('RC-BFS-030', 'BFS-007', 'Assuming Internal Review Is Sufficient', 'Knowledge', 'It is assumed that internal review alone is enough, without external verification.', 0.62, 'external', 'Stage 0→1'),
('RC-BFS-031', 'BFS-007', 'No Security Audit Budget', 'Strategic', 'No budget has been allocated for a real, professional security audit.', 0.60, 'external', 'Stage 0→1'),
('RC-BFS-032', 'BFS-008', 'Test Users Using Play Money', 'Operational', 'Testers are using simulated or play money rather than real funds.', 0.65, 'external', 'Stage 0→1'),
('RC-BFS-033', 'BFS-008', 'Testers Not Financially Representative', 'Knowledge', 'Testers do not match the real financial situation of the actual target customer.', 0.63, 'external', 'Stage 0→1'),
('RC-BFS-034', 'BFS-008', 'No Real Financial Stress in Testing', 'Operational', 'Testing conditions do not include any genuine financial stress or urgency.', 0.60, 'external', 'Stage 0→1'),
('RC-BFS-035', 'BFS-008', 'Feedback Collected Under Artificial Conditions', 'Behavioural', 'Feedback is gathered in low-stakes, artificial conditions that may not reflect real use.', 0.60, 'external', 'Stage 0→1'),
('RC-BFS-036', 'BFS-008', 'No Plan to Test Real Financial Decisions', 'Strategic', 'There is no plan to test with users actually making real financial decisions.', 0.60, 'external', 'Stage 0→1'),
('RC-BFS-037', 'BFS-009', 'Sandbox Programs Unknown', 'Knowledge', 'The founder is unaware that regulatory sandbox programs exist for this category.', 0.60, 'external', 'Stage 0→1'),
('RC-BFS-038', 'BFS-009', 'Sandbox Eligibility Not Researched', 'Operational', 'No research has been done on whether this idea qualifies for a sandbox program.', 0.60, 'external', 'Stage 0→1'),
('RC-BFS-039', 'BFS-009', 'Assuming Full Licensing Is the Only Path', 'Knowledge', 'It is assumed full licensing is required before any legal testing can happen.', 0.58, 'external', 'Stage 0→1'),
('RC-BFS-040', 'BFS-009', 'No Sandbox Application Submitted', 'Operational', 'No application has actually been submitted to any sandbox program.', 0.58, 'external', 'Stage 0→1'),
('RC-BFS-041', 'BFS-010', 'No Fraud Detection System', 'Operational', 'No automated system exists to detect fraudulent transactions.', 0.68, 'external', 'Stage 1→10+'),
('RC-BFS-042', 'BFS-010', 'Fraud Losses Not Tracked Separately', 'Operational', 'Fraud losses are not measured separately from other business losses.', 0.65, 'external', 'Stage 1→10+'),
('RC-BFS-043', 'BFS-010', 'No Fraud Rate Benchmark', 'Knowledge', 'There is no benchmark for what an acceptable fraud rate looks like in this category.', 0.62, 'external', 'Stage 1→10+'),
('RC-BFS-044', 'BFS-010', 'Manual Review Cannot Keep Pace', 'Operational', 'Manual fraud review cannot keep up with current transaction volume.', 0.63, 'external', 'Stage 1→10+'),
('RC-BFS-045', 'BFS-010', 'No Fraud Investigation Process', 'Operational', 'There is no defined process for investigating a suspected fraud case.', 0.62, 'external', 'Stage 1→10+'),
('RC-BFS-046', 'BFS-011', 'Reporting Handled Reactively', 'Operational', 'Regulatory reporting is scrambled together at each deadline rather than managed proactively.', 0.63, 'external', 'Stage 1→10+'),
('RC-BFS-047', 'BFS-011', 'No Dedicated Reporting Owner', 'Operational', 'Nobody is specifically responsible for regulatory reporting.', 0.62, 'external', 'Stage 1→10+'),
('RC-BFS-048', 'BFS-011', 'No Audit Trail in Core Systems', 'Operational', 'Core systems do not automatically produce the audit trail regulators expect.', 0.65, 'external', 'Stage 1→10+'),
('RC-BFS-049', 'BFS-011', 'Reporting Requires Heavy Manual Compilation', 'Operational', 'Each reporting cycle requires significant manual data gathering and compilation.', 0.62, 'external', 'Stage 1→10+'),
('RC-BFS-050', 'BFS-012', 'No Formal Grievance Process', 'Operational', 'There is no formal, documented grievance redressal process.', 0.65, 'external', 'Stage 1→10+'),
('RC-BFS-051', 'BFS-012', 'Mandated Timelines Not Tracked', 'Operational', 'Regulator-mandated complaint resolution timelines are not being tracked.', 0.65, 'external', 'Stage 1→10+'),
('RC-BFS-052', 'BFS-012', 'No Grievance Officer Appointed', 'Operational', 'No grievance officer has been formally appointed as regulations typically require.', 0.63, 'external', 'Stage 1→10+'),
('RC-BFS-053', 'BFS-012', 'Complaints Handled Informally', 'Operational', 'Customer complaints are handled case by case without a consistent process.', 0.62, 'external', 'Stage 1→10+'),
('RC-BFS-054', 'BFS-012', 'No Proof of Timeline Compliance', 'Operational', 'No record exists that could prove complaint resolution timelines were actually met.', 0.62, 'external', 'Stage 1→10+'),
('RC-BFS-055', 'BFS-013', 'Assuming New Products Fall Under Existing License', 'Knowledge', 'It is assumed a new product line is covered by the existing license without confirming this.', 0.65, 'external', 'Stage 1→10+'),
('RC-BFS-056', 'BFS-013', 'No Licensing Research Before Product Planning', 'Operational', 'New product lines are planned before checking what licensing they would require.', 0.63, 'external', 'Stage 1→10+'),
('RC-BFS-057', 'BFS-013', 'No Licensing Timeline in Product Roadmap', 'Strategic', 'The product roadmap does not build in time for obtaining new licenses.', 0.62, 'external', 'Stage 1→10+'),
('RC-BFS-058', 'BFS-013', 'Roadmap Ignores Regulatory Approval Gates', 'Strategic', 'The product roadmap does not treat regulatory approval as a real gating milestone.', 0.62, 'external', 'Stage 1→10+'),
('RC-BFS-059', 'BFS-014', 'Capital Adequacy Position Not Tracked', 'Operational', 'The current capital adequacy position is not being actively monitored.', 0.68, 'external', 'Stage 1→10+'),
('RC-BFS-060', 'BFS-014', 'No Early Warning for Regulatory Limits', 'Operational', 'There is no alert or early warning as the business approaches a regulatory limit.', 0.65, 'external', 'Stage 1→10+'),
('RC-BFS-061', 'BFS-014', 'Liquidity Stress Not Modeled', 'Strategic', 'Liquidity risk under stress conditions has never been modeled.', 0.63, 'external', 'Stage 1→10+'),
('RC-BFS-062', 'BFS-014', 'Growth Targets Not Checked Against Capital Limits', 'Strategic', 'Growth targets are set without checking them against capital adequacy constraints.', 0.63, 'external', 'Stage 1→10+'),
('RC-BFS-063', 'BFS-014', 'No Capital Raise Plan Before Hitting Limits', 'Strategic', 'There is no plan for raising additional capital before regulatory limits are reached.', 0.62, 'external', 'Stage 1→10+'),
('RC-BFS-064', 'BFS-015', 'Total Dependence on One Partner', 'Strategic', 'The entire business depends on a single partner bank or NBFC relationship.', 0.68, 'external', 'Stage 1→10+'),
('RC-BFS-065', 'BFS-015', 'No Backup Partner Established', 'Strategic', 'No alternative partner bank or NBFC relationship has been established.', 0.65, 'external', 'Stage 1→10+'),
('RC-BFS-066', 'BFS-015', 'Partnership Exit Terms Not Understood', 'Knowledge', 'The terms under which the partnership could end are not well understood.', 0.62, 'external', 'Stage 1→10+')
  ) AS v(root_cause_code, problem_code, root_cause_name, root_cause_category, explanation, confidence_weight, layer, primary_stage_group)
  JOIN new_problems p ON p.problem_code = v.problem_code
  RETURNING root_cause_id, root_cause_code
),
...
('S01-BFS-001', 'BFS-005', 'RC-BFS-019', 'Have you actually submitted your license application, or is it still sitting in draft?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-002', 'BFS-005', 'RC-BFS-020', 'Is there someone specifically responsible for pushing your application forward?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-003', 'BFS-005', 'RC-BFS-021', 'Is submitting your application something you''re actively doing, or something you keep planning to start?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-004', 'BFS-005', 'RC-BFS-022', 'What documentation is still missing that''s delaying your submission?', 2, 'SUPPLEMENTARY', 'Stage 0→1'),
('S01-BFS-005', 'BFS-006', 'RC-BFS-023', 'Has this ever processed a real transaction with real money, even a small one?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-006', 'BFS-006', 'RC-BFS-024', 'Has all your testing so far used fake or dummy money only?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-007', 'BFS-006', 'RC-BFS-025', 'Do you have a plan to test with small, real-value transactions before scaling up?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-008', 'BFS-006', 'RC-BFS-026', 'Are you assuming your dummy-data results will hold once real money is involved?', 3, 'CORE', 'Stage 0→1'),
('S01-BFS-009', 'BFS-006', 'RC-BFS-027', 'Is fear of regulatory risk the reason you haven''t tested with real money yet?', 3, 'CORE', 'Stage 0→1'),
('S01-BFS-010', 'BFS-007', 'RC-BFS-029', 'Has anyone actually tried to break into your system, or is security still theoretical?', 3, 'CORE', 'Stage 0→1'),
('S01-BFS-011', 'BFS-007', 'RC-BFS-028', 'Has a third party ever audited your security, or has it only been reviewed internally?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-012', 'BFS-007', 'RC-BFS-030', 'Are you assuming your internal review is enough without external verification?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-013', 'BFS-007', 'RC-BFS-031', 'Have you set aside a real budget for a proper security audit?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-014', 'BFS-008', 'RC-BFS-032', 'Are your test users using real money in a real financial situation, or play money in a demo?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-015', 'BFS-008', 'RC-BFS-033', 'Do your testers actually match the financial situation of your real target customer?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-016', 'BFS-008', 'RC-BFS-034', 'Is there any real financial stress or urgency present when people test this, or is it low-stakes?', 3, 'CORE', 'Stage 0→1'),
('S01-BFS-017', 'BFS-008', 'RC-BFS-035', 'Could the feedback you''re getting be different if testers had something real financially at stake?', 3, 'CORE', 'Stage 0→1'),
('S01-BFS-018', 'BFS-008', 'RC-BFS-036', 'Do you have a plan to test this with people making genuinely real financial decisions?', 2, 'SUPPLEMENTARY', 'Stage 0→1'),
('S01-BFS-019', 'BFS-009', 'RC-BFS-037', 'Have you looked into RBI''s regulatory sandbox as a way to test this compliantly before full licensing?', 2, 'CORE', 'Stage 0→1'),
('S01-BFS-020', 'BFS-009', 'RC-BFS-038', 'Have you checked whether your specific category is even eligible for a sandbox program?', 2, 'CORE', 'Stage 0→1'),
('S10-BFS-001', 'BFS-010', 'RC-BFS-042', 'Do you know what percentage of your transactions are fraudulent, or would you have to go find out?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-002', 'BFS-010', 'RC-BFS-041', 'Do you have an automated system catching fraud, or does it depend on someone noticing?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-003', 'BFS-010', 'RC-BFS-043', 'Do you know what a normal fraud rate looks like for your type of business?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-004', 'BFS-010', 'RC-BFS-044', 'Can your manual review process still keep up with your transaction volume?', 3, 'CORE', 'Stage 1→10+'),
('S10-BFS-005', 'BFS-010', 'RC-BFS-045', 'When you suspect fraud, is there a clear process for investigating it?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-006', 'BFS-011', 'RC-BFS-046', 'Is regulatory reporting something you do calmly on schedule, or a scramble every deadline?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-007', 'BFS-011', 'RC-BFS-047', 'Is there someone specifically responsible for regulatory reporting?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-008', 'BFS-011', 'RC-BFS-048', 'Do your systems automatically create the audit trail regulators would ask for?', 3, 'CORE', 'Stage 1→10+'),
('S10-BFS-009', 'BFS-011', 'RC-BFS-049', 'How much manual work goes into pulling together each regulatory report?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-010', 'BFS-012', 'RC-BFS-051', 'Do you meet the mandated timeline for resolving customer complaints, and can you prove it?', 3, 'CORE', 'Stage 1→10+'),
('S10-BFS-011', 'BFS-012', 'RC-BFS-050', 'Do you have a formal, written grievance process, or are complaints handled however they come in?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-012', 'BFS-012', 'RC-BFS-052', 'Have you appointed a grievance officer, as regulations typically require?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-013', 'BFS-012', 'RC-BFS-054', 'If a regulator asked you to prove you resolved complaints on time, could you show them records?', 3, 'CORE', 'Stage 1→10+'),
('S10-BFS-014', 'BFS-012', 'RC-BFS-053', 'Are customer complaints handled the same way every time, or does it depend on who picks it up?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-015', 'BFS-013', 'RC-BFS-055', 'If you added a new financial product, do you know whether that needs a completely separate license?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-016', 'BFS-013', 'RC-BFS-056', 'Do you check licensing requirements before planning a new product line, or after?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-017', 'BFS-013', 'RC-BFS-057', 'Does your product roadmap build in time for getting new licenses approved?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-018', 'BFS-013', 'RC-BFS-058', 'Does your roadmap treat regulatory approval as a real gate, or assume it will work out?', 3, 'SUPPLEMENTARY', 'Stage 1→10+'),
('S10-BFS-019', 'BFS-014', 'RC-BFS-059', 'Do you know your current capital adequacy position, and how close you are to the limit?', 3, 'CORE', 'Stage 1→10+'),
('S10-BFS-020', 'BFS-014', 'RC-BFS-060', 'Would you get any warning before you hit a regulatory capital limit, or only find out when you cross it?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-021', 'BFS-014', 'RC-BFS-061', 'Have you modeled what happens to your liquidity under stress conditions?', 3, 'CORE', 'Stage 1→10+'),
('S10-BFS-022', 'BFS-014', 'RC-BFS-062', 'Are your growth targets checked against your capital limits, or set independently?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-023', 'BFS-014', 'RC-BFS-063', 'Do you have a plan to raise capital before you hit your regulatory limit, not after?', 2, 'CORE', 'Stage 1→10+'),
('S10-BFS-024', 'BFS-015', 'RC-BFS-064', 'If your partner bank or NBFC ended the relationship tomorrow, what happens to your business?', 3, 'CORE', 'Stage 1→10+'),
('S10-BFS-025', 'BFS-015', 'RC-BFS-065', 'Have you established a backup partner bank or NBFC relationship?', 2, 'CORE', 'Stage 1→10+')
  ) AS v(question_code, problem_code, root_cause_code, question_text, difficulty_level, priority, stage_group)
  JOIN new_problems p ON p.problem_code = v.problem_code
  JOIN new_root_causes rc ON rc.root_cause_code = v.root_cause_code
  RETURNING question_id, question_code
...
('RC-BPC-019', 'BPC-005', 'Requirements Known but Not Filed', 'Operational', 'The founder knows the requirements but has not actually submitted the application.', 0.65, 'external', 'Stage 0→1'),
('RC-BPC-020', 'BPC-005', 'No Ingredient Safety Documentation', 'Operational', 'Required documentation on ingredient safety has not been prepared.', 0.63, 'external', 'Stage 0→1'),
('RC-BPC-021', 'BPC-005', 'No Approval Timeline in Launch Plan', 'Strategic', 'The launch plan does not account for how long approval actually takes.', 0.62, 'external', 'Stage 0→1'),
('RC-BPC-022', 'BPC-005', 'Assuming Approval Will Be Quick', 'Knowledge', 'The founder assumes the approval process will be fast and simple without confirming this.', 0.60, 'external', 'Stage 0→1'),
('RC-BPC-023', 'BPC-006', 'No Shelf-Life Testing', 'Operational', 'No testing has been done to determine how long the product remains stable.', 0.65, 'external', 'Stage 0→1'),
('RC-BPC-024', 'BPC-006', 'Packaging Not Tested With Formulation', 'Operational', 'The packaging has never actually been tested together with the real product formulation.', 0.63, 'external', 'Stage 0→1'),
('RC-BPC-025', 'BPC-006', 'No Heat or Humidity Testing', 'Operational', 'The product has not been tested under real heat or humidity conditions.', 0.63, 'external', 'Stage 0→1'),
('RC-BPC-026', 'BPC-006', 'No Post-Shipping Performance Testing', 'Operational', 'There is no data on how the product performs after being shipped.', 0.60, 'external', 'Stage 0→1'),
('RC-BPC-027', 'BPC-006', 'Assuming Lab Results Hold in Real Storage', 'Knowledge', 'It is assumed that lab testing results will hold true under real-world storage conditions.', 0.60, 'external', 'Stage 0→1'),
('RC-BPC-028', 'BPC-007', 'Only Friends and Family Have Tried It', 'Operational', 'Testing has been limited to friends and family rather than genuine target customers.', 0.65, 'external', 'Stage 0→1'),
('RC-BPC-029', 'BPC-007', 'No Unbiased Outside Feedback', 'Operational', 'No feedback has been collected from anyone without a personal connection to the founder.', 0.63, 'external', 'Stage 0→1'),
('RC-BPC-030', 'BPC-007', 'Feedback Skewed by Relationship Bias', 'Behavioural', 'Feedback may be overly positive because testers do not want to disappoint the founder.', 0.60, 'external', 'Stage 0→1'),
('RC-BPC-031', 'BPC-007', 'No Plan to Test With Strangers', 'Strategic', 'There is no plan to test the product with people who have no personal connection to the founder.', 0.60, 'external', 'Stage 0→1'),
('RC-BPC-032', 'BPC-008', 'No Sample Strategy', 'Strategic', 'There is no defined strategy for offering samples or trial sizes.', 0.63, 'external', 'Stage 0→1'),
('RC-BPC-033', 'BPC-008', 'Sample Costs Not in Acquisition Math', 'Operational', 'The cost of giving out samples has not been factored into customer acquisition cost calculations.', 0.63, 'external', 'Stage 0→1'),
('RC-BPC-034', 'BPC-008', 'Assuming Full-Size Purchase Without Trial', 'Knowledge', 'It is assumed customers will buy full-size products without trying a sample first.', 0.60, 'external', 'Stage 0→1'),
('RC-BPC-035', 'BPC-008', 'No Sample-to-Purchase Conversion Plan', 'Strategic', 'There is no plan for how sample recipients are expected to convert into full purchasers.', 0.60, 'external', 'Stage 0→1'),
('RC-BPC-036', 'BPC-009', 'No Content Strategy', 'Strategic', 'There is no defined content strategy for reaching potential customers.', 0.63, 'external', 'Stage 0→1'),
('RC-BPC-037', 'BPC-009', 'No Influencer or Outreach Plan', 'Strategic', 'There is no plan for influencer partnerships or other outreach.', 0.62, 'external', 'Stage 0→1'),
('RC-BPC-038', 'BPC-009', 'Relying on Hope of Going Viral', 'Behavioural', 'The founder is relying on the hope of organic virality rather than a deliberate plan.', 0.63, 'external', 'Stage 0→1'),
('RC-BPC-039', 'BPC-009', 'No Marketing Budget Allocated', 'Operational', 'No budget has been set aside for marketing or content creation.', 0.60, 'external', 'Stage 0→1'),
('RC-BPC-040', 'BPC-009', 'Target Customer Channel Unknown', 'Knowledge', 'It is not known which specific channel the real target customer actually spends time on.', 0.60, 'external', 'Stage 0→1'),
('RC-BPC-041', 'BPC-010', 'No Standardized Batch Process', 'Operational', 'There is no documented, repeatable process for producing a consistent batch.', 0.65, 'external', 'Stage 1→10+'),
('RC-BPC-042', 'BPC-010', 'Batch Testing Inconsistent', 'Operational', 'Quality testing of batches happens irregularly rather than every time.', 0.63, 'external', 'Stage 1→10+'),
('RC-BPC-043', 'BPC-010', 'Supplier Changes Not Checked for Consistency', 'Operational', 'Different suppliers are used without verifying whether that changes the final product.', 0.62, 'external', 'Stage 1→10+'),
('RC-BPC-044', 'BPC-010', 'No Pre-Ship Quality Checkpoint', 'Operational', 'There is no quality checkpoint before a batch ships to customers.', 0.63, 'external', 'Stage 1→10+'),
('RC-BPC-045', 'BPC-010', 'Process Knowledge Lives With One Person', 'Operational', 'Exact process knowledge exists only in one person''s head, not documented anywhere.', 0.62, 'external', 'Stage 1→10+'),
('RC-BPC-046', 'BPC-011', 'No Margin Modeling Before Retail', 'Strategic', 'Retail margin impact was not modeled before entering retail channels.', 0.65, 'external', 'Stage 1→10+'),
('RC-BPC-047', 'BPC-011', 'Retailer Terms Not Negotiated', 'Operational', 'Retailer terms were accepted as offered rather than negotiated.', 0.62, 'external', 'Stage 1→10+'),
('RC-BPC-048', 'BPC-011', 'Distributor Cuts Not Accounted For', 'Operational', 'Distributor fees were not factored in before signing agreements.', 0.62, 'external', 'Stage 1→10+'),
('RC-BPC-049', 'BPC-011', 'True Landed Cost Unknown', 'Knowledge', 'The real cost after every channel fee is included is not actually known.', 0.63, 'external', 'Stage 1→10+'),
('RC-BPC-050', 'BPC-012', 'No Legal Protection on Formulation or Brand', 'Strategic', 'No trademark or formulation protection has been put in place.', 0.63, 'external', 'Stage 1→10+'),
('RC-BPC-051', 'BPC-012', 'No Counterfeit Monitoring', 'Operational', 'There is no ongoing monitoring for counterfeit versions in the market.', 0.60, 'external', 'Stage 1→10+'),
('RC-BPC-052', 'BPC-012', 'No Copycat Response Plan', 'Strategic', 'There is no plan for what to do if a copycat product appears.', 0.60, 'external', 'Stage 1→10+'),
('RC-BPC-053', 'BPC-012', 'Assuming Brand Loyalty Prevents Copying', 'Knowledge', 'It is assumed that brand loyalty alone will stop customers from switching to a copycat.', 0.58, 'external', 'Stage 1→10+'),
('RC-BPC-054', 'BPC-013', 'Sales Concentrated in One or Two Influencers', 'Strategic', 'A majority of sales depend on just one or two influencer relationships.', 0.65, 'external', 'Stage 1→10+'),
('RC-BPC-055', 'BPC-013', 'No Diversified Marketing Channels', 'Strategic', 'Marketing relies almost entirely on influencer partnerships, with no other channels developed.', 0.63, 'external', 'Stage 1→10+'),
('RC-BPC-056', 'BPC-013', 'No Plan if Key Influencer Relationship Ends', 'Strategic', 'There is no contingency plan for if a major influencer relationship ends.', 0.62, 'external', 'Stage 1→10+'),
('RC-BPC-057', 'BPC-013', 'Brand Tied Too Closely to One Person', 'Strategic', 'The brand''s reputation is tied too closely to a single person''s public image.', 0.60, 'external', 'Stage 1→10+'),
('RC-BPC-058', 'BPC-014', 'No Formal Complaint Logging System', 'Operational', 'There is no formal system for logging allergic reactions or complaints.', 0.68, 'external', 'Stage 1→10+'),
('RC-BPC-059', 'BPC-014', 'No Escalation Process for Serious Reactions', 'Operational', 'There is no defined process for escalating a serious reaction report.', 0.65, 'external', 'Stage 1→10+'),
('RC-BPC-060', 'BPC-014', 'Return Process Not Built for Volume', 'Operational', 'The current return process was not designed to handle present order volume.', 0.62, 'external', 'Stage 1→10+'),
('RC-BPC-061', 'BPC-014', 'No Complaint Pattern Tracking', 'Operational', 'There is no tracking of whether complaints cluster around specific batches.', 0.62, 'external', 'Stage 1→10+'),
('RC-BPC-062', 'BPC-014', 'No Legal or Medical Protocol for Reactions', 'Strategic', 'There is no defined legal or medical protocol for handling a serious reaction report.', 0.63, 'external', 'Stage 1→10+'),
('RC-BPC-063', 'BPC-015', 'Assuming Domestic Regulations Apply Internationally', 'Knowledge', 'It is assumed the same regulations that apply domestically will apply in a new country.', 0.65, 'external', 'Stage 1→10+'),
('RC-BPC-064', 'BPC-015', 'Target Country Regulations Not Researched', 'Operational', 'No research has been done into the specific cosmetic regulations of the target country.', 0.63, 'external', 'Stage 1→10+'),
('RC-BPC-065', 'BPC-015', 'No Local Registration Started', 'Operational', 'No local registration or approval process has actually been started for the new country.', 0.63, 'external', 'Stage 1→10+'),
('RC-BPC-066', 'BPC-015', 'Labeling Not Adapted for Target Country', 'Operational', 'Product labeling has not been adapted to meet the target country''s specific requirements.', 0.60, 'external', 'Stage 1→10+')
  ) AS v(root_cause_code, problem_code, root_cause_name, root_cause_category, explanation, confidence_weight, layer, primary_stage_group)
  JOIN new_problems p ON p.problem_code = v.problem_code
  RETURNING root_cause_id, root_cause_code
),
...
('S01-BPC-001', 'BPC-005', 'RC-BPC-019', 'Have you actually applied for the approval you now know you need, or is that still pending?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-002', 'BPC-005', 'RC-BPC-020', 'Do you have the ingredient safety documentation ready, or is that still missing?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-003', 'BPC-005', 'RC-BPC-021', 'Have you built approval timing into your launch plan, or are you assuming it''ll be quick?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-004', 'BPC-005', 'RC-BPC-022', 'What''s actually stopping you from submitting your application this month?', 2, 'SUPPLEMENTARY', 'Stage 0→1'),
('S01-BPC-005', 'BPC-006', 'RC-BPC-023', 'Has your product been tested to see how long it stays stable before it degrades?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-006', 'BPC-006', 'RC-BPC-024', 'Has your packaging actually been tested with your real formulation, not just assumed to work?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-007', 'BPC-006', 'RC-BPC-025', 'Has this been tested under real heat or humidity, or only in ideal lab conditions?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-008', 'BPC-006', 'RC-BPC-026', 'Do you know how your product holds up after being shipped, not just sitting on a shelf?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-009', 'BPC-006', 'RC-BPC-027', 'Are you assuming your lab testing results will hold once it''s in real storage conditions?', 3, 'CORE', 'Stage 0→1'),
('S01-BPC-010', 'BPC-007', 'RC-BPC-028', 'Has anyone outside your friends and family actually tried this and given honest feedback?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-011', 'BPC-007', 'RC-BPC-030', 'Could the positive feedback you''ve gotten be because people don''t want to disappoint you?', 3, 'CORE', 'Stage 0→1'),
('S01-BPC-012', 'BPC-007', 'RC-BPC-029', 'Have you gotten any feedback from someone with zero personal connection to you?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-013', 'BPC-007', 'RC-BPC-031', 'Do you have a plan to test this with complete strangers before you launch?', 2, 'SUPPLEMENTARY', 'Stage 0→1'),
('S01-BPC-014', 'BPC-008', 'RC-BPC-032', 'Have you planned for giving out samples, and does your cost model account for that?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-015', 'BPC-008', 'RC-BPC-033', 'Have you built the cost of samples into how you calculate customer acquisition cost?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-016', 'BPC-008', 'RC-BPC-034', 'Are you assuming customers will buy full-size without trying it first?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-017', 'BPC-008', 'RC-BPC-035', 'Do you know what percentage of sample-takers you''d need to convert to make this work?', 3, 'CORE', 'Stage 0→1'),
('S01-BPC-018', 'BPC-009', 'RC-BPC-038', 'Do you have any real plan for how people will discover this, or are you hoping it goes viral?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-019', 'BPC-009', 'RC-BPC-036', 'Do you have any actual content or influencer outreach plan, or is that still undefined?', 2, 'CORE', 'Stage 0→1'),
('S01-BPC-020', 'BPC-009', 'RC-BPC-040', 'Do you know which specific channel your real target customers actually spend time on?', 2, 'CORE', 'Stage 0→1'),
('S10-BPC-001', 'BPC-010', 'RC-BPC-041', 'Does every batch actually match the one before it, or does quality vary depending on who made it?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-002', 'BPC-010', 'RC-BPC-042', 'Is batch testing something you do every time, or only sometimes?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-003', 'BPC-010', 'RC-BPC-043', 'If you switched suppliers, would you actually know if that changed your product?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-004', 'BPC-010', 'RC-BPC-044', 'Is there a quality check before a batch ships, or does it just go out?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-005', 'BPC-010', 'RC-BPC-045', 'If the person who knows your exact process left, could anyone else replicate it?', 3, 'CORE', 'Stage 1→10+'),
('S10-BPC-006', 'BPC-011', 'RC-BPC-046', 'Did you model your margins before agreeing to retailer terms, or after?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-007', 'BPC-011', 'RC-BPC-047', 'Were your retailer terms negotiated, or did you accept whatever was offered?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-008', 'BPC-011', 'RC-BPC-048', 'Did you account for distributor cuts before signing, or did that surprise you later?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-009', 'BPC-011', 'RC-BPC-049', 'Do you actually know your true landed cost after every channel fee is included?', 3, 'CORE', 'Stage 1→10+'),
('S10-BPC-010', 'BPC-012', 'RC-BPC-050', 'Do you have any legal protection on your formulation or brand name?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-011', 'BPC-012', 'RC-BPC-051', 'Do you monitor the market for counterfeit versions of your product?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-012', 'BPC-012', 'RC-BPC-052', 'If a copycat appeared tomorrow, would you have any real plan to respond?', 3, 'CORE', 'Stage 1→10+'),
('S10-BPC-013', 'BPC-012', 'RC-BPC-053', 'Are you assuming brand loyalty alone will stop people from copying you?', 2, 'SUPPLEMENTARY', 'Stage 1→10+'),
('S10-BPC-014', 'BPC-013', 'RC-BPC-054', 'If your top influencer disappeared tomorrow, would your sales survive?', 3, 'CORE', 'Stage 1→10+'),
('S10-BPC-015', 'BPC-013', 'RC-BPC-055', 'How many different marketing channels do you actually rely on, beyond influencers?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-016', 'BPC-013', 'RC-BPC-056', 'Do you have a plan for what happens if a key influencer relationship ends badly?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-017', 'BPC-013', 'RC-BPC-057', 'Is your brand''s reputation tied too closely to one person''s public image?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-018', 'BPC-014', 'RC-BPC-058', 'Do you have a real system for handling allergic reactions and complaints at your current volume?', 3, 'CORE', 'Stage 1→10+'),
('S10-BPC-019', 'BPC-014', 'RC-BPC-059', 'Is there a clear escalation process for a serious reaction report?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-020', 'BPC-014', 'RC-BPC-060', 'Can your return process actually handle your current order volume?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-021', 'BPC-014', 'RC-BPC-061', 'Do you track whether complaints are clustering around a specific batch?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-022', 'BPC-014', 'RC-BPC-062', 'If a serious reaction were reported, do you know the right legal or medical steps to take?', 3, 'CORE', 'Stage 1→10+'),
('S10-BPC-023', 'BPC-015', 'RC-BPC-063', 'Are you assuming the same regulations that apply here will apply in a new country?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-024', 'BPC-015', 'RC-BPC-064', 'Have you actually researched your target country''s cosmetic regulations?', 2, 'CORE', 'Stage 1→10+'),
('S10-BPC-025', 'BPC-015', 'RC-BPC-065', 'Have you started any local registration process for the country you''re expanding into?', 2, 'CORE', 'Stage 1→10+')
  ) AS v(question_code, problem_code, root_cause_code, question_text, difficulty_level, priority, stage_group)
  JOIN new_problems p ON p.problem_code = v.problem_code
  JOIN new_root_causes rc ON rc.root_cause_code = v.root_cause_code
  RETURNING question_id, question_code
...
('RC-PRP-019', 'PRP-005', 'No Listing Verification Process', 'Operational', 'There is no process in place to verify that listing information is accurate.', 0.65, 'external', 'Stage 0→1'),
('RC-PRP-020', 'PRP-005', 'Data From an Unreliable Source', 'Operational', 'Listing data is pulled from a source that has not been checked for reliability.', 0.63, 'external', 'Stage 0→1'),
('RC-PRP-021', 'PRP-005', 'No Process for Updating Stale Listings', 'Operational', 'There is no process for catching and refreshing listings that have become outdated.', 0.62, 'external', 'Stage 0→1'),
('RC-PRP-022', 'PRP-005', 'Assuming Listers Self-Maintain Accuracy', 'Knowledge', 'It is assumed that the people posting listings will keep their information accurate without any prompting.', 0.60, 'external', 'Stage 0→1'),
('RC-PRP-023', 'PRP-006', 'Local Registration Requirements Not Understood', 'Knowledge', 'The founder does not understand what local registration requirements actually apply.', 0.65, 'external', 'Stage 0→1'),
('RC-PRP-024', 'PRP-006', 'No Lawyer or Legal Consultant Involved', 'Operational', 'No lawyer or legal consultant has been engaged to review the process.', 0.65, 'external', 'Stage 0→1'),
('RC-PRP-025', 'PRP-006', 'Assuming Standard Templates Suffice', 'Knowledge', 'It is assumed a standard contract template is sufficient for this specific kind of transaction.', 0.60, 'external', 'Stage 0→1'),
('RC-PRP-026', 'PRP-006', 'No Title or Ownership Verification Process', 'Operational', 'There is no process for verifying title or ownership before a deal proceeds.', 0.63, 'external', 'Stage 0→1'),
('RC-PRP-027', 'PRP-006', 'Legal Compliance Time and Cost Underestimated', 'Knowledge', 'The real time and cost of legal compliance in this space has been underestimated.', 0.62, 'external', 'Stage 0→1'),
('RC-PRP-028', 'PRP-007', 'No Real Broker Relationship Built', 'Operational', 'No genuine working relationship has been built with brokers or agents.', 0.63, 'external', 'Stage 0→1'),
('RC-PRP-029', 'PRP-007', 'Assuming Brokers Can Be Bypassed', 'Knowledge', 'It is assumed the platform can bypass brokers entirely in this market.', 0.60, 'external', 'Stage 0→1'),
('RC-PRP-030', 'PRP-007', 'Broker Compensation Model Not Understood', 'Knowledge', 'It is not understood how brokers are actually compensated in this market.', 0.60, 'external', 'Stage 0→1'),
('RC-PRP-031', 'PRP-007', 'No Broker Adoption Plan', 'Strategic', 'There is no real plan for how a broker would actually use or adopt the platform.', 0.60, 'external', 'Stage 0→1'),
('RC-PRP-032', 'PRP-008', 'Leads Generated but No Deal Closed', 'Operational', 'Interest and leads exist, but no actual deal has been completed.', 0.65, 'external', 'Stage 0→1'),
('RC-PRP-033', 'PRP-008', 'No Lead-to-Completion Process', 'Operational', 'There is no defined process for guiding a lead all the way through to completion.', 0.62, 'external', 'Stage 0→1'),
('RC-PRP-034', 'PRP-008', 'Assuming Interest Converts Automatically', 'Knowledge', 'It is assumed that generated interest will automatically turn into a completed deal.', 0.60, 'external', 'Stage 0→1'),
('RC-PRP-035', 'PRP-008', 'No Manual Push for a Completed Deal', 'Operational', 'No deliberate, manual effort has been applied to push even one deal through to completion.', 0.60, 'external', 'Stage 0→1'),
('RC-PRP-036', 'PRP-009', 'No Verification Badges or Credibility Markers', 'Operational', 'No verification badges or credibility markers exist on the platform.', 0.62, 'external', 'Stage 0→1'),
('RC-PRP-037', 'PRP-009', 'No Reviews or Testimonials Collected', 'Operational', 'No reviews or testimonials from real users have been collected yet.', 0.62, 'external', 'Stage 0→1'),
('RC-PRP-038', 'PRP-009', 'No Transparency on Who Is Behind It', 'Operational', 'It is not clear to a visitor who is actually behind the platform or its listings.', 0.60, 'external', 'Stage 0→1'),
('RC-PRP-039', 'PRP-009', 'Assuming Trust Builds Automatically', 'Knowledge', 'It is assumed that trust will build on its own over time without deliberate effort.', 0.58, 'external', 'Stage 0→1'),
('RC-PRP-040', 'PRP-009', 'No Plan to Earn Trust Before Big Commitments', 'Strategic', 'There is no plan for earning trust before asking users for large financial commitments.', 0.60, 'external', 'Stage 0→1'),
('RC-PRP-041', 'PRP-010', 'No City-by-City Regulatory Checklist', 'Strategic', 'There is no checklist covering regulatory differences across cities or states.', 0.65, 'external', 'Stage 1→10+'),
('RC-PRP-042', 'PRP-010', 'Assuming Registration Process Transfers', 'Knowledge', 'It is assumed the current city''s registration process will work the same way elsewhere.', 0.63, 'external', 'Stage 1→10+'),
('RC-PRP-043', 'PRP-010', 'No Local Legal Partner in New Markets', 'Operational', 'No local legal partner has been engaged in newly entered markets.', 0.63, 'external', 'Stage 1→10+'),
('RC-PRP-044', 'PRP-010', 'Stamp Duty Differences Not Researched', 'Knowledge', 'Differences in stamp duty and registration costs between markets have not been researched.', 0.60, 'external', 'Stage 1→10+'),
('RC-PRP-045', 'PRP-011', 'No Standardized Quality Control Across Projects', 'Operational', 'There is no consistent quality control process applied across multiple projects.', 0.65, 'external', 'Stage 1→10+'),
('RC-PRP-046', 'PRP-011', 'No Centralized Timeline Tracking', 'Operational', 'There is no single place tracking timelines across all active projects.', 0.63, 'external', 'Stage 1→10+'),
('RC-PRP-047', 'PRP-011', 'Contractors Held to Different Standards', 'Operational', 'Different contractors are evaluated against inconsistent quality standards.', 0.62, 'external', 'Stage 1→10+'),
('RC-PRP-048', 'PRP-011', 'No Early Warning System for Delays', 'Operational', 'There is no system that flags a project heading toward delay before it actually happens.', 0.62, 'external', 'Stage 1→10+'),
('RC-PRP-049', 'PRP-011', 'No Process for Recurring Contractor Issues', 'Operational', 'There is no defined process for addressing a contractor issue that keeps recurring.', 0.60, 'external', 'Stage 1→10+'),
('RC-PRP-050', 'PRP-012', 'No Compliant Escrow System', 'Strategic', 'There is no properly compliant system in place for holding escrow funds.', 0.68, 'external', 'Stage 1→10+'),
('RC-PRP-051', 'PRP-012', 'Large Sums Handled Without Legal Structure', 'Operational', 'Large sums of money are being handled without a proper legal structure behind them.', 0.65, 'external', 'Stage 1→10+'),
('RC-PRP-052', 'PRP-012', 'No Third-Party Escrow Partner', 'Operational', 'No real third-party escrow partner has been engaged.', 0.63, 'external', 'Stage 1→10+'),
('RC-PRP-053', 'PRP-012', 'No Audit Trail for Fund Movements', 'Operational', 'There is no clear audit trail showing where funds moved and when.', 0.62, 'external', 'Stage 1→10+'),
('RC-PRP-054', 'PRP-013', 'No Fraud Detection Process', 'Operational', 'There is no process in place to detect fraudulent activity on the platform.', 0.65, 'external', 'Stage 1→10+'),
('RC-PRP-055', 'PRP-013', 'No Pre-Listing Verification Step', 'Operational', 'There is no verification step before a new listing actually goes live.', 0.63, 'external', 'Stage 1→10+'),
('RC-PRP-056', 'PRP-013', 'No Fast Removal Process for Fraud', 'Operational', 'There is no fast, defined process for removing a reported fraudulent listing.', 0.62, 'external', 'Stage 1→10+'),
('RC-PRP-057', 'PRP-013', 'No Repeat Offender Monitoring', 'Operational', 'There is no tracking of actors who post fraudulent listings more than once.', 0.60, 'external', 'Stage 1→10+'),
('RC-PRP-058', 'PRP-014', 'Listings Concentrated in Few Developers', 'Strategic', 'A majority of listings or projects depend on a small number of developers or owners.', 0.65, 'external', 'Stage 1→10+'),
('RC-PRP-059', 'PRP-014', 'No Supply Diversification Plan', 'Strategic', 'There is no active plan to diversify beyond the current top supply sources.', 0.63, 'external', 'Stage 1→10+'),
('RC-PRP-060', 'PRP-014', 'No Backup Supplier Relationship', 'Strategic', 'There is no backup relationship ready if a top supplier were to leave.', 0.62, 'external', 'Stage 1→10+'),
('RC-PRP-061', 'PRP-014', 'Supply Concentration Not Tracked', 'Operational', 'Supply concentration is not tracked over time, so it is only noticed once it becomes a problem.', 0.60, 'external', 'Stage 1→10+'),
('RC-PRP-062', 'PRP-014', 'Growth Targets Not Checked Against Supply Diversity', 'Strategic', 'Growth targets are set without checking them against how concentrated current supply actually is.', 0.60, 'external', 'Stage 1→10+'),
('RC-PRP-063', 'PRP-015', 'No Document Retention System', 'Operational', 'There is no system retaining documentation from past transactions for future reference.', 0.65, 'external', 'Stage 1→10+'),
('RC-PRP-064', 'PRP-015', 'No Protocol for Late-Surfacing Disputes', 'Strategic', 'There is no defined legal protocol for handling a dispute that surfaces well after closing.', 0.63, 'external', 'Stage 1→10+'),
('RC-PRP-065', 'PRP-015', 'No Long-Tail Liability Coverage', 'Operational', 'There is no insurance or liability coverage for claims that could arise years later.', 0.63, 'external', 'Stage 1→10+'),
('RC-PRP-066', 'PRP-015', 'Assuming Closed Deals Carry No Ongoing Risk', 'Knowledge', 'It is assumed that once a transaction closes, it carries no further risk to the business.', 0.60, 'external', 'Stage 1→10+')
  ) AS v(root_cause_code, problem_code, root_cause_name, root_cause_category, explanation, confidence_weight, layer, primary_stage_group)
  JOIN new_problems p ON p.problem_code = v.problem_code
  RETURNING root_cause_id, root_cause_code
),
...
('S01-PRP-001', 'PRP-005', 'RC-PRP-019', 'Have you actually verified that the property information on your platform matches reality?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-002', 'PRP-005', 'RC-PRP-020', 'Where does your listing data actually come from, and how reliable is that source?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-003', 'PRP-005', 'RC-PRP-021', 'Do you have any process for catching and updating listings that have gone stale?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-004', 'PRP-005', 'RC-PRP-022', 'Are you assuming the people listing properties will keep their own information accurate?', 2, 'SUPPLEMENTARY', 'Stage 0→1'),
('S01-PRP-005', 'PRP-006', 'RC-PRP-023', 'Do you understand what legal paperwork is actually involved in the kind of transaction you''re facilitating?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-006', 'PRP-006', 'RC-PRP-024', 'Has a lawyer or legal consultant actually reviewed your process yet?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-007', 'PRP-006', 'RC-PRP-025', 'Are you assuming a standard contract template is enough for this kind of transaction?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-008', 'PRP-006', 'RC-PRP-026', 'Do you have any process for verifying title or ownership before a deal proceeds?', 3, 'CORE', 'Stage 0→1'),
('S01-PRP-009', 'PRP-006', 'RC-PRP-027', 'Have you underestimated how much time and cost real legal compliance actually takes here?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-010', 'PRP-007', 'RC-PRP-028', 'Have you built any real relationship with brokers or agents, or are you trying to work entirely around them?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-011', 'PRP-007', 'RC-PRP-029', 'Are you assuming your platform can bypass brokers entirely in this market?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-012', 'PRP-007', 'RC-PRP-030', 'Do you actually understand how brokers get paid in this market?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-013', 'PRP-007', 'RC-PRP-031', 'Do you have a real plan for how a broker would actually use your platform?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-014', 'PRP-008', 'RC-PRP-032', 'Has an actual deal gone all the way through your platform, from interest to completion?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-015', 'PRP-008', 'RC-PRP-033', 'Do you have a real process for guiding a lead all the way to a completed deal?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-016', 'PRP-008', 'RC-PRP-034', 'Are you assuming interest or inquiries will automatically turn into completed deals?', 3, 'CORE', 'Stage 0→1'),
('S01-PRP-017', 'PRP-008', 'RC-PRP-035', 'Have you personally pushed even one deal through manually, start to finish?', 2, 'SUPPLEMENTARY', 'Stage 0→1'),
('S01-PRP-018', 'PRP-009', 'RC-PRP-036', 'Would a stranger trust your platform enough to put real money into a transaction through it?', 3, 'CORE', 'Stage 0→1'),
('S01-PRP-019', 'PRP-009', 'RC-PRP-037', 'Do you have any reviews or testimonials from real users yet?', 2, 'CORE', 'Stage 0→1'),
('S01-PRP-020', 'PRP-009', 'RC-PRP-038', 'Is it clear to a visitor who is actually behind your platform or listings?', 2, 'CORE', 'Stage 0→1'),
('S10-PRP-001', 'PRP-010', 'RC-PRP-041', 'Have you actually researched what changes legally when you expand to a new city or state?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-002', 'PRP-010', 'RC-PRP-042', 'Are you assuming your current city''s registration process will work the same way elsewhere?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-003', 'PRP-010', 'RC-PRP-043', 'Do you have a local legal partner in each new market you''ve entered?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-004', 'PRP-010', 'RC-PRP-044', 'Have you checked how stamp duty and registration costs differ in your new market?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-005', 'PRP-011', 'RC-PRP-045', 'As you''ve added more projects or listings, has quality gotten harder to keep consistent?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-006', 'PRP-011', 'RC-PRP-046', 'Do you have one central place to track timelines across all your active projects?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-007', 'PRP-011', 'RC-PRP-047', 'Are all your contractors held to the same quality standard, or does it vary?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-008', 'PRP-011', 'RC-PRP-048', 'Would you know a project was heading toward delay early, or only once it was already late?', 3, 'CORE', 'Stage 1→10+'),
('S10-PRP-009', 'PRP-011', 'RC-PRP-049', 'When a contractor issue keeps recurring, is there a process for addressing it?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-010', 'PRP-012', 'RC-PRP-050', 'Do you have a real, compliant system for holding large deposits or escrow funds safely?', 3, 'CORE', 'Stage 1→10+'),
('S10-PRP-011', 'PRP-012', 'RC-PRP-051', 'Are you handling large sums of money without a proper legal structure behind it?', 3, 'CORE', 'Stage 1→10+'),
('S10-PRP-012', 'PRP-012', 'RC-PRP-052', 'Have you engaged a real third-party escrow partner, or is this handled informally?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-013', 'PRP-012', 'RC-PRP-053', 'If asked, could you produce a clear audit trail for where funds moved and when?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-014', 'PRP-013', 'RC-PRP-054', 'Do you have any way to detect a fake or fraudulent listing before it goes live?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-015', 'PRP-013', 'RC-PRP-055', 'Is there a verification step before a new listing actually goes live?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-016', 'PRP-013', 'RC-PRP-056', 'If a fraudulent listing were reported, do you have a real process for removing it quickly?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-017', 'PRP-013', 'RC-PRP-057', 'Do you track repeat offenders who post fraudulent listings more than once?', 2, 'SUPPLEMENTARY', 'Stage 1→10+'),
('S10-PRP-018', 'PRP-014', 'RC-PRP-058', 'What percentage of your business depends on just your top few developers or property owners?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-019', 'PRP-014', 'RC-PRP-059', 'Do you have any active plan to diversify beyond your current top suppliers?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-020', 'PRP-014', 'RC-PRP-060', 'If your biggest supplier left tomorrow, do you have a backup relationship ready?', 3, 'CORE', 'Stage 1→10+'),
('S10-PRP-021', 'PRP-014', 'RC-PRP-061', 'Do you track your supply concentration over time, or only notice it when it becomes a problem?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-022', 'PRP-014', 'RC-PRP-062', 'Are your growth targets realistic given how concentrated your current supply actually is?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-023', 'PRP-015', 'RC-PRP-063', 'If a dispute surfaced two years after a transaction closed, would you have any records to defend yourself?', 3, 'CORE', 'Stage 1→10+'),
('S10-PRP-024', 'PRP-015', 'RC-PRP-064', 'Do you have a real legal protocol for handling a dispute that surfaces well after closing?', 2, 'CORE', 'Stage 1→10+'),
('S10-PRP-025', 'PRP-015', 'RC-PRP-065', 'Do you carry any insurance or coverage for liability claims that could arise years later?', 2, 'CORE', 'Stage 1→10+')
  ) AS v(question_code, problem_code, root_cause_code, question_text, difficulty_level, priority, stage_group)
  JOIN new_problems p ON p.problem_code = v.problem_code
  JOIN new_root_causes rc ON rc.root_cause_code = v.root_cause_code
  RETURNING question_id, question_code
...
new_interventions AS (
  ...
  FROM (VALUES
('INT-PRP-001', 'PRP-001', '["RC-PRP-001", "RC-PRP-004"]'::jsonb, 'Market Validation', 'Ideation — PropTech Market Fundamentals', '[{"name": "Differentiation Statement", "brief": "Writing a single, clear sentence describing what makes the product different."}]'::jsonb, '["Write one sentence describing what makes your product different.", "If you cannot write it clearly, treat that as your real starting point.", "Test this sentence on someone unfamiliar with your idea."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-002', 'PRP-001', '["RC-PRP-003"]'::jsonb, 'Market Validation', 'Ideation — PropTech Market Fundamentals', '[{"name": "Competitor Comparison List", "brief": "Listing existing platforms doing something similar and comparing honestly."}]'::jsonb, '["List 3 existing platforms doing something similar.", "Compare your idea against each one honestly.", "Identify what, if anything, is genuinely different."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-003', 'PRP-001', '["RC-PRP-005"]'::jsonb, 'Market Validation', 'Ideation — PropTech Market Fundamentals', '[{"name": "Outside Perspective Check", "brief": "Asking people outside the founder''s own circle whether the idea stands out."}]'::jsonb, '["Describe your idea to 5 people outside your close circle.", "Ask them directly what stands out, if anything.", "Note honestly if nobody mentions something unique."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-004', 'PRP-002', '["RC-PRP-006", "RC-PRP-007"]'::jsonb, 'Customer Definition', 'Ideation — PropTech Market Fundamentals', '[{"name": "First Customer Selection", "brief": "Picking one specific type of customer to build for first, instead of the whole industry."}]'::jsonb, '["Pick one specific type of customer to build for first.", "Write down why you chose that group specifically.", "Set aside every other customer type for now."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-005', 'PRP-002', '["RC-PRP-008", "RC-PRP-009"]'::jsonb, 'Customer Definition', 'Ideation — PropTech Market Fundamentals', '[{"name": "Customer Need Comparison", "brief": "Comparing how different needs actually are across different roles in the property chain."}]'::jsonb, '["List the needs of two different customer types in this space.", "Compare them side by side honestly.", "Note where one product genuinely cannot serve both well."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-006', 'PRP-003', '["RC-PRP-011", "RC-PRP-012"]'::jsonb, 'Market Validation', 'Ideation — PropTech Market Fundamentals', '[{"name": "Real Timeline Research", "brief": "Talking to someone who has actually completed a property or construction transaction about how long it took."}]'::jsonb, '["Talk to someone who recently bought, sold, or built property.", "Ask them specifically how long the process took.", "Compare that against your current assumption."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-007', 'PRP-003', '["RC-PRP-010"]'::jsonb, 'Market Validation', 'Ideation — PropTech Market Fundamentals', '[{"name": "Sector Timeline Research", "brief": "Researching actual average timelines for your specific type of transaction."}]'::jsonb, '["Research typical timelines for your specific transaction type.", "Write down that real number.", "Compare it against what your current plan assumes."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-008', 'PRP-003', '["RC-PRP-013"]'::jsonb, 'Financial Planning', 'Ideation — PropTech Market Fundamentals', '[{"name": "Long Cycle Survival Plan", "brief": "Writing down what the business does to survive during a typical deal-length gap with no revenue."}]'::jsonb, '["Write down the real length of a typical deal cycle.", "Write down what your business does during that gap with no revenue.", "Decide if that gap feels survivable as currently planned."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-009', 'PRP-004', '["RC-PRP-014", "RC-PRP-015"]'::jsonb, 'Customer Definition', 'Ideation — PropTech Market Fundamentals', '[{"name": "Decision-Maker Mapping", "brief": "Listing every person who might be involved in the decision the customer makes."}]'::jsonb, '["List every person who might be involved in this decision.", "Include family, co-owners, and anyone else relevant.", "Note who among them actually has final say."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-010', 'PRP-004', '["RC-PRP-016", "RC-PRP-017", "RC-PRP-018"]'::jsonb, 'Customer Definition', 'Ideation — PropTech Market Fundamentals', '[{"name": "Offline Influence Mapping", "brief": "Mapping where a broker, bank, or other offline party would enter the process."}]'::jsonb, '["Map out where a broker or agent would enter your process.", "Map out where a bank or lender would enter your process.", "Note anywhere your idea assumes a purely digital decision that is not realistic."]'::jsonb, '[1]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-011', 'PRP-005', '["RC-PRP-019", "RC-PRP-020"]'::jsonb, 'Data Quality', 'Validation — PropTech Real-World Readiness', '[{"name": "Listing Verification Process", "brief": "Building a real process to verify listing accuracy before scaling."}]'::jsonb, '["Pick a sample of current listings and verify them against reality.", "Identify how many were inaccurate.", "Build a verification step into how new listings get added."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-012', 'PRP-005', '["RC-PRP-021", "RC-PRP-022"]'::jsonb, 'Data Quality', 'Validation — PropTech Real-World Readiness', '[{"name": "Stale Listing Refresh Process", "brief": "Setting up a regular process to catch and refresh outdated listings."}]'::jsonb, '["Set a regular schedule for checking listing freshness.", "Flag and refresh anything found to be stale.", "Do not assume listers will self-maintain accuracy without prompting."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-013', 'PRP-006', '["RC-PRP-023", "RC-PRP-024"]'::jsonb, 'Legal Compliance', 'Validation — PropTech Real-World Readiness', '[{"name": "Legal Process Review", "brief": "Getting a lawyer or legal consultant to review the actual transaction process."}]'::jsonb, '["Find a lawyer with real estate experience.", "Have them review your actual process end to end.", "Fix any gap they identify before proceeding further."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-014', 'PRP-006', '["RC-PRP-025", "RC-PRP-027"]'::jsonb, 'Legal Compliance', 'Validation — PropTech Real-World Readiness', '[{"name": "Full Legal Step Mapping", "brief": "Mapping every legal and paperwork step involved in a real transaction, including real time and cost."}]'::jsonb, '["List every legal step a real transaction requires.", "Get a real time and cost estimate for each step.", "Compare this against your current assumptions."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-015', 'PRP-007', '["RC-PRP-028", "RC-PRP-029"]'::jsonb, 'Partnership Strategy', 'Validation — PropTech Real-World Readiness', '[{"name": "Broker Relationship Building", "brief": "Having real conversations with brokers about working together, rather than assuming they can be bypassed."}]'::jsonb, '["Have direct conversations with 3-5 real brokers.", "Ask them how they currently work and what they need.", "Reconsider any assumption that they can simply be bypassed."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-016', 'PRP-007', '["RC-PRP-030", "RC-PRP-031"]'::jsonb, 'Partnership Strategy', 'Validation — PropTech Real-World Readiness', '[{"name": "Broker Compensation and Adoption Design", "brief": "Understanding real broker compensation and designing a genuine path for broker adoption."}]'::jsonb, '["Research exactly how brokers are compensated in this market.", "Design your platform to work with that model, not against it.", "Build a concrete plan for how a broker would actually adopt this."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-017', 'PRP-008', '["RC-PRP-032", "RC-PRP-035"]'::jsonb, 'Sales Execution', 'Validation — PropTech Real-World Readiness', '[{"name": "Manual Deal Completion Push", "brief": "Manually pushing one real deal all the way to completion, even if it requires significant personal effort."}]'::jsonb, '["Pick your strongest current lead.", "Personally push that deal through to completion, manually if needed.", "Document every obstacle encountered along the way."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-018', 'PRP-008', '["RC-PRP-033", "RC-PRP-034"]'::jsonb, 'Sales Execution', 'Validation — PropTech Real-World Readiness', '[{"name": "Lead-to-Completion Process Design", "brief": "Building a defined process for guiding a lead through every stage to a completed deal."}]'::jsonb, '["Map every stage between initial interest and a completed deal.", "Define what needs to happen at each stage.", "Stop assuming interest converts automatically without this process."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-019', 'PRP-009', '["RC-PRP-036", "RC-PRP-039"]'::jsonb, 'Trust Building', 'Validation — PropTech Real-World Readiness', '[{"name": "Basic Trust Signal Implementation", "brief": "Adding basic verification and credibility markers before asking for bigger financial commitments."}]'::jsonb, '["Add basic verification badges to listings or profiles.", "Do not assume trust will build without deliberate signals.", "Test whether these signals actually change user behavior."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-020', 'PRP-009', '["RC-PRP-038", "RC-PRP-040"]'::jsonb, 'Trust Building', 'Validation — PropTech Real-World Readiness', '[{"name": "Platform Transparency", "brief": "Being clearly transparent about who is behind the platform and its listings before asking for trust."}]'::jsonb, '["Add clear information about who is behind the platform.", "Make this visible before asking for any financial commitment.", "Build a deliberate plan for earning trust in stages."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-021', 'PRP-006', '["RC-PRP-026"]'::jsonb, 'Legal Compliance', 'Validation — PropTech Real-World Readiness', '[{"name": "Title and Ownership Verification", "brief": "Building a real process for verifying title or ownership before a listing or deal proceeds."}]'::jsonb, '["Define what ownership verification looks like for your transaction type.", "Build a verification step before a listing goes live.", "Do not skip this step for the sake of speed."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-022', 'PRP-009', '["RC-PRP-037"]'::jsonb, 'Trust Building', 'Validation — PropTech Real-World Readiness', '[{"name": "Early Testimonial Collection", "brief": "Actively collecting real testimonials from the platform''s first completed transactions."}]'::jsonb, '["Identify your first completed transactions, however few.", "Ask those users directly for a testimonial.", "Display these prominently to build early credibility."]'::jsonb, '[2, 3, 4]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
('INT-PRP-023', 'PRP-010', '["RC-PRP-041", "RC-PRP-042"]'::jsonb, 'Regulatory Compliance', 'Growth — Multi-City Regulatory Readiness', '[{"name": "City-by-City Regulatory Checklist", "brief": "Building a reusable checklist covering regulatory differences before entering any new city or state."}]'::jsonb, '["Research regulatory requirements for your next target city.", "Build a reusable checklist template from that research.", "Confirm what differs from your current market before assuming it transfers."]'::jsonb, '[5, 6, 7]'::jsonb, '["minimum_effective_dose", "evidence_based", "stage_contextualised"]'::jsonb),
...
new_root_causes AS (
  ...
  ('RC-CEL-019', 'No Design for Manufacturing Review', 'The design has never been checked by anyone who would actually have to produce it.', 'CEL-005', 'external', 'Operational', 0.70, 'Stage 0→1'),
  ('RC-CEL-020', 'Prototype Parts Not Available in Bulk', 'The components used in the sample cannot be bought in production quantities.', 'CEL-005', 'external', 'Operational', 0.66, 'Stage 0→1'),
  ('RC-CEL-021', 'No Manufacturer Has Seen the Design', 'No factory or contract manufacturer has been approached with the actual design files.', 'CEL-005', 'external', 'Behavioural', 0.68, 'Stage 0→1'),
  ('RC-CEL-022', 'Assuming the Prototype Just Needs Scaling', 'The founder believes production is the same design made in larger numbers.', 'CEL-005', 'external', 'Knowledge', 0.65, 'Stage 0→1'),
  ('RC-CEL-023', 'No Production Version of the Design Exists', 'Only a hand-built version exists, with no manufacturable drawing or file set.', 'CEL-005', 'external', 'Operational', 0.64, 'Stage 0→1'),
  ('RC-CEL-024', 'Certification Application Never Filed', 'The requirement is understood but the application has not been submitted.', 'CEL-006', 'external', 'Behavioural', 0.72, 'Stage 0→1'),
  ('RC-CEL-025', 'No Testing Lab Engaged', 'No safety or EMC testing has been booked with an approved lab.', 'CEL-006', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-CEL-026', 'Certification Timeline Not in the Plan', 'The launch plan assumes certification takes no meaningful time.', 'CEL-006', 'external', 'Strategic', 0.66, 'Stage 0→1'),
  ('RC-CEL-027', 'No Budget for Testing and Certification', 'Money has not been set aside for the real cost of compliance.', 'CEL-006', 'external', 'Knowledge', 0.63, 'Stage 0→1'),
  ('RC-CEL-028', 'Certification Treated as a Formality', 'The founder assumes approval is automatic rather than a real gate that can fail.', 'CEL-006', 'external', 'Psychological', 0.61, 'Stage 0→1'),
  ('RC-CEL-029', 'No Confirmed Supplier for Key Parts', 'Critical components have no named, agreed supplier behind them.', 'CEL-007', 'external', 'Operational', 0.71, 'Stage 0→1'),
  ('RC-CEL-030', 'Minimum Order Quantities Never Checked', 'No one has asked suppliers what the smallest order they will accept is.', 'CEL-007', 'external', 'Knowledge', 0.67, 'Stage 0→1'),
  ('RC-CEL-031', 'Component Lead Times Unknown', 'How long parts take to arrive has never been confirmed with a supplier.', 'CEL-007', 'external', 'Knowledge', 0.66, 'Stage 0→1'),
  ('RC-CEL-032', 'Only Online Prices Used, No Real Quotes', 'Planning is based on listed web prices rather than written supplier quotes.', 'CEL-007', 'external', 'Behavioural', 0.64, 'Stage 0→1'),
  ('RC-CEL-033', 'No Backup Supplier Identified', 'If one supplier fails, there is no second option for that part.', 'CEL-007', 'external', 'Operational', 0.62, 'Stage 0→1'),
  ('RC-CEL-034', 'Cost Based on Small Quantity Buying', 'Unit cost was worked out from buying a few pieces, not production volumes.', 'CEL-008', 'external', 'Knowledge', 0.70, 'Stage 0→1'),
  ('RC-CEL-035', 'No Factory Quote at Target Volume', 'No manufacturer has given a written price for the real first order size.', 'CEL-008', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-CEL-036', 'Assembly and Labour Costs Left Out', 'Only parts are counted, ignoring what it costs to actually put the product together.', 'CEL-008', 'external', 'Knowledge', 0.65, 'Stage 0→1'),
  ('RC-CEL-037', 'Margin Calculated on an Unverified Cost', 'Profit expectations are built on a cost number nobody has confirmed.', 'CEL-008', 'external', 'Strategic', 0.64, 'Stage 0→1'),
  ('RC-CEL-038', 'No Warranty Terms Defined', 'There is no written statement of what the customer is promised if the product fails.', 'CEL-009', 'external', 'Operational', 0.69, 'Stage 0→1'),
  ('RC-CEL-039', 'No Repair or Replacement Process', 'Nothing is set up for getting a failed unit fixed or swapped.', 'CEL-009', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-CEL-040', 'Expected Failure Rate Unknown', 'The founder has no estimate of how many units will fail in the first year.', 'CEL-009', 'external', 'Knowledge', 0.63, 'Stage 0→1'),
  ('RC-CEL-041', 'Defect Rate Never Measured', 'Nobody tracks what share of units fail, so quality problems are invisible until customers complain.', 'CEL-010', 'external', 'Operational', 0.72, 'Stage 1→10+'),
  ('RC-CEL-042', 'No Incoming Parts Inspection', 'Components go straight into production without being checked on arrival.', 'CEL-010', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-CEL-043', 'Repeat Faults Never Traced', 'The same fault keeps appearing because nobody investigates why it happens.', 'CEL-010', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-CEL-044', 'Quality Varies Between Batches', 'Each production run is treated separately, with no fixed standard to hold them to.', 'CEL-010', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-CEL-045', 'Customer Complaints Are the Only Signal', 'Quality problems are discovered by customers rather than caught in the factory.', 'CEL-010', 'external', 'Operational', 0.64, 'Stage 1→10+'),
  ('RC-CEL-046', 'No Service Coverage Outside Home City', 'Customers elsewhere have nowhere to take a faulty unit.', 'CEL-011', 'external', 'Operational', 0.71, 'Stage 1→10+'),
  ('RC-CEL-047', 'No Spare Parts Held', 'There is no stock of parts, so nothing can actually be repaired.', 'CEL-011', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-CEL-048', 'Every Repair Becomes a Replacement', 'Whole units are swapped because repair is not set up, which destroys margin.', 'CEL-011', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-CEL-049', 'No Turnaround Time Promised or Measured', 'Customers are not told how long a repair takes, and it is never tracked.', 'CEL-011', 'external', 'Operational', 0.62, 'Stage 1→10+'),
  ('RC-CEL-050', 'Service Still Handled by the Core Team', 'Repairs pull the founder and core team away from building the business.', 'CEL-011', 'external', 'Behavioural', 0.64, 'Stage 1→10+'),
  ('RC-CEL-051', 'Stock Age Never Reviewed', 'Nobody checks how long inventory has been sitting before it becomes hard to sell.', 'CEL-012', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-CEL-052', 'No Plan for End of Life Components', 'A supplier discontinuing a part would strand the existing design and stock.', 'CEL-012', 'external', 'Strategic', 0.68, 'Stage 1→10+'),
  ('RC-CEL-053', 'Ordering Based on Optimism', 'Purchase quantities are set on hoped for sales rather than actual sell through.', 'CEL-012', 'external', 'Behavioural', 0.67, 'Stage 1→10+'),
  ('RC-CEL-054', 'Old Model Stock Held After New Launch', 'Previous model inventory is not cleared before the replacement arrives.', 'CEL-012', 'external', 'Strategic', 0.63, 'Stage 1→10+'),
  ('RC-CEL-055', 'Cash Locked in Unsold Stock', 'Working capital is tied up in inventory instead of being available to the business.', 'CEL-012', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-CEL-056', 'Retail Terms Agreed Without Margin Modelling', 'Channel agreements were signed before working out what was left per unit.', 'CEL-013', 'external', 'Strategic', 0.71, 'Stage 1→10+'),
  ('RC-CEL-057', 'Marketplace Fees and Returns Not Counted', 'Platform commission, returns and shipping are missing from the unit economics.', 'CEL-013', 'external', 'Knowledge', 0.68, 'Stage 1→10+'),
  ('RC-CEL-058', 'Discounting to Win Shelf Space', 'Price is cut to get into retail, and the discount never comes back.', 'CEL-013', 'external', 'Behavioural', 0.64, 'Stage 1→10+'),
  ('RC-CEL-059', 'Profit Per Channel Unknown', 'There is no view of which channels actually make money and which lose it.', 'CEL-013', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-CEL-060', 'All Production With One Factory', 'The entire output depends on a single manufacturer continuing to perform.', 'CEL-014', 'external', 'Operational', 0.73, 'Stage 1→10+'),
  ('RC-CEL-061', 'No Second Factory Qualified', 'No alternative manufacturer has been trialled or approved.', 'CEL-014', 'external', 'Strategic', 0.69, 'Stage 1→10+'),
  ('RC-CEL-062', 'All Key Parts From One Region', 'A single region disruption would stop every critical component at once.', 'CEL-014', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-CEL-063', 'No Buffer Stock for Supply Interruption', 'Nothing is held back to keep selling if supply pauses.', 'CEL-014', 'external', 'Operational', 0.63, 'Stage 1→10+'),
  ('RC-CEL-064', 'No End of Life Date for Current Model', 'Nobody has decided when the current product stops being the main one.', 'CEL-015', 'external', 'Strategic', 0.68, 'Stage 1→10+'),
  ('RC-CEL-065', 'No Next Model in Development', 'All effort goes to the current product, with nothing being readied to replace it.', 'CEL-015', 'external', 'Strategic', 0.70, 'Stage 1→10+'),
  ('RC-CEL-066', 'Competitor Refresh Cycles Not Tracked', 'How often rivals launch new versions is not watched or planned against.', 'CEL-015', 'external', 'Knowledge', 0.64, 'Stage 1→10+')
...
new_questions AS (
  ...
  ('S01-CEL-001', 'Could a factory actually make your current design, or does it only work because you built it by hand?', 'open_text', 'Product Development', 'CORE', 'CEL-005', 'RC-CEL-019', 2, 'Stage 0→1'),
  ('S01-CEL-002', 'Are the parts in your prototype ones you can buy in large quantities, or only in ones and twos?', 'open_text', 'Product Development', 'CORE', 'CEL-005', 'RC-CEL-020', 2, 'Stage 0→1'),
  ('S01-CEL-003', 'Has a manufacturer actually looked at your design and told you what needs to change?', 'open_text', 'Product Development', 'CORE', 'CEL-005', 'RC-CEL-021', 2, 'Stage 0→1'),
  ('S01-CEL-004', 'Do you think production is just your prototype made in bigger numbers, or a different design job?', 'open_text', 'Product Development', 'CORE', 'CEL-005', 'RC-CEL-022', 3, 'Stage 0→1'),
  ('S01-CEL-005', 'Do you have proper production drawings or files, or only the hand built sample?', 'open_text', 'Product Development', 'CORE', 'CEL-005', 'RC-CEL-023', 2, 'Stage 0→1'),
  ('S01-CEL-006', 'Have you applied for BIS registration, or is it still on the to do list?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-006', 'RC-CEL-024', 2, 'Stage 0→1'),
  ('S01-CEL-007', 'Have you booked safety or EMC testing with an approved lab yet?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-006', 'RC-CEL-025', 2, 'Stage 0→1'),
  ('S01-CEL-008', 'How many months has your launch plan set aside for certification?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-006', 'RC-CEL-026', 2, 'Stage 0→1'),
  ('S01-CEL-009', 'How much money have you kept aside for testing and certification costs?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-006', 'RC-CEL-027', 2, 'Stage 0→1'),
  ('S01-CEL-010', 'What is your plan if your product fails its first certification test?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-006', 'RC-CEL-028', 3, 'Stage 0→1'),
  ('S01-CEL-011', 'Do you have a confirmed supplier for your key parts, or just prices you found online?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-007', 'RC-CEL-029', 2, 'Stage 0→1'),
  ('S01-CEL-012', 'What is the smallest quantity you would have to order for your main components?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-007', 'RC-CEL-030', 2, 'Stage 0→1'),
  ('S01-CEL-013', 'How long would it take for your key parts to arrive after you place an order?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-007', 'RC-CEL-031', 2, 'Stage 0→1'),
  ('S01-CEL-014', 'Do you have written quotes from suppliers, or only listed web prices?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-007', 'RC-CEL-032', 2, 'Stage 0→1'),
  ('S01-CEL-015', 'If your main supplier could not deliver, who would you go to instead?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-007', 'RC-CEL-033', 3, 'Stage 0→1'),
  ('S01-CEL-016', 'Is your cost per unit based on buying a few pieces, or on a real production order?', 'open_text', 'Financial Management', 'CORE', 'CEL-008', 'RC-CEL-034', 2, 'Stage 0→1'),
  ('S01-CEL-017', 'Have you got a written factory quote at 500 or 1000 units?', 'open_text', 'Financial Management', 'CORE', 'CEL-008', 'RC-CEL-035', 2, 'Stage 0→1'),
  ('S01-CEL-018', 'Does your cost include what it takes to assemble the product, not just the parts?', 'open_text', 'Financial Management', 'CORE', 'CEL-008', 'RC-CEL-036', 2, 'Stage 0→1'),
  ('S01-CEL-019', 'If a customer unit stops working in month two, what happens right now?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-009', 'RC-CEL-038', 2, 'Stage 0→1'),
  ('S01-CEL-020', 'Out of every 100 units you sell, how many do you expect to come back as faulty?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-009', 'RC-CEL-040', 3, 'Stage 0→1'),
  ('S10-CEL-001', 'Do you know what percentage of your units come back faulty, or would you have to go and find out?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-010', 'RC-CEL-041', 2, 'Stage 1→10+'),
  ('S10-CEL-002', 'Are parts checked when they arrive, or do they go straight into production?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-010', 'RC-CEL-042', 2, 'Stage 1→10+'),
  ('S10-CEL-003', 'When the same fault appears again and again, does anyone find out why?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-010', 'RC-CEL-043', 3, 'Stage 1→10+'),
  ('S10-CEL-004', 'Does every production batch come out the same, or does quality depend on the run?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-010', 'RC-CEL-044', 3, 'Stage 1→10+'),
  ('S10-CEL-005', 'How do you usually find out about a quality problem, from your factory or from customers?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-010', 'RC-CEL-045', 2, 'Stage 1→10+'),
  ('S10-CEL-006', 'If a customer in a city you do not cover needs a repair, what actually happens?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-011', 'RC-CEL-046', 2, 'Stage 1→10+'),
  ('S10-CEL-007', 'Do you hold spare parts, or does a repair mean replacing the whole unit?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-011', 'RC-CEL-047', 2, 'Stage 1→10+'),
  ('S10-CEL-008', 'What does it cost you every time you replace a unit instead of repairing it?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-011', 'RC-CEL-048', 3, 'Stage 1→10+'),
  ('S10-CEL-009', 'How long do you tell a customer a repair will take, and do you measure whether you hit it?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-011', 'RC-CEL-049', 2, 'Stage 1→10+'),
  ('S10-CEL-010', 'Who handles service requests today, and how much of your own time does it take?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-011', 'RC-CEL-050', 2, 'Stage 1→10+'),
  ('S10-CEL-011', 'How much cash is sitting in stock right now, and how long has it been there?', 'open_text', 'Financial Management', 'CORE', 'CEL-012', 'RC-CEL-055', 2, 'Stage 1→10+'),
  ('S10-CEL-012', 'Do you review how old your stock is, or only how much of it there is?', 'open_text', 'Financial Management', 'CORE', 'CEL-012', 'RC-CEL-051', 2, 'Stage 1→10+'),
  ('S10-CEL-013', 'What happens to your product if a key component goes end of life?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-012', 'RC-CEL-052', 3, 'Stage 1→10+'),
  ('S10-CEL-014', 'Are your order quantities based on actual sales so far, or on what you hope to sell?', 'open_text', 'Financial Management', 'CORE', 'CEL-012', 'RC-CEL-053', 2, 'Stage 1→10+'),
  ('S10-CEL-015', 'When you launched your newest model, was the old stock already cleared?', 'open_text', 'Financial Management', 'CORE', 'CEL-012', 'RC-CEL-054', 2, 'Stage 1→10+'),
  ('S10-CEL-016', 'Did you work out your margin before agreeing retailer and marketplace terms, or after?', 'open_text', 'Financial Management', 'CORE', 'CEL-013', 'RC-CEL-056', 2, 'Stage 1→10+'),
  ('S10-CEL-017', 'Does your cost per unit include platform commission, returns and shipping?', 'open_text', 'Financial Management', 'CORE', 'CEL-013', 'RC-CEL-057', 2, 'Stage 1→10+'),
  ('S10-CEL-018', 'Have you cut your price to get shelf space, and did that price ever go back up?', 'open_text', 'Financial Management', 'CORE', 'CEL-013', 'RC-CEL-058', 3, 'Stage 1→10+'),
  ('S10-CEL-019', 'Which of your sales channels makes the most profit per unit, and which makes the least?', 'open_text', 'Financial Management', 'CORE', 'CEL-013', 'RC-CEL-059', 3, 'Stage 1→10+'),
  ('S10-CEL-020', 'If your factory stopped tomorrow, how long before you could produce anywhere else?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-014', 'RC-CEL-060', 3, 'Stage 1→10+'),
  ('S10-CEL-021', 'Have you ever trial produced with a second factory, or only talked about it?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-014', 'RC-CEL-061', 2, 'Stage 1→10+'),
  ('S10-CEL-022', 'Do all your key parts come from the same region, or are they spread out?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-014', 'RC-CEL-062', 2, 'Stage 1→10+'),
  ('S10-CEL-023', 'How many weeks could you keep selling if supply stopped today?', 'open_text', 'Operations & Systems', 'CORE', 'CEL-014', 'RC-CEL-063', 3, 'Stage 1→10+'),
  ('S10-CEL-024', 'Do you know when your current model gets replaced, or is that decision still open?', 'open_text', 'Strategy & Planning', 'CORE', 'CEL-015', 'RC-CEL-064', 2, 'Stage 1→10+'),
  ('S10-CEL-025', 'Is anyone working on the next product, or is all effort on the current one?', 'open_text', 'Strategy & Planning', 'CORE', 'CEL-015', 'RC-CEL-065', 2, 'Stage 1→10+')
...
new_interventions AS (
  ...
  FROM (VALUES
  ('INT-CEL-001', 'Ideation — Consumer Electronics Market Fundamentals', 'CEL-001', '["RC-CEL-002"]'::jsonb, '[1]'::jsonb, 'Market Validation', '["Visit a shop or online store and list 5 products that already do something close to yours.", "Note the price and the main selling point of each.", "Write down where your idea sits among them."]'::jsonb, '[{"name": "Competitor Shelf Scan", "brief": "Listing products already sold in the same category to see the real market."}]'::jsonb),
  ('INT-CEL-002', 'Ideation — Consumer Electronics Market Fundamentals', 'CEL-001', '["RC-CEL-001", "RC-CEL-003"]'::jsonb, '[1]'::jsonb, 'Market Validation', '["Write one sentence saying what makes your product different.", "Read it out to someone who does not know your idea.", "If they shrug, the difference is not strong enough yet."]'::jsonb, '[{"name": "Differentiation Statement", "brief": "A single clear sentence describing what makes the product different."}]'::jsonb),
  ('INT-CEL-003', 'Ideation — Consumer Electronics Market Fundamentals', 'CEL-001', '["RC-CEL-004", "RC-CEL-005"]'::jsonb, '[1]'::jsonb, 'Market Validation', '["Pick one brand your customer already trusts.", "Write down one honest reason someone would switch from it to you.", "If the only reason is price, check your cost first."]'::jsonb, '[{"name": "Switching Reason Test", "brief": "Testing whether there is a real reason for a customer to leave a trusted brand."}]'::jsonb),
  ('INT-CEL-004', 'Ideation — Consumer Electronics Cost Fundamentals', 'CEL-002', '["RC-CEL-006", "RC-CEL-007"]'::jsonb, '[1]'::jsonb, 'Financial Clarity', '["List the main parts your product needs.", "Find the price of each part online or from a supplier.", "Add them up to get a rough cost for one unit."]'::jsonb, '[{"name": "Bill of Materials (Basic)", "brief": "A simple list of parts and their costs to get a first unit cost."}]'::jsonb),
  ('INT-CEL-005', 'Ideation — Consumer Electronics Cost Fundamentals', 'CEL-002', '["RC-CEL-009"]'::jsonb, '[1]'::jsonb, 'Financial Clarity', '["Add packaging, testing, shipping and tooling to your parts cost.", "Keep these as separate lines so you can see each one.", "Compare the total against the price you had in mind."]'::jsonb, '[{"name": "Full Cost Picture", "brief": "Counting all costs, not just parts, before setting a price."}]'::jsonb),
  ('INT-CEL-006', 'Ideation — Consumer Electronics Cost Fundamentals', 'CEL-002', '["RC-CEL-008", "RC-CEL-010"]'::jsonb, '[1]'::jsonb, 'Financial Clarity', '["Write down the price you were planning to charge and why.", "Check it against your real cost per unit.", "If there is no margin left, change the product or the price now, not later."]'::jsonb, '[{"name": "Cost Before Price", "brief": "Setting price only after the real cost of making one unit is known."}]'::jsonb),
  ('INT-CEL-007', 'Ideation — Consumer Electronics Build Reality', 'CEL-003', '["RC-CEL-011", "RC-CEL-014"]'::jsonb, '[1]'::jsonb, 'Execution Planning', '["Write your expected timeline from idea to first sellable unit.", "Show it to someone who has built a physical product before.", "Adjust it based on what they tell you."]'::jsonb, '[{"name": "Hardware Timeline Check", "brief": "Testing a build timeline against someone with real hardware experience."}]'::jsonb),
  ('INT-CEL-008', 'Ideation — Consumer Electronics Build Reality', 'CEL-003', '["RC-CEL-012", "RC-CEL-013"]'::jsonb, '[1]'::jsonb, 'Execution Planning', '["Ask one manufacturer what a mould or tool for your product would cost and how long it takes.", "Ask what happens if the design changes after tooling is made.", "Write both answers into your plan."]'::jsonb, '[{"name": "Tooling Reality Check", "brief": "Getting real tooling cost and lead time from a manufacturer early."}]'::jsonb),
  ('INT-CEL-009', 'Ideation — Consumer Electronics Customer Clarity', 'CEL-004', '["RC-CEL-015", "RC-CEL-016"]'::jsonb, '[1]'::jsonb, 'Customer Clarity', '["Pick one specific type of person to build for first.", "Describe one moment in their day when they would use your product.", "Write both down in two lines."]'::jsonb, '[{"name": "One Customer, One Moment", "brief": "Narrowing to a single customer type and a single clear use moment."}]'::jsonb),
  ('INT-CEL-010', 'Ideation — Consumer Electronics Customer Clarity', 'CEL-004', '["RC-CEL-017", "RC-CEL-018"]'::jsonb, '[1]'::jsonb, 'Customer Clarity', '["Talk to 5 people who are not friends or family.", "Ask what they use today instead of your product.", "Ask what would make them buy something new now rather than later."]'::jsonb, '[{"name": "Outside Feedback Round", "brief": "Getting first honest reactions from people with no personal connection to the founder."}]'::jsonb),
  ('INT-CEL-011', 'Validation to Traction — Consumer Electronics Manufacturability', 'CEL-005', '["RC-CEL-019", "RC-CEL-021"]'::jsonb, '[2, 3, 4]'::jsonb, 'Product Development', '["Send your design to one contract manufacturer for review.", "Ask them to list every change needed to make it producible.", "Work through that list before building another prototype."]'::jsonb, '[{"name": "Design for Manufacturing Review", "brief": "Getting a real manufacturer to mark up the design before production planning."}]'::jsonb),
  ('INT-CEL-012', 'Validation to Traction — Consumer Electronics Manufacturability', 'CEL-005', '["RC-CEL-020", "RC-CEL-023"]'::jsonb, '[2, 3, 4]'::jsonb, 'Product Development', '["List every part in your prototype.", "Mark the ones you cannot buy in production quantities.", "Find a production equivalent for each one before locking the design."]'::jsonb, '[{"name": "Production Parts Swap List", "brief": "Replacing prototype only components with parts available at volume."}]'::jsonb),
  ('INT-CEL-013', 'Validation to Traction — Consumer Electronics Compliance', 'CEL-006', '["RC-CEL-024"]'::jsonb, '[2, 3, 4]'::jsonb, 'Compliance', '["Identify the exact certification your product category needs.", "Submit the application this month rather than researching further.", "Record the submission date and expected decision date."]'::jsonb, '[{"name": "File, Do Not Research", "brief": "Moving from understanding a compliance requirement to actually submitting it."}]'::jsonb),
  ('INT-CEL-014', 'Validation to Traction — Consumer Electronics Compliance', 'CEL-006', '["RC-CEL-025", "RC-CEL-026"]'::jsonb, '[2, 3, 4]'::jsonb, 'Compliance', '["Book testing with an approved lab and get a date in writing.", "Add that date and the retest window to your launch plan.", "Move your launch date if the two do not fit."]'::jsonb, '[{"name": "Certification in the Timeline", "brief": "Putting real testing dates into the launch plan instead of assuming they fit."}]'::jsonb),
  ('INT-CEL-015', 'Validation to Traction — Consumer Electronics Compliance', 'CEL-006', '["RC-CEL-027", "RC-CEL-028"]'::jsonb, '[2, 3, 4]'::jsonb, 'Compliance', '["Ask the lab what a full test plus one retest costs.", "Set that amount aside as a separate line in your budget.", "Assume at least one retest will be needed."]'::jsonb, '[{"name": "Compliance Budget Line", "brief": "Treating certification cost and a likely retest as a planned expense."}]'::jsonb),
  ('INT-CEL-016', 'Validation to Traction — Consumer Electronics Supply Chain', 'CEL-007', '["RC-CEL-029", "RC-CEL-032"]'::jsonb, '[2, 3, 4]'::jsonb, 'Supply Chain', '["Pick your five most critical components.", "Get a written quote from a real supplier for each one.", "Keep the quotes on file with dates and validity periods."]'::jsonb, '[{"name": "Written Quotes Only", "brief": "Replacing web listed prices with real supplier quotes for critical parts."}]'::jsonb),
  ('INT-CEL-017', 'Validation to Traction — Consumer Electronics Supply Chain', 'CEL-007', '["RC-CEL-030", "RC-CEL-031"]'::jsonb, '[2, 3, 4]'::jsonb, 'Supply Chain', '["Ask each supplier for minimum order quantity and lead time.", "Put both numbers next to each part in one sheet.", "Check whether your cash and timeline can actually meet them."]'::jsonb, '[{"name": "MOQ and Lead Time Sheet", "brief": "A single view of order minimums and delivery times for every key part."}]'::jsonb),
  ('INT-CEL-018', 'Validation to Traction — Consumer Electronics Supply Chain', 'CEL-007', '["RC-CEL-033"]'::jsonb, '[2, 3, 4]'::jsonb, 'Supply Chain', '["Find a second source for every single source component.", "Get at least an indicative price from them.", "Note which parts still have no backup and treat those as your real risk."]'::jsonb, '[{"name": "Second Source Mapping", "brief": "Identifying a backup supplier for each critical component before volume production."}]'::jsonb),
  ('INT-CEL-019', 'Validation to Traction — Consumer Electronics Unit Economics', 'CEL-008', '["RC-CEL-034", "RC-CEL-035"]'::jsonb, '[2, 3, 4]'::jsonb, 'Financial Clarity', '["Ask a factory for a written price at your realistic first order size.", "Compare it against the cost you have been planning with.", "Update every number that depended on the old cost."]'::jsonb, '[{"name": "Volume Quote Reset", "brief": "Rebuilding unit economics on a real factory quote at production volume."}]'::jsonb),
  ('INT-CEL-020', 'Validation to Traction — Consumer Electronics Unit Economics', 'CEL-008', '["RC-CEL-036", "RC-CEL-037"]'::jsonb, '[2, 3, 4]'::jsonb, 'Financial Clarity', '["Add assembly, testing, packaging and freight to your parts cost.", "Recalculate your margin on that full number.", "If the margin disappears, fix it before you order stock."]'::jsonb, '[{"name": "Landed Cost Margin Check", "brief": "Checking margin against the full cost of a finished, delivered unit."}]'::jsonb),
  ('INT-CEL-021', 'Validation to Traction — Consumer Electronics Service Readiness', 'CEL-009', '["RC-CEL-038", "RC-CEL-039"]'::jsonb, '[2, 3, 4]'::jsonb, 'Operations', '["Write your warranty in plain language on one page.", "Decide whether a failed unit gets repaired or replaced.", "Write down who does it and how the customer sends it back."]'::jsonb, '[{"name": "One Page Warranty", "brief": "A simple written promise and process for handling failed units."}]'::jsonb),
  ('INT-CEL-022', 'Validation to Traction — Consumer Electronics Service Readiness', 'CEL-009', '["RC-CEL-040"]'::jsonb, '[2, 3, 4]'::jsonb, 'Operations', '["Estimate how many units out of 100 will fail in the first year.", "Multiply that by your unit cost to get a replacement reserve.", "Hold that money back before counting your profit."]'::jsonb, '[{"name": "Failure Rate Reserve", "brief": "Setting aside money for expected returns and replacements before booking profit."}]'::jsonb),
  ('INT-CEL-023', 'Growth to Maturity — Consumer Electronics Quality Control', 'CEL-010', '["RC-CEL-041", "RC-CEL-045"]'::jsonb, '[5, 6, 7]'::jsonb, 'Operations', '["Start recording defects by batch and by fault type.", "Review the numbers once a month, not only when complaints spike.", "Set a defect rate you will not accept and act when it is crossed."]'::jsonb, '[{"name": "Defect Rate Tracking", "brief": "Measuring failures by batch and fault type so quality problems surface early."}]'::jsonb),
  ('INT-CEL-024', 'Growth to Maturity — Consumer Electronics Quality Control', 'CEL-010', '["RC-CEL-042", "RC-CEL-044"]'::jsonb, '[5, 6, 7]'::jsonb, 'Operations', '["Add a simple incoming check for critical components.", "Write one quality checklist every batch must pass before shipping.", "Keep the checklist the same across runs and factories."]'::jsonb, '[{"name": "Incoming and Outgoing Checks", "brief": "A fixed inspection standard applied to every batch, not per run."}]'::jsonb),
  ('INT-CEL-025', 'Growth to Maturity — Consumer Electronics Quality Control', 'CEL-010', '["RC-CEL-043"]'::jsonb, '[5, 6, 7]'::jsonb, 'Operations', '["Pick your most common repeat fault.", "Trace it back to the part, process or supplier causing it.", "Fix that cause before adding more production volume."]'::jsonb, '[{"name": "Repeat Fault Root Cause", "brief": "Tracing recurring defects to their source instead of replacing units."}]'::jsonb),
  ('INT-CEL-026', 'Growth to Maturity — Consumer Electronics After Sales', 'CEL-011', '["RC-CEL-046", "RC-CEL-049"]'::jsonb, '[5, 6, 7]'::jsonb, 'Operations', '["List the cities where you now have customers but no service option.", "Set up one repair partner or collection point per priority city.", "Publish a turnaround time and start measuring against it."]'::jsonb, '[{"name": "Minimum Service Coverage", "brief": "A basic repair route and promised turnaround wherever customers exist."}]'::jsonb),
  ('INT-CEL-027', 'Growth to Maturity — Consumer Electronics After Sales', 'CEL-011', '["RC-CEL-047", "RC-CEL-048"]'::jsonb, '[5, 6, 7]'::jsonb, 'Operations', '["Identify the parts that fail most often.", "Hold spare stock of those parts so repairs are possible.", "Compare repair cost against full replacement cost for each fault."]'::jsonb, '[{"name": "Repair Before Replace", "brief": "Holding spares for common failures to stop margin leaking through replacements."}]'::jsonb),
  ('INT-CEL-028', 'Growth to Maturity — Consumer Electronics After Sales', 'CEL-011', '["RC-CEL-050"]'::jsonb, '[5, 6, 7]'::jsonb, 'Operations', '["Write down the steps you personally follow to handle a service request.", "Hand that process to one named person.", "Review it weekly instead of doing it yourself."]'::jsonb, '[{"name": "Service Handover", "brief": "Moving after sales off the founder by documenting and assigning the process."}]'::jsonb),
  ('INT-CEL-029', 'Growth to Maturity — Consumer Electronics Inventory Risk', 'CEL-012', '["RC-CEL-051", "RC-CEL-055"]'::jsonb, '[5, 6, 7]'::jsonb, 'Financial Clarity', '["List your stock by age in weeks and the cash sitting in each bucket.", "Set an age limit after which stock gets discounted or cleared.", "Review this once a month."]'::jsonb, '[{"name": "Stock Ageing Review", "brief": "Tracking inventory by age and cash locked up, with a clearance trigger."}]'::jsonb),
  ('INT-CEL-030', 'Growth to Maturity — Consumer Electronics Inventory Risk', 'CEL-012', '["RC-CEL-052", "RC-CEL-053"]'::jsonb, '[5, 6, 7]'::jsonb, 'Supply Chain', '["Ask suppliers which of your parts are nearing end of life.", "Set order quantities from actual sell through, not forecasts.", "Plan a redesign or last time buy for any part being discontinued."]'::jsonb, '[{"name": "End of Life Watch", "brief": "Spotting components being discontinued before they strand the design."}]'::jsonb),
  ('INT-CEL-031', 'Growth to Maturity — Consumer Electronics Channel Economics', 'CEL-013', '["RC-CEL-056", "RC-CEL-057"]'::jsonb, '[5, 6, 7]'::jsonb, 'Financial Clarity', '["Build one sheet showing profit per unit for each channel.", "Include commission, returns, shipping and listing costs.", "Renegotiate or exit any channel that loses money."]'::jsonb, '[{"name": "Profit by Channel", "brief": "Seeing true margin per channel after all fees and returns."}]'::jsonb),
  ('INT-CEL-032', 'Growth to Maturity — Consumer Electronics Channel Economics', 'CEL-013', '["RC-CEL-058", "RC-CEL-059"]'::jsonb, '[5, 6, 7]'::jsonb, 'Financial Clarity', '["List every discount currently running and why it started.", "Decide which ones end and on what date.", "Agree a price floor no channel is allowed to go below."]'::jsonb, '[{"name": "Discount Cleanup", "brief": "Ending legacy discounts and setting one price floor across channels."}]'::jsonb),
  ('INT-CEL-033', 'Growth to Maturity — Consumer Electronics Supply Risk', 'CEL-014', '["RC-CEL-060", "RC-CEL-061", "RC-CEL-062"]'::jsonb, '[5, 6, 7]'::jsonb, 'Supply Chain', '["Identify a second factory and run one small trial order with them.", "Split at least one key part across two sourcing regions.", "Write down how long a full switch would take."]'::jsonb, '[{"name": "Second Source Qualification", "brief": "Proving an alternative factory works before you are forced to use it."}]'::jsonb),
  ('INT-CEL-034', 'Growth to Maturity — Consumer Electronics Lifecycle Planning', 'CEL-015', '["RC-CEL-064", "RC-CEL-065", "RC-CEL-066"]'::jsonb, '[5, 6, 7]'::jsonb, 'Strategy', '["Set an end of life date for your current model.", "Name who is working on the next one and what stage it is at.", "Track how often your main competitors launch new versions."]'::jsonb, '[{"name": "Next Model Roadmap", "brief": "A dated plan for retiring the current product and readying its replacement."}]'::jsonb)
...
new_root_causes AS (
  ...
  ('RC-EDU-019', 'Completion Never Measured by Lesson', 'Nobody knows at which lesson learners actually stop.', 'EDU-005', 'external', 'Operational', 0.71, 'Stage 0→1'),
  ('RC-EDU-020', 'No Support When a Learner Gets Stuck', 'A learner who hits a hard point has nowhere to turn.', 'EDU-005', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-EDU-021', 'Lessons Too Long for Real Learner Time', 'Content length ignores how much time learners really have.', 'EDU-005', 'external', 'Strategic', 0.65, 'Stage 0→1'),
  ('RC-EDU-022', 'No Follow Up When a Learner Goes Quiet', 'Silence from a learner triggers no action at all.', 'EDU-005', 'external', 'Behavioural', 0.66, 'Stage 0→1'),
  ('RC-EDU-023', 'Refunds Linked to Not Finishing', 'People ask for money back because they never got through the course.', 'EDU-005', 'external', 'Operational', 0.62, 'Stage 0→1'),
  ('RC-EDU-024', 'Free to Paid Conversion Not Measured', 'The share of free users who pay is never calculated.', 'EDU-006', 'external', 'Operational', 0.70, 'Stage 0→1'),
  ('RC-EDU-025', 'Free Version Gives Away the Main Value', 'The free tier satisfies the need, so paying adds little.', 'EDU-006', 'external', 'Strategic', 0.69, 'Stage 0→1'),
  ('RC-EDU-026', 'No Clear Moment to Ask for Payment', 'There is no defined point where the learner is invited to pay.', 'EDU-006', 'external', 'Strategic', 0.66, 'Stage 0→1'),
  ('RC-EDU-027', 'Free Users Never Contacted', 'Nobody reaches out to free users after signup.', 'EDU-006', 'external', 'Behavioural', 0.64, 'Stage 0→1'),
  ('RC-EDU-028', 'Demo Class Not Connected to an Offer', 'The demo ends without a clear next step or offer.', 'EDU-006', 'external', 'Operational', 0.63, 'Stage 0→1'),
  ('RC-EDU-029', 'All Classes Taught by One Person', 'Delivery sits entirely with one individual.', 'EDU-007', 'external', 'Operational', 0.73, 'Stage 0→1'),
  ('RC-EDU-030', 'No Recorded Version of the Course', 'Everything is live, so nothing can run without that person.', 'EDU-007', 'external', 'Operational', 0.69, 'Stage 0→1'),
  ('RC-EDU-031', 'Growth Limited by One Calendar', 'How much the business can sell is capped by one persons hours.', 'EDU-007', 'external', 'Strategic', 0.68, 'Stage 0→1'),
  ('RC-EDU-032', 'No Second Teacher Trained', 'Nobody else has been prepared to deliver the same programme.', 'EDU-007', 'external', 'Operational', 0.66, 'Stage 0→1'),
  ('RC-EDU-033', 'Learners Attached to the Teacher Not the Programme', 'Demand follows the individual rather than the course.', 'EDU-007', 'external', 'Strategic', 0.64, 'Stage 0→1'),
  ('RC-EDU-034', 'Time Per Lesson Never Measured', 'How long a lesson really takes to produce has never been recorded.', 'EDU-008', 'external', 'Knowledge', 0.68, 'Stage 0→1'),
  ('RC-EDU-035', 'No Content Calendar', 'Production happens reactively with no schedule.', 'EDU-008', 'external', 'Operational', 0.66, 'Stage 0→1'),
  ('RC-EDU-036', 'Updates Postponed Indefinitely', 'Refreshing old content keeps slipping behind new content.', 'EDU-008', 'external', 'Behavioural', 0.63, 'Stage 0→1'),
  ('RC-EDU-037', 'Quality Dropping to Meet Deadlines', 'Lessons are rushed out to stay on schedule.', 'EDU-008', 'external', 'Operational', 0.62, 'Stage 0→1'),
  ('RC-EDU-038', 'No Before and After Measurement', 'Nothing captures where a learner started and where they ended.', 'EDU-009', 'external', 'Operational', 0.71, 'Stage 0→1'),
  ('RC-EDU-039', 'Testimonials Used in Place of Results', 'Positive quotes stand in for actual evidence of learning.', 'EDU-009', 'external', 'Behavioural', 0.66, 'Stage 0→1'),
  ('RC-EDU-040', 'Learner Outcomes Never Tracked', 'What happened to past learners is unknown.', 'EDU-009', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-EDU-041', 'No Written Teaching Standard', 'There is no agreed definition of what good teaching looks like here.', 'EDU-010', 'external', 'Operational', 0.72, 'Stage 1→10+'),
  ('RC-EDU-042', 'Teachers Never Observed After Hiring', 'Nobody watches a class once the teacher is onboarded.', 'EDU-010', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-EDU-043', 'Feedback Not Linked to Individual Teachers', 'Learner ratings are collected but never traced to who taught.', 'EDU-010', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-EDU-044', 'Faculty Onboarding Is Informal', 'New teachers learn by watching rather than from a defined process.', 'EDU-010', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-EDU-045', 'Experience Varies Sharply Between Batches', 'Two learners on the same programme get very different experiences.', 'EDU-010', 'external', 'Operational', 0.64, 'Stage 1→10+'),
  ('RC-EDU-046', 'Scheduling Handled in Spreadsheets and Chat', 'Batch and teacher allocation runs on tools that cannot hold the volume.', 'EDU-011', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-EDU-047', 'Clashes and Double Bookings Happening', 'Errors in allocation are reaching learners and teachers.', 'EDU-011', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-EDU-048', 'Founder Time Consumed by Scheduling', 'Senior time goes into timetable work instead of the business.', 'EDU-011', 'external', 'Behavioural', 0.66, 'Stage 1→10+'),
  ('RC-EDU-049', 'No Single View of Batches and Teachers', 'Information is spread across files and chats with no one source.', 'EDU-011', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-EDU-050', 'Approval Requirements Not Mapped', 'New offerings launch before anyone checks what approval they need.', 'EDU-012', 'external', 'Knowledge', 0.73, 'Stage 1→10+'),
  ('RC-EDU-051', 'Certification Claims Cannot Be Backed', 'What is promised about certificates is stronger than what is actually held.', 'EDU-012', 'external', 'Strategic', 0.70, 'Stage 1→10+'),
  ('RC-EDU-052', 'No Compliance Owner', 'Nobody is responsible for keeping approvals current.', 'EDU-012', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-EDU-053', 'State Level Differences Not Researched', 'Rules that vary by state are assumed to be the same everywhere.', 'EDU-012', 'external', 'Knowledge', 0.65, 'Stage 1→10+'),
  ('RC-EDU-054', 'Partnerships Used to Sidestep Approvals', 'Tie ups are used as a workaround rather than a proper route.', 'EDU-012', 'external', 'Strategic', 0.63, 'Stage 1→10+'),
  ('RC-EDU-055', 'Refunds and Complaints Rising With Enrolments', 'Growth in signups is matched by growth in dissatisfaction.', 'EDU-013', 'external', 'Operational', 0.71, 'Stage 1→10+'),
  ('RC-EDU-056', 'Counsellors Promising Unguaranteed Outcomes', 'Job or score promises are made that the programme cannot ensure.', 'EDU-013', 'external', 'Behavioural', 0.72, 'Stage 1→10+'),
  ('RC-EDU-057', 'Incentives Reward Enrolment Only', 'Counsellor pay depends on signing people up, not on them succeeding.', 'EDU-013', 'external', 'Strategic', 0.69, 'Stage 1→10+'),
  ('RC-EDU-058', 'No Check on What Is Said in Counselling', 'Nobody reviews or records what is actually promised to a prospect.', 'EDU-013', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-EDU-059', 'Reviews Mentioning Sales Pressure', 'Public feedback is starting to describe the selling, not the teaching.', 'EDU-013', 'external', 'Operational', 0.64, 'Stage 1→10+'),
  ('RC-EDU-060', 'Large Share of Content Over Two Years Old', 'Much of the library has not been reviewed since it was made.', 'EDU-014', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-EDU-061', 'Duplicate Lessons on the Same Topic', 'The same subject is covered several times in different places.', 'EDU-014', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-EDU-062', 'No Owner for the Content Library', 'Nobody is responsible for what the library contains overall.', 'EDU-014', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-EDU-063', 'No Retirement Process for Content', 'Nothing is ever formally removed from the catalogue.', 'EDU-014', 'external', 'Operational', 0.63, 'Stage 1→10+'),
  ('RC-EDU-064', 'Consumer Approach Used for Institutions', 'Institutional buyers are sold to as if they were individual learners.', 'EDU-015', 'external', 'Strategic', 0.70, 'Stage 1→10+'),
  ('RC-EDU-065', 'Procurement and Tender Steps Not Understood', 'How institutions actually buy has never been learned.', 'EDU-015', 'external', 'Knowledge', 0.68, 'Stage 1→10+'),
  ('RC-EDU-066', 'Long Payment Cycles Straining Cash', 'Institutional payment terms are much slower than the business is built for.', 'EDU-015', 'external', 'Operational', 0.66, 'Stage 1→10+')
  ) AS t(root_cause_code, root_cause_name, explanation, problem_code, layer,
         root_cause_category, confidence_weight, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  CROSS JOIN z
...
new_questions AS (
  ...
  ('S01-EDU-001', 'Out of everyone who enrolled last month, how many actually finished?', 'open_text', 'Product Development', 'CORE', 'EDU-005', 'RC-EDU-019', 2, 'Stage 0→1'),
  ('S01-EDU-002', 'At which lesson do most learners stop?', 'open_text', 'Product Development', 'CORE', 'EDU-005', 'RC-EDU-019', 2, 'Stage 0→1'),
  ('S01-EDU-003', 'What happens when a learner gets stuck on something?', 'open_text', 'Product Development', 'CORE', 'EDU-005', 'RC-EDU-020', 2, 'Stage 0→1'),
  ('S01-EDU-004', 'How long is one lesson, and how much time does your learner really have?', 'open_text', 'Product Development', 'CORE', 'EDU-005', 'RC-EDU-021', 2, 'Stage 0→1'),
  ('S01-EDU-005', 'If a learner goes quiet for two weeks, does anyone notice or reach out?', 'open_text', 'Product Development', 'CORE', 'EDU-005', 'RC-EDU-022', 2, 'Stage 0→1'),
  ('S01-EDU-006', 'How many refund requests did you get last month, and why?', 'open_text', 'Product Development', 'CORE', 'EDU-005', 'RC-EDU-023', 2, 'Stage 0→1'),
  ('S01-EDU-007', 'What share of your free users end up paying?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-006', 'RC-EDU-024', 2, 'Stage 0→1'),
  ('S01-EDU-008', 'Does your free version already solve the problem, or does it leave a real reason to pay?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-006', 'RC-EDU-025', 3, 'Stage 0→1'),
  ('S01-EDU-009', 'At what exact point is a free user asked to pay?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-006', 'RC-EDU-026', 2, 'Stage 0→1'),
  ('S01-EDU-010', 'After someone signs up free, does anyone contact them?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-006', 'RC-EDU-027', 2, 'Stage 0→1'),
  ('S01-EDU-011', 'What happens at the end of a demo class?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-006', 'RC-EDU-028', 2, 'Stage 0→1'),
  ('S01-EDU-012', 'If you were unwell for two weeks, would classes still run?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-007', 'RC-EDU-029', 2, 'Stage 0→1'),
  ('S01-EDU-013', 'Is any part of your course recorded, or is everything live?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-007', 'RC-EDU-030', 2, 'Stage 0→1'),
  ('S01-EDU-014', 'How many more learners could you take on without adding hours to your week?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-007', 'RC-EDU-031', 3, 'Stage 0→1'),
  ('S01-EDU-015', 'Has anyone else been trained to teach your programme?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-007', 'RC-EDU-032', 2, 'Stage 0→1'),
  ('S01-EDU-016', 'Do learners come for your course, or specifically for you?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-007', 'RC-EDU-033', 3, 'Stage 0→1'),
  ('S01-EDU-017', 'How many hours does one lesson take to make, start to finish?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-008', 'RC-EDU-034', 2, 'Stage 0→1'),
  ('S01-EDU-018', 'Do you have a content calendar, or is content made when there is time?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-008', 'RC-EDU-035', 2, 'Stage 0→1'),
  ('S01-EDU-019', 'When did you last update an older lesson?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-008', 'RC-EDU-036', 2, 'Stage 0→1'),
  ('S01-EDU-020', 'Can you show a buyer any proof that your learners actually improved?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-009', 'RC-EDU-038', 2, 'Stage 0→1'),
  ('S10-EDU-001', 'Does a learner get the same quality whichever teacher they are assigned?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-010', 'RC-EDU-041', 2, 'Stage 1→10+'),
  ('S10-EDU-002', 'When did you last sit in on one of your teachers classes?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-010', 'RC-EDU-042', 2, 'Stage 1→10+'),
  ('S10-EDU-003', 'How do you know if one of your teachers is underperforming?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-010', 'RC-EDU-043', 2, 'Stage 1→10+'),
  ('S10-EDU-004', 'What does a new teacher go through before their first class?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-010', 'RC-EDU-044', 2, 'Stage 1→10+'),
  ('S10-EDU-005', 'Would two learners in different batches describe the same experience?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-010', 'RC-EDU-045', 3, 'Stage 1→10+'),
  ('S10-EDU-006', 'How much of your week goes into scheduling batches and teachers?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-011', 'RC-EDU-048', 2, 'Stage 1→10+'),
  ('S10-EDU-007', 'Where does your batch and teacher schedule actually live?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-011', 'RC-EDU-046', 2, 'Stage 1→10+'),
  ('S10-EDU-008', 'When did you last have a clash or double booking?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-011', 'RC-EDU-047', 2, 'Stage 1→10+'),
  ('S10-EDU-009', 'Can you see all batches and teacher availability in one place?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-011', 'RC-EDU-049', 2, 'Stage 1→10+'),
  ('S10-EDU-010', 'Do you know what approvals you need before offering this in a new state or as a certification?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-012', 'RC-EDU-050', 3, 'Stage 1→10+'),
  ('S10-EDU-011', 'Can you back up everything you claim about your certificates?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-012', 'RC-EDU-051', 3, 'Stage 1→10+'),
  ('S10-EDU-012', 'Who in your team is responsible for keeping approvals current?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-012', 'RC-EDU-052', 2, 'Stage 1→10+'),
  ('S10-EDU-013', 'Have you checked whether the rules differ in the states you operate in?', 'open_text', 'Operations & Systems', 'CORE', 'EDU-012', 'RC-EDU-053', 2, 'Stage 1→10+'),
  ('S10-EDU-014', 'What percentage of enrolments end in a refund or complaint, and why?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-013', 'RC-EDU-055', 2, 'Stage 1→10+'),
  ('S10-EDU-015', 'What exactly do your counsellors promise a prospect about outcomes?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-013', 'RC-EDU-056', 3, 'Stage 1→10+'),
  ('S10-EDU-016', 'Are your counsellors paid for enrolments only, or also for learners who succeed?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-013', 'RC-EDU-057', 3, 'Stage 1→10+'),
  ('S10-EDU-017', 'Does anyone review what is actually said during a counselling call?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-013', 'RC-EDU-058', 2, 'Stage 1→10+'),
  ('S10-EDU-018', 'What do your recent public reviews talk about most?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-013', 'RC-EDU-059', 2, 'Stage 1→10+'),
  ('S10-EDU-019', 'How much of your content library is more than two years old?', 'open_text', 'Product Development', 'CORE', 'EDU-014', 'RC-EDU-060', 2, 'Stage 1→10+'),
  ('S10-EDU-020', 'Do you have several lessons covering the same topic in different places?', 'open_text', 'Product Development', 'CORE', 'EDU-014', 'RC-EDU-061', 2, 'Stage 1→10+'),
  ('S10-EDU-021', 'Who owns the content library as a whole?', 'open_text', 'Product Development', 'CORE', 'EDU-014', 'RC-EDU-062', 2, 'Stage 1→10+'),
  ('S10-EDU-022', 'Has anything ever been removed from your catalogue?', 'open_text', 'Product Development', 'CORE', 'EDU-014', 'RC-EDU-063', 2, 'Stage 1→10+'),
  ('S10-EDU-023', 'Do you sell to schools and companies the same way you sell to individuals?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-015', 'RC-EDU-064', 2, 'Stage 1→10+'),
  ('S10-EDU-024', 'How long does an institutional deal take from first meeting to payment?', 'open_text', 'Sales & Revenue', 'CORE', 'EDU-015', 'RC-EDU-065', 3, 'Stage 1→10+'),
  ('S10-EDU-025', 'How do institutional payment terms affect your cash each month?', 'open_text', 'Financial Management', 'CORE', 'EDU-015', 'RC-EDU-066', 3, 'Stage 1→10+')
  ) AS t(question_code, question_text, question_type, category, priority,
         problem_code, root_cause_code, difficulty_level, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  JOIN new_root_causes nr ON nr.root_cause_code = t.root_cause_code
...
new_root_causes AS (
  ...
  ('RC-ENR-019', 'No Site Survey Before Quoting', 'Prices are given without anyone visiting and assessing the site.', 'ENR-005', 'external', 'Operational', 0.72, 'Stage 0→1'),
  ('RC-ENR-020', 'Costs Quoted From a Supplier List', 'Pricing uses list prices rather than what projects actually cost to deliver.', 'ENR-005', 'external', 'Knowledge', 0.68, 'Stage 0→1'),
  ('RC-ENR-021', 'Approval Delays Not in the Timeline', 'Schedules assume permissions arrive instantly.', 'ENR-005', 'external', 'Strategic', 0.67, 'Stage 0→1'),
  ('RC-ENR-022', 'Scope Changes Accepted Without Repricing', 'Extra work is absorbed rather than charged for.', 'ENR-005', 'external', 'Behavioural', 0.66, 'Stage 0→1'),
  ('RC-ENR-023', 'Quoted Versus Actual Never Compared', 'Nobody checks afterwards how close the quote was to reality.', 'ENR-005', 'external', 'Operational', 0.65, 'Stage 0→1'),
  ('RC-ENR-024', 'Cash Plan Assumes Subsidy Arrives on Time', 'The forecast treats government money as if it were predictable.', 'ENR-006', 'external', 'Strategic', 0.71, 'Stage 0→1'),
  ('RC-ENR-025', 'No Buffer for Delayed Receivables', 'Nothing is held back to survive a late payment.', 'ENR-006', 'external', 'Operational', 0.69, 'Stage 0→1'),
  ('RC-ENR-026', 'Paying Suppliers Before Being Paid', 'Money goes out well before it comes in, with no terms to soften it.', 'ENR-006', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-ENR-027', 'Claim Follow Up Handled Ad Hoc', 'Chasing subsidy claims happens only when someone remembers.', 'ENR-006', 'external', 'Behavioural', 0.63, 'Stage 0→1'),
  ('RC-ENR-028', 'Payment Delay Length Not Tracked', 'How late payments actually run has never been measured.', 'ENR-006', 'external', 'Knowledge', 0.64, 'Stage 0→1'),
  ('RC-ENR-029', 'No Maintenance Contract Offered', 'Customers are never sold an ongoing service arrangement.', 'ENR-007', 'external', 'Strategic', 0.70, 'Stage 0→1'),
  ('RC-ENR-030', 'No Process When Equipment Fails', 'A breakdown is handled differently every time.', 'ENR-007', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-ENR-031', 'No Revenue After Installation', 'The business earns nothing once the equipment is handed over.', 'ENR-007', 'external', 'Strategic', 0.67, 'Stage 0→1'),
  ('RC-ENR-032', 'Customers Call the Founder for Repairs', 'Service requests land personally on the founder.', 'ENR-007', 'external', 'Behavioural', 0.64, 'Stage 0→1'),
  ('RC-ENR-033', 'No Record of What Was Installed Where', 'There is no list of sites, equipment and dates to service from.', 'ENR-007', 'external', 'Operational', 0.65, 'Stage 0→1'),
  ('RC-ENR-034', 'No Lender or Financing Partner', 'Nobody has been tied up to fund customer purchases.', 'ENR-008', 'external', 'Strategic', 0.71, 'Stage 0→1'),
  ('RC-ENR-035', 'No EMI or Lease Option Offered', 'The only way to buy is paying the whole amount at once.', 'ENR-008', 'external', 'Strategic', 0.68, 'Stage 0→1'),
  ('RC-ENR-036', 'Founder Funding Customer Purchases', 'The business absorbs customer financing out of its own pocket.', 'ENR-008', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-ENR-037', 'Payment Terms Decided Deal by Deal', 'Every customer negotiates their own terms with no standard.', 'ENR-008', 'external', 'Operational', 0.63, 'Stage 0→1'),
  ('RC-ENR-038', 'No Standard Installation Checklist', 'There is no fixed sequence of steps for doing a site.', 'ENR-009', 'external', 'Operational', 0.70, 'Stage 0→1'),
  ('RC-ENR-039', 'Each Site Planned From Scratch', 'Every project starts as if it were the first one.', 'ENR-009', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-ENR-040', 'Lessons From Past Sites Not Recorded', 'What went wrong last time is never written down.', 'ENR-009', 'external', 'Behavioural', 0.66, 'Stage 0→1'),
  ('RC-ENR-041', 'Cash Tied Up Per Project Never Measured', 'Nobody knows how much money one project locks up or for how long.', 'ENR-010', 'external', 'Knowledge', 0.73, 'Stage 1→10+'),
  ('RC-ENR-042', 'Orders Accepted Without Funding Check', 'New work is taken on without asking whether it can be funded.', 'ENR-010', 'external', 'Behavioural', 0.71, 'Stage 1→10+'),
  ('RC-ENR-043', 'No Working Capital Facility', 'No credit line exists to bridge project spending.', 'ENR-010', 'external', 'Strategic', 0.69, 'Stage 1→10+'),
  ('RC-ENR-044', 'Payment Milestones Loaded to the End', 'Most of the money arrives only after the work is finished.', 'ENR-010', 'external', 'Strategic', 0.67, 'Stage 1→10+'),
  ('RC-ENR-045', 'Growth Increasing Cash Strain', 'Each new order makes the cash position worse rather than better.', 'ENR-010', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-ENR-046', 'Service Team Far Behind Site Count', 'Live sites have grown much faster than the people servicing them.', 'ENR-011', 'external', 'Operational', 0.72, 'Stage 1→10+'),
  ('RC-ENR-047', 'Service Requests Queuing Up', 'Requests wait because capacity cannot absorb them.', 'ENR-011', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-ENR-048', 'No Regional Service Coverage', 'Distant sites have nobody nearby who can attend.', 'ENR-011', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-ENR-049', 'Maintenance Visits Missed', 'Scheduled servicing slips because urgent breakdowns take priority.', 'ENR-011', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-ENR-050', 'Complaints Rising With Installed Base', 'Dissatisfaction grows in step with the number of live sites.', 'ENR-011', 'external', 'Operational', 0.64, 'Stage 1→10+'),
  ('RC-ENR-051', 'Guarantees Given in Contracts', 'Output or savings promises are written into customer agreements.', 'ENR-012', 'external', 'Strategic', 0.71, 'Stage 1→10+'),
  ('RC-ENR-052', 'Actual Performance Not Monitored', 'What each site really produces is not measured against what was promised.', 'ENR-012', 'external', 'Operational', 0.73, 'Stage 1→10+'),
  ('RC-ENR-053', 'No Early Warning for Underperformance', 'A failing site is discovered only when the customer complains.', 'ENR-012', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-ENR-054', 'Warranty Claims Handled Case by Case', 'Every claim is negotiated separately with no policy.', 'ENR-012', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-ENR-055', 'Guarantee Exposure Not Quantified', 'Nobody has added up what the promises could cost if called in.', 'ENR-012', 'external', 'Knowledge', 0.68, 'Stage 1→10+'),
  ('RC-ENR-056', 'Model Depends on Current Tariff Rules', 'The economics only work under todays metering and tariff regime.', 'ENR-013', 'external', 'Strategic', 0.74, 'Stage 1→10+'),
  ('RC-ENR-057', 'No Scenario for a Policy Change', 'Nothing has been planned for rules shifting against the business.', 'ENR-013', 'external', 'Strategic', 0.71, 'Stage 1→10+'),
  ('RC-ENR-058', 'Subsidy Dependence Never Reduced', 'Reliance on government support has not decreased as the business grew.', 'ENR-013', 'external', 'Strategic', 0.69, 'Stage 1→10+'),
  ('RC-ENR-059', 'Policy News Not Tracked Systematically', 'Regulatory changes are learned about by accident.', 'ENR-013', 'external', 'Behavioural', 0.65, 'Stage 1→10+'),
  ('RC-ENR-060', 'No Pricing Flexibility if Rules Shift', 'Prices and contracts cannot absorb a change in the rules.', 'ENR-013', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-ENR-061', 'Same Playbook Applied to Every State', 'Expansion assumes what worked in one state works everywhere.', 'ENR-014', 'external', 'Strategic', 0.72, 'Stage 1→10+'),
  ('RC-ENR-062', 'Discom and Approval Differences Found Late', 'Local requirements surface only after committing to a project.', 'ENR-014', 'external', 'Knowledge', 0.70, 'Stage 1→10+'),
  ('RC-ENR-063', 'No Local Partner in New States', 'There is nobody on the ground who knows the local system.', 'ENR-014', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-ENR-064', 'Most Revenue From Two or Three Clients', 'A handful of buyers carry nearly all the income.', 'ENR-015', 'external', 'Strategic', 0.74, 'Stage 1→10+'),
  ('RC-ENR-065', 'Terms Dictated by the Large Buyer', 'Pricing and payment conditions are set by the client, not the business.', 'ENR-015', 'external', 'Strategic', 0.69, 'Stage 1→10+'),
  ('RC-ENR-066', 'No Pipeline of Smaller Customers', 'Nothing is being built that could replace a lost large client.', 'ENR-015', 'external', 'Strategic', 0.68, 'Stage 1→10+')
  ) AS t(root_cause_code, root_cause_name, explanation, problem_code, layer,
         root_cause_category, confidence_weight, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  CROSS JOIN z
...
new_questions AS (
  ...
  ('S01-ENR-001', 'On your last project, was the final cost the same as what you quoted?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-005', 'RC-ENR-023', 2, 'Stage 0→1'),
  ('S01-ENR-002', 'Do you do a site visit before giving a price?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-005', 'RC-ENR-019', 2, 'Stage 0→1'),
  ('S01-ENR-003', 'Is your pricing based on supplier lists or on what past projects really cost?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-005', 'RC-ENR-020', 2, 'Stage 0→1'),
  ('S01-ENR-004', 'Does your project timeline include waiting time for approvals?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-005', 'RC-ENR-021', 2, 'Stage 0→1'),
  ('S01-ENR-005', 'When a customer asks for extra work mid project, do you charge for it?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-005', 'RC-ENR-022', 2, 'Stage 0→1'),
  ('S01-ENR-006', 'How many months late was your last government or subsidy payment?', 'open_text', 'Financial Management', 'CORE', 'ENR-006', 'RC-ENR-028', 2, 'Stage 0→1'),
  ('S01-ENR-007', 'Does your cash plan assume subsidy money arrives on time?', 'open_text', 'Financial Management', 'CORE', 'ENR-006', 'RC-ENR-024', 2, 'Stage 0→1'),
  ('S01-ENR-008', 'If a payment came 6 months late, could the business survive it?', 'open_text', 'Financial Management', 'CORE', 'ENR-006', 'RC-ENR-025', 3, 'Stage 0→1'),
  ('S01-ENR-009', 'Do you pay your suppliers before your customer pays you?', 'open_text', 'Financial Management', 'CORE', 'ENR-006', 'RC-ENR-026', 2, 'Stage 0→1'),
  ('S01-ENR-010', 'Who chases your pending subsidy claims, and how often?', 'open_text', 'Financial Management', 'CORE', 'ENR-006', 'RC-ENR-027', 2, 'Stage 0→1'),
  ('S01-ENR-011', 'If the equipment you installed last year stops working, who fixes it and who pays?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-007', 'RC-ENR-030', 2, 'Stage 0→1'),
  ('S01-ENR-012', 'Do you earn anything after the installation is done?', 'open_text', 'Sales & Revenue', 'CORE', 'ENR-007', 'RC-ENR-031', 2, 'Stage 0→1'),
  ('S01-ENR-013', 'Do you offer customers any maintenance contract?', 'open_text', 'Sales & Revenue', 'CORE', 'ENR-007', 'RC-ENR-029', 2, 'Stage 0→1'),
  ('S01-ENR-014', 'When something breaks, who does the customer call?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-007', 'RC-ENR-032', 2, 'Stage 0→1'),
  ('S01-ENR-015', 'Do you have a list of every site, what was installed and when?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-007', 'RC-ENR-033', 2, 'Stage 0→1'),
  ('S01-ENR-016', 'When a customer says yes but cannot pay upfront, what do you offer them?', 'open_text', 'Sales & Revenue', 'CORE', 'ENR-008', 'RC-ENR-034', 2, 'Stage 0→1'),
  ('S01-ENR-017', 'Is there any EMI or lease option a customer can take?', 'open_text', 'Sales & Revenue', 'CORE', 'ENR-008', 'RC-ENR-035', 2, 'Stage 0→1'),
  ('S01-ENR-018', 'Have you ever funded a customer purchase out of your own money?', 'open_text', 'Financial Management', 'CORE', 'ENR-008', 'RC-ENR-036', 3, 'Stage 0→1'),
  ('S01-ENR-019', 'Is your second installation faster and cheaper than your first?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-009', 'RC-ENR-038', 2, 'Stage 0→1'),
  ('S01-ENR-020', 'When a site goes wrong, does anyone write down what happened?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-009', 'RC-ENR-040', 2, 'Stage 0→1'),
  ('S10-ENR-001', 'How much cash does one project tie up, and for how long?', 'open_text', 'Financial Management', 'CORE', 'ENR-010', 'RC-ENR-041', 2, 'Stage 1→10+'),
  ('S10-ENR-002', 'Do you check whether you can fund a project before accepting the order?', 'open_text', 'Financial Management', 'CORE', 'ENR-010', 'RC-ENR-042', 2, 'Stage 1→10+'),
  ('S10-ENR-003', 'Do you have a working capital line, or do you fund projects from revenue?', 'open_text', 'Financial Management', 'CORE', 'ENR-010', 'RC-ENR-043', 3, 'Stage 1→10+'),
  ('S10-ENR-004', 'When during a project do you actually get paid, start or end?', 'open_text', 'Financial Management', 'CORE', 'ENR-010', 'RC-ENR-044', 2, 'Stage 1→10+'),
  ('S10-ENR-005', 'Does taking on more orders make your cash position better or worse?', 'open_text', 'Financial Management', 'CORE', 'ENR-010', 'RC-ENR-045', 3, 'Stage 1→10+'),
  ('S10-ENR-006', 'How many sites are live now, and how many people service them?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-011', 'RC-ENR-046', 2, 'Stage 1→10+'),
  ('S10-ENR-007', 'How long does a customer wait for a service visit?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-011', 'RC-ENR-047', 2, 'Stage 1→10+'),
  ('S10-ENR-008', 'If a site is in a city you have no team in, who attends it?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-011', 'RC-ENR-048', 2, 'Stage 1→10+'),
  ('S10-ENR-009', 'Are scheduled maintenance visits actually happening on time?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-011', 'RC-ENR-049', 2, 'Stage 1→10+'),
  ('S10-ENR-010', 'Have complaints gone up as your number of sites has grown?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-011', 'RC-ENR-050', 2, 'Stage 1→10+'),
  ('S10-ENR-011', 'Did you promise customers a certain output or saving in writing?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-012', 'RC-ENR-051', 2, 'Stage 1→10+'),
  ('S10-ENR-012', 'Do you know if each site is actually delivering what you promised?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-012', 'RC-ENR-052', 3, 'Stage 1→10+'),
  ('S10-ENR-013', 'How do you find out a site is underperforming, from data or from the customer?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-012', 'RC-ENR-053', 2, 'Stage 1→10+'),
  ('S10-ENR-014', 'If every guarantee you gave was claimed, what would it cost you?', 'open_text', 'Financial Management', 'CORE', 'ENR-012', 'RC-ENR-055', 3, 'Stage 1→10+'),
  ('S10-ENR-015', 'Do you have a standard way of handling warranty claims?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-012', 'RC-ENR-054', 2, 'Stage 1→10+'),
  ('S10-ENR-016', 'If net metering or tariff rules changed next year, what happens to your model?', 'open_text', 'Strategy & Planning', 'CORE', 'ENR-013', 'RC-ENR-056', 3, 'Stage 1→10+'),
  ('S10-ENR-017', 'Have you planned for what you would do if the rules changed against you?', 'open_text', 'Strategy & Planning', 'CORE', 'ENR-013', 'RC-ENR-057', 3, 'Stage 1→10+'),
  ('S10-ENR-018', 'Has your dependence on subsidies gone down as you have grown?', 'open_text', 'Strategy & Planning', 'CORE', 'ENR-013', 'RC-ENR-058', 3, 'Stage 1→10+'),
  ('S10-ENR-019', 'How do you keep track of policy and regulation changes?', 'open_text', 'Strategy & Planning', 'CORE', 'ENR-013', 'RC-ENR-059', 2, 'Stage 1→10+'),
  ('S10-ENR-020', 'Could your pricing absorb a change in tariff rules?', 'open_text', 'Financial Management', 'CORE', 'ENR-013', 'RC-ENR-060', 3, 'Stage 1→10+'),
  ('S10-ENR-021', 'What changes when you enter a new state?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-014', 'RC-ENR-061', 2, 'Stage 1→10+'),
  ('S10-ENR-022', 'When did you last discover a local requirement after committing to a project?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-014', 'RC-ENR-062', 2, 'Stage 1→10+'),
  ('S10-ENR-023', 'Do you have someone on the ground in each state you operate in?', 'open_text', 'Operations & Systems', 'CORE', 'ENR-014', 'RC-ENR-063', 2, 'Stage 1→10+'),
  ('S10-ENR-024', 'What share of revenue comes from your top two customers?', 'open_text', 'Sales & Revenue', 'CORE', 'ENR-015', 'RC-ENR-064', 2, 'Stage 1→10+'),
  ('S10-ENR-025', 'If your biggest client left, how long could the business continue?', 'open_text', 'Sales & Revenue', 'CORE', 'ENR-015', 'RC-ENR-066', 3, 'Stage 1→10+')
  ) AS t(question_code, question_text, question_type, category, priority,
         problem_code, root_cause_code, difficulty_level, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  JOIN new_root_causes nr ON nr.root_cause_code = t.root_cause_code
...
new_root_causes AS (
  ...
  ('RC-MED-019', 'No Direct Way for the Audience to Pay', 'There is nothing a follower can buy or support even if they want to.', 'MED-005', 'external', 'Strategic', 0.72, 'Stage 0→1'),
  ('RC-MED-020', 'Income Only Arrives With a Brand', 'The business earns nothing unless a sponsor turns up.', 'MED-005', 'external', 'Strategic', 0.70, 'Stage 0→1'),
  ('RC-MED-021', 'Audience Never Asked for Anything', 'The audience has never been invited to buy, join or support.', 'MED-005', 'external', 'Behavioural', 0.67, 'Stage 0→1'),
  ('RC-MED-022', 'No Owned List or Channel', 'There is no email list or direct channel the creator controls.', 'MED-005', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-MED-023', 'Audience Size Treated as the Goal', 'Growth is chased while revenue is left for later.', 'MED-005', 'external', 'Psychological', 0.65, 'Stage 0→1'),
  ('RC-MED-024', 'All Content Made by One Person', 'Every step from idea to publish sits with the founder.', 'MED-006', 'external', 'Operational', 0.73, 'Stage 0→1'),
  ('RC-MED-025', 'No Second Face or Voice', 'Nobody else appears, so the channel has one point of failure.', 'MED-006', 'external', 'Strategic', 0.68, 'Stage 0→1'),
  ('RC-MED-026', 'Publishing Stops When the Founder Stops', 'Any illness or travel breaks the schedule completely.', 'MED-006', 'external', 'Operational', 0.70, 'Stage 0→1'),
  ('RC-MED-027', 'No Editing or Production Help', 'Post production is entirely on the founder.', 'MED-006', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-MED-028', 'Audience Follows the Person Not the Brand', 'Attachment is to the individual rather than to anything transferable.', 'MED-006', 'external', 'Strategic', 0.66, 'Stage 0→1'),
  ('RC-MED-029', 'Nearly All Reach From One Platform', 'One feed decides whether the content is seen at all.', 'MED-007', 'external', 'Strategic', 0.74, 'Stage 0→1'),
  ('RC-MED-030', 'No Second Platform Built', 'Nothing else has been grown that could carry the audience.', 'MED-007', 'external', 'Strategic', 0.70, 'Stage 0→1'),
  ('RC-MED-031', 'No Owned Audience List', 'There is no way to reach followers if the platform disappears.', 'MED-007', 'external', 'Operational', 0.71, 'Stage 0→1'),
  ('RC-MED-032', 'Views Swing With Algorithm Changes', 'Reach moves sharply for reasons outside anyone control.', 'MED-007', 'external', 'Operational', 0.66, 'Stage 0→1'),
  ('RC-MED-033', 'No Plan If the Account Is Restricted', 'A suspension or strike has no prepared response.', 'MED-007', 'external', 'Strategic', 0.68, 'Stage 0→1'),
  ('RC-MED-034', 'No Rate Card', 'There is no standard price list for sponsorships.', 'MED-008', 'external', 'Operational', 0.71, 'Stage 0→1'),
  ('RC-MED-035', 'Price Negotiated From Zero Each Time', 'Every deal starts with guessing what to ask for.', 'MED-008', 'external', 'Behavioural', 0.69, 'Stage 0→1'),
  ('RC-MED-036', 'No Repeat Deals With the Same Brand', 'Sponsorships end after one campaign with no renewal path.', 'MED-008', 'external', 'Strategic', 0.66, 'Stage 0→1'),
  ('RC-MED-037', 'Deliverables Unclear in Each Deal', 'What the brand receives is agreed loosely and varies.', 'MED-008', 'external', 'Operational', 0.64, 'Stage 0→1'),
  ('RC-MED-038', 'Market Rates Unknown', 'What similar creators charge has never been researched.', 'MED-008', 'external', 'Knowledge', 0.67, 'Stage 0→1'),
  ('RC-MED-039', 'Content Made Just Before Publishing', 'Nothing is produced ahead of the deadline.', 'MED-009', 'external', 'Behavioural', 0.70, 'Stage 0→1'),
  ('RC-MED-040', 'No Buffer of Ready Content', 'There is no stock of finished pieces to fall back on.', 'MED-009', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-MED-041', 'No Written Style or Quality Standard', 'There is no agreed definition of what good looks like here.', 'MED-010', 'external', 'Operational', 0.72, 'Stage 1→10+'),
  ('RC-MED-042', 'Nothing Reviewed Before Publishing', 'Work goes out without anyone checking it against a standard.', 'MED-010', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-MED-043', 'Contributors Onboarded Informally', 'New people learn the style by guessing rather than being taught.', 'MED-010', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-MED-044', 'Output Prioritised Over Consistency', 'Hitting the schedule matters more than holding the bar.', 'MED-010', 'external', 'Behavioural', 0.67, 'Stage 1→10+'),
  ('RC-MED-045', 'Audience Noticing the Difference', 'Viewers are commenting that the work has changed.', 'MED-010', 'external', 'Operational', 0.64, 'Stage 1→10+'),
  ('RC-MED-046', 'Income Stops When Posting Stops', 'Revenue depends entirely on continuing to publish.', 'MED-011', 'external', 'Strategic', 0.73, 'Stage 1→10+'),
  ('RC-MED-047', 'Nothing Owned That Earns Repeatedly', 'No product, format or catalogue generates income on its own.', 'MED-011', 'external', 'Strategic', 0.71, 'Stage 1→10+'),
  ('RC-MED-048', 'No Licensing or Catalogue Revenue', 'Existing content is never licensed or resold anywhere.', 'MED-011', 'external', 'Strategic', 0.67, 'Stage 1→10+'),
  ('RC-MED-049', 'No Format or IP That Could Be Sold', 'Nothing has been built that another party would buy.', 'MED-011', 'external', 'Strategic', 0.66, 'Stage 1→10+'),
  ('RC-MED-050', 'Back Catalogue Earns Almost Nothing', 'Older content sits unused instead of continuing to work.', 'MED-011', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-MED-051', 'No Written Rights for Music or Footage', 'Material is used without documented permission.', 'MED-012', 'external', 'Knowledge', 0.74, 'Stage 1→10+'),
  ('RC-MED-052', 'Contributor Releases Not Collected', 'People who appear on camera have signed nothing.', 'MED-012', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-MED-053', 'Takedowns or Claims Already Received', 'The exposure has already started showing up as claims.', 'MED-012', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-MED-054', 'No Record of What Is Licensed', 'Nobody can say what rights are held and until when.', 'MED-012', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-MED-055', 'Rights Handled Differently by Each Person', 'Every team member follows their own approach to clearance.', 'MED-012', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-MED-056', 'Key Talent Working Without Contracts', 'Central people have no written agreement of any kind.', 'MED-013', 'external', 'Operational', 0.75, 'Stage 1→10+'),
  ('RC-MED-057', 'Unclear Who Owns the Channel and Audience', 'Ownership of the account and following was never agreed.', 'MED-013', 'external', 'Strategic', 0.72, 'Stage 1→10+'),
  ('RC-MED-058', 'No Notice Period or Handover Terms', 'Someone could leave immediately with no transition.', 'MED-013', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-MED-059', 'Talent Approached by Competitors', 'Key people are being actively recruited elsewhere.', 'MED-013', 'external', 'Strategic', 0.66, 'Stage 1→10+'),
  ('RC-MED-060', 'Audience Attached to One Individual', 'The following belongs to a person rather than the brand.', 'MED-013', 'external', 'Strategic', 0.69, 'Stage 1→10+'),
  ('RC-MED-061', 'Platform Policies Never Fully Read', 'Nobody has actually read the rules the business depends on.', 'MED-014', 'external', 'Knowledge', 0.71, 'Stage 1→10+'),
  ('RC-MED-062', 'No Review of Risky Content Before Publishing', 'Sensitive material goes out without a compliance check.', 'MED-014', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-MED-063', 'Large Income Share Exposed to One Policy', 'A single demonetisation decision would hit most of the revenue.', 'MED-014', 'external', 'Strategic', 0.72, 'Stage 1→10+'),
  ('RC-MED-064', 'Decisions Made on Instinct', 'What to make next is chosen by feel rather than evidence.', 'MED-015', 'external', 'Behavioural', 0.70, 'Stage 1→10+'),
  ('RC-MED-065', 'Performance Data Never Analysed', 'Years of data sit unused in the platform dashboard.', 'MED-015', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-MED-066', 'Underperforming Content Repeated', 'The same formats keep being made despite weak results.', 'MED-015', 'external', 'Behavioural', 0.66, 'Stage 1→10+')
  ) AS t(root_cause_code, root_cause_name, explanation, problem_code, layer,
         root_cause_category, confidence_weight, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  CROSS JOIN z
...
new_questions AS (
  ...
  ('S01-MED-001', 'Your audience has grown. Has your income grown with it?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-005', 'RC-MED-023', 2, 'Stage 0→1'),
  ('S01-MED-002', 'Is there any way for a follower to give you money directly today?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-005', 'RC-MED-019', 2, 'Stage 0→1'),
  ('S01-MED-003', 'If no brand sponsored you this year, what would you earn?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-005', 'RC-MED-020', 2, 'Stage 0→1'),
  ('S01-MED-004', 'Have you ever actually asked your audience to buy or support something?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-005', 'RC-MED-021', 2, 'Stage 0→1'),
  ('S01-MED-005', 'Do you have an email list or group you own, outside the platform?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-005', 'RC-MED-022', 2, 'Stage 0→1'),
  ('S01-MED-006', 'If you stopped appearing for a month, what would happen?', 'open_text', 'Operations & Systems', 'CORE', 'MED-006', 'RC-MED-026', 2, 'Stage 0→1'),
  ('S01-MED-007', 'Does anyone else edit, script or publish, or is it all you?', 'open_text', 'Operations & Systems', 'CORE', 'MED-006', 'RC-MED-024', 2, 'Stage 0→1'),
  ('S01-MED-008', 'Has anyone else ever appeared on your channel?', 'open_text', 'Operations & Systems', 'CORE', 'MED-006', 'RC-MED-025', 2, 'Stage 0→1'),
  ('S01-MED-009', 'How many hours a week go into editing and post production?', 'open_text', 'Operations & Systems', 'CORE', 'MED-006', 'RC-MED-027', 2, 'Stage 0→1'),
  ('S01-MED-010', 'Do people follow you, or would they follow the brand without you?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-006', 'RC-MED-028', 3, 'Stage 0→1'),
  ('S01-MED-011', 'What share of your reach comes from one platform feed?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-007', 'RC-MED-029', 2, 'Stage 0→1'),
  ('S01-MED-012', 'Have you built anything on a second platform yet?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-007', 'RC-MED-030', 2, 'Stage 0→1'),
  ('S01-MED-013', 'If your account was restricted tomorrow, how would you reach your audience?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-007', 'RC-MED-031', 3, 'Stage 0→1'),
  ('S01-MED-014', 'How much do your views swing month to month, and do you know why?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-007', 'RC-MED-032', 2, 'Stage 0→1'),
  ('S01-MED-015', 'Do you have any plan for a strike or suspension?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-007', 'RC-MED-033', 3, 'Stage 0→1'),
  ('S01-MED-016', 'How do you decide what to charge a brand?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-008', 'RC-MED-034', 2, 'Stage 0→1'),
  ('S01-MED-017', 'Do you know what creators of your size usually charge?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-008', 'RC-MED-038', 2, 'Stage 0→1'),
  ('S01-MED-018', 'Has any brand worked with you more than once?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-008', 'RC-MED-036', 2, 'Stage 0→1'),
  ('S01-MED-019', 'Do you have content ready in advance, or is it made just before publishing?', 'open_text', 'Operations & Systems', 'CORE', 'MED-009', 'RC-MED-039', 2, 'Stage 0→1'),
  ('S01-MED-020', 'How many finished pieces are sitting ready right now?', 'open_text', 'Operations & Systems', 'CORE', 'MED-009', 'RC-MED-040', 2, 'Stage 0→1'),
  ('S10-MED-001', 'Is there a written standard for what good work looks like here?', 'open_text', 'Operations & Systems', 'CORE', 'MED-010', 'RC-MED-041', 2, 'Stage 1→10+'),
  ('S10-MED-002', 'Does anything get reviewed before it goes out?', 'open_text', 'Operations & Systems', 'CORE', 'MED-010', 'RC-MED-042', 2, 'Stage 1→10+'),
  ('S10-MED-003', 'What does a new contributor get shown before their first piece?', 'open_text', 'Operations & Systems', 'CORE', 'MED-010', 'RC-MED-043', 2, 'Stage 1→10+'),
  ('S10-MED-004', 'When the schedule is tight, what gets sacrificed?', 'open_text', 'Operations & Systems', 'CORE', 'MED-010', 'RC-MED-044', 2, 'Stage 1→10+'),
  ('S10-MED-005', 'Has your audience commented that the work has changed?', 'open_text', 'Operations & Systems', 'CORE', 'MED-010', 'RC-MED-045', 2, 'Stage 1→10+'),
  ('S10-MED-006', 'If you stopped posting for six months, what would you still earn?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-011', 'RC-MED-046', 3, 'Stage 1→10+'),
  ('S10-MED-007', 'Do you own anything that could still earn in three years without new posting?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-011', 'RC-MED-047', 3, 'Stage 1→10+'),
  ('S10-MED-008', 'Has any of your content ever been licensed to someone else?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-011', 'RC-MED-048', 2, 'Stage 1→10+'),
  ('S10-MED-009', 'Is there a format or idea here that another company would buy?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-011', 'RC-MED-049', 3, 'Stage 1→10+'),
  ('S10-MED-010', 'How much does your older content earn compared to new content?', 'open_text', 'Sales & Revenue', 'CORE', 'MED-011', 'RC-MED-050', 2, 'Stage 1→10+'),
  ('S10-MED-011', 'Do you have written rights for all the music, clips and footage you use?', 'open_text', 'Operations & Systems', 'CORE', 'MED-012', 'RC-MED-051', 2, 'Stage 1→10+'),
  ('S10-MED-012', 'Have the people who appear in your content signed anything?', 'open_text', 'Operations & Systems', 'CORE', 'MED-012', 'RC-MED-052', 2, 'Stage 1→10+'),
  ('S10-MED-013', 'Have you received any takedowns or copyright claims?', 'open_text', 'Operations & Systems', 'CORE', 'MED-012', 'RC-MED-053', 2, 'Stage 1→10+'),
  ('S10-MED-014', 'Can you say what you have licensed and until when?', 'open_text', 'Operations & Systems', 'CORE', 'MED-012', 'RC-MED-054', 3, 'Stage 1→10+'),
  ('S10-MED-015', 'Does everyone on your team clear rights the same way?', 'open_text', 'Operations & Systems', 'CORE', 'MED-012', 'RC-MED-055', 2, 'Stage 1→10+'),
  ('S10-MED-016', 'Are your key people on written contracts?', 'open_text', 'Team & Leadership', 'CORE', 'MED-013', 'RC-MED-056', 2, 'Stage 1→10+'),
  ('S10-MED-017', 'Is it clear in writing who owns the channel and the audience?', 'open_text', 'Team & Leadership', 'CORE', 'MED-013', 'RC-MED-057', 3, 'Stage 1→10+'),
  ('S10-MED-018', 'If your main host left tomorrow, what could they take with them?', 'open_text', 'Team & Leadership', 'CORE', 'MED-013', 'RC-MED-060', 3, 'Stage 1→10+'),
  ('S10-MED-019', 'Is there any notice period or handover agreed with key talent?', 'open_text', 'Team & Leadership', 'CORE', 'MED-013', 'RC-MED-058', 2, 'Stage 1→10+'),
  ('S10-MED-020', 'Has anyone on your team been approached by a competitor?', 'open_text', 'Team & Leadership', 'CORE', 'MED-013', 'RC-MED-059', 2, 'Stage 1→10+'),
  ('S10-MED-021', 'Has anyone actually read the platform policies you depend on?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-014', 'RC-MED-061', 2, 'Stage 1→10+'),
  ('S10-MED-022', 'Does risky or sensitive content get checked before publishing?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-014', 'RC-MED-062', 2, 'Stage 1→10+'),
  ('S10-MED-023', 'What share of your income would a demonetisation decision affect?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-014', 'RC-MED-063', 3, 'Stage 1→10+'),
  ('S10-MED-024', 'When you decide what to make next, do you look at data or go by feel?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-015', 'RC-MED-064', 2, 'Stage 1→10+'),
  ('S10-MED-025', 'Which of your formats performs best, and how do you know?', 'open_text', 'Strategy & Planning', 'CORE', 'MED-015', 'RC-MED-065', 2, 'Stage 1→10+')
  ) AS t(question_code, question_text, question_type, category, priority,
         problem_code, root_cause_code, difficulty_level, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  JOIN new_root_causes nr ON nr.root_cause_code = t.root_cause_code
...
new_root_causes AS (
  ...
  ('RC-FSH-019', 'Return Rate Not Measured', 'Nobody tracks what share of orders comes back.', 'FSH-005', 'external', 'Operational', 0.72, 'Stage 0→1'),
  ('RC-FSH-020', 'Return Reasons Never Collected', 'Customers are not asked why they returned, so the cause is never fixed.', 'FSH-005', 'external', 'Operational', 0.70, 'Stage 0→1'),
  ('RC-FSH-021', 'Size Chart Does Not Match the Garment', 'Published measurements differ from the actual stitched piece.', 'FSH-005', 'external', 'Operational', 0.69, 'Stage 0→1'),
  ('RC-FSH-022', 'Photos Not Showing Real Fit', 'Product images do not show how the garment actually sits.', 'FSH-005', 'external', 'Operational', 0.65, 'Stage 0→1'),
  ('RC-FSH-023', 'Cost of a Return Never Calculated', 'What one return really costs has never been worked out.', 'FSH-005', 'external', 'Knowledge', 0.67, 'Stage 0→1'),
  ('RC-FSH-024', 'Equal Quantities Bought Across Sizes', 'Every size is ordered in the same number regardless of demand.', 'FSH-006', 'external', 'Behavioural', 0.71, 'Stage 0→1'),
  ('RC-FSH-025', 'Best Selling Sizes Out of Stock', 'The sizes people actually want run out first and stay out.', 'FSH-006', 'external', 'Operational', 0.69, 'Stage 0→1'),
  ('RC-FSH-026', 'Slow Colours Repeatedly Reordered', 'Colours that do not sell keep being produced again.', 'FSH-006', 'external', 'Behavioural', 0.66, 'Stage 0→1'),
  ('RC-FSH-027', 'Cash Locked in Unsold Variants', 'Money sits in combinations nobody is buying.', 'FSH-006', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-FSH-028', 'Size Ratio Never Analysed', 'Nobody has looked at which sizes actually sold.', 'FSH-006', 'external', 'Knowledge', 0.67, 'Stage 0→1'),
  ('RC-FSH-029', 'No Quality Check Before Accepting a Lot', 'Garments are accepted from the unit without inspection.', 'FSH-007', 'external', 'Operational', 0.72, 'Stage 0→1'),
  ('RC-FSH-030', 'No Written Specification Given to the Unit', 'The maker works from a verbal brief rather than a written spec.', 'FSH-007', 'external', 'Operational', 0.70, 'Stage 0→1'),
  ('RC-FSH-031', 'Fabric Substituted Without Notice', 'The unit changes material without telling anyone.', 'FSH-007', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-FSH-032', 'Complaints About Stitching or Shrinkage', 'Customers are reporting quality failures after washing or wearing.', 'FSH-007', 'external', 'Operational', 0.65, 'Stage 0→1'),
  ('RC-FSH-033', 'Repeat Purchase Rate Never Measured', 'How many customers buy twice is not tracked.', 'FSH-008', 'external', 'Operational', 0.70, 'Stage 0→1'),
  ('RC-FSH-034', 'No Contact After Delivery', 'The relationship ends once the parcel arrives.', 'FSH-008', 'external', 'Behavioural', 0.68, 'Stage 0→1'),
  ('RC-FSH-035', 'No Reason Given to Buy Again', 'Nothing invites the customer back for a second purchase.', 'FSH-008', 'external', 'Strategic', 0.66, 'Stage 0→1'),
  ('RC-FSH-036', 'New Styles Not Shown to Past Buyers', 'Existing customers never hear about new arrivals.', 'FSH-008', 'external', 'Operational', 0.65, 'Stage 0→1'),
  ('RC-FSH-037', 'Growth Depends Entirely on New Customers', 'Every month starts from zero with no returning base.', 'FSH-008', 'external', 'Strategic', 0.67, 'Stage 0→1'),
  ('RC-FSH-038', 'Production Quantity Set on Optimism', 'Quantities are chosen on hope rather than past sales.', 'FSH-009', 'external', 'Behavioural', 0.71, 'Stage 0→1'),
  ('RC-FSH-039', 'Margin After Markdown Never Calculated', 'Nobody works out what is left once discounted stock is counted.', 'FSH-009', 'external', 'Knowledge', 0.69, 'Stage 0→1'),
  ('RC-FSH-040', 'Customers Waiting for the Sale', 'Buyers have learned to hold out for the seasonal discount.', 'FSH-009', 'external', 'Behavioural', 0.67, 'Stage 0→1'),
  ('RC-FSH-041', 'SKU Count Grown Without Review', 'Styles and variants keep being added while nothing is removed.', 'FSH-010', 'external', 'Behavioural', 0.71, 'Stage 1→10+'),
  ('RC-FSH-042', 'No Rule for Retiring a Style', 'There is no moment at which a style is formally dropped.', 'FSH-010', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-FSH-043', 'Forecasting Done Per Style Not Per Variant', 'Planning ignores that demand differs by size and colour.', 'FSH-010', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-FSH-044', 'Long Tail Eating Warehouse Space', 'Slow variants take up room and handling effort.', 'FSH-010', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-FSH-045', 'Most Revenue From Few SKUs', 'A small share of the catalogue carries nearly all sales.', 'FSH-010', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-FSH-046', 'No Comparison of Vendors', 'Units are never measured against each other on price or quality.', 'FSH-011', 'external', 'Operational', 0.71, 'Stage 1→10+'),
  ('RC-FSH-047', 'Lead Times Vary Widely', 'Delivery times differ so much that planning becomes guesswork.', 'FSH-011', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-FSH-048', 'No Vendor Scorecard', 'Nothing records how each unit actually performs.', 'FSH-011', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-FSH-049', 'Volume Allocated by Habit', 'Work goes to the same units regardless of how they perform.', 'FSH-011', 'external', 'Behavioural', 0.66, 'Stage 1→10+'),
  ('RC-FSH-050', 'Quality Differs by Who Made It', 'The same style varies depending on which unit produced it.', 'FSH-011', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-FSH-051', 'Same Product Priced Differently by Channel', 'Prices are inconsistent across store, marketplace and retail.', 'FSH-012', 'external', 'Strategic', 0.72, 'Stage 1→10+'),
  ('RC-FSH-052', 'Marketplace Discounting Undercutting Own Store', 'Platform discounts pull customers away from the direct channel.', 'FSH-012', 'external', 'Strategic', 0.69, 'Stage 1→10+'),
  ('RC-FSH-053', 'Retail Partners Complaining About Online Price', 'Stockists find they cannot compete with the brand own pricing.', 'FSH-012', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-FSH-054', 'No Price Floor Across Channels', 'No minimum price has been set that every channel must respect.', 'FSH-012', 'external', 'Strategic', 0.70, 'Stage 1→10+'),
  ('RC-FSH-055', 'Profit Per Channel Unknown', 'It is not known which channel actually makes money.', 'FSH-012', 'external', 'Knowledge', 0.68, 'Stage 1→10+'),
  ('RC-FSH-056', 'Months of Stock Held at All Times', 'A large amount of inventory sits waiting to sell.', 'FSH-013', 'external', 'Operational', 0.73, 'Stage 1→10+'),
  ('RC-FSH-057', 'Stock Bought Long Before It Sells', 'Money leaves months before revenue arrives.', 'FSH-013', 'external', 'Operational', 0.71, 'Stage 1→10+'),
  ('RC-FSH-058', 'No Limit on Inventory Months', 'Nothing caps how much stock the business will carry.', 'FSH-013', 'external', 'Strategic', 0.69, 'Stage 1→10+'),
  ('RC-FSH-059', 'Growth Increasing Cash Strain', 'Each growth step makes the cash position tighter.', 'FSH-013', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-FSH-060', 'No Factory Compliance Documentation', 'Nothing exists to show how or where garments are made.', 'FSH-014', 'external', 'Operational', 0.72, 'Stage 1→10+'),
  ('RC-FSH-061', 'Labelling Requirements Not Fully Met', 'Legal labelling and care information is incomplete.', 'FSH-014', 'external', 'Knowledge', 0.68, 'Stage 1→10+'),
  ('RC-FSH-062', 'Material or Sustainability Claims Unverified', 'Claims are made about fabric or ethics that cannot be proven.', 'FSH-014', 'external', 'Strategic', 0.70, 'Stage 1→10+'),
  ('RC-FSH-063', 'No Audit of Manufacturing Partners', 'Nobody has checked conditions at the units producing the goods.', 'FSH-014', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-FSH-064', 'Collections Launched on Calendar Not Data', 'Timing is set by season rather than by evidence.', 'FSH-015', 'external', 'Behavioural', 0.70, 'Stage 1→10+'),
  ('RC-FSH-065', 'Past Sell Through Not Reviewed', 'What actually sold last season is not studied before designing.', 'FSH-015', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-FSH-066', 'Best Sellers Not Repeated', 'Proven styles are dropped in favour of new ones each season.', 'FSH-015', 'external', 'Strategic', 0.67, 'Stage 1→10+')
  ) AS t(root_cause_code, root_cause_name, explanation, problem_code, layer,
         root_cause_category, confidence_weight, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  CROSS JOIN z
...
new_questions AS (
  ...
  ('S01-FSH-001', 'Out of every 100 orders, how many come back?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-005', 'RC-FSH-019', 2, 'Stage 0→1'),
  ('S01-FSH-002', 'Do you ask customers why they returned something?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-005', 'RC-FSH-020', 2, 'Stage 0→1'),
  ('S01-FSH-003', 'Have you measured a stitched garment against your own size chart?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-005', 'RC-FSH-021', 2, 'Stage 0→1'),
  ('S01-FSH-004', 'Do your photos show how the garment actually sits on a person?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-005', 'RC-FSH-022', 2, 'Stage 0→1'),
  ('S01-FSH-005', 'What does one return actually cost you in shipping and repacking?', 'open_text', 'Financial Management', 'CORE', 'FSH-005', 'RC-FSH-023', 3, 'Stage 0→1'),
  ('S01-FSH-006', 'Which sizes sell out first, and which are left over every time?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-006', 'RC-FSH-028', 2, 'Stage 0→1'),
  ('S01-FSH-007', 'Do you order the same quantity in every size?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-006', 'RC-FSH-024', 2, 'Stage 0→1'),
  ('S01-FSH-008', 'How often is your best selling size out of stock?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-006', 'RC-FSH-025', 2, 'Stage 0→1'),
  ('S01-FSH-009', 'Are you still reordering colours that never sold well?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-006', 'RC-FSH-026', 2, 'Stage 0→1'),
  ('S01-FSH-010', 'How much money is sitting in stock that is not selling?', 'open_text', 'Financial Management', 'CORE', 'FSH-006', 'RC-FSH-027', 2, 'Stage 0→1'),
  ('S01-FSH-011', 'Does the same style come out the same in every batch?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-007', 'RC-FSH-029', 2, 'Stage 0→1'),
  ('S01-FSH-012', 'Does your manufacturer get a written specification or a verbal brief?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-007', 'RC-FSH-030', 2, 'Stage 0→1'),
  ('S01-FSH-013', 'Has a unit ever changed the fabric without telling you?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-007', 'RC-FSH-031', 2, 'Stage 0→1'),
  ('S01-FSH-014', 'What do customers complain about most after wearing or washing?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-007', 'RC-FSH-032', 2, 'Stage 0→1'),
  ('S01-FSH-015', 'Out of your last 100 orders, how many were repeat customers?', 'open_text', 'Sales & Revenue', 'CORE', 'FSH-008', 'RC-FSH-033', 2, 'Stage 0→1'),
  ('S01-FSH-016', 'Does a customer hear anything from you after the parcel arrives?', 'open_text', 'Sales & Revenue', 'CORE', 'FSH-008', 'RC-FSH-034', 2, 'Stage 0→1'),
  ('S01-FSH-017', 'What reason does a customer have to buy from you again?', 'open_text', 'Sales & Revenue', 'CORE', 'FSH-008', 'RC-FSH-035', 2, 'Stage 0→1'),
  ('S01-FSH-018', 'Do your past buyers get told when new styles arrive?', 'open_text', 'Sales & Revenue', 'CORE', 'FSH-008', 'RC-FSH-036', 2, 'Stage 0→1'),
  ('S01-FSH-019', 'How much of your stock ends up sold at a discount?', 'open_text', 'Financial Management', 'CORE', 'FSH-009', 'RC-FSH-038', 2, 'Stage 0→1'),
  ('S01-FSH-020', 'After your end of season sale, what profit is actually left?', 'open_text', 'Financial Management', 'CORE', 'FSH-009', 'RC-FSH-039', 3, 'Stage 0→1'),
  ('S10-FSH-001', 'How many live SKUs do you have today, and how many did you have two years ago?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-010', 'RC-FSH-041', 2, 'Stage 1→10+'),
  ('S10-FSH-002', 'How many of your SKUs make up most of your sales?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-010', 'RC-FSH-045', 2, 'Stage 1→10+'),
  ('S10-FSH-003', 'Do you have any rule for dropping a style?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-010', 'RC-FSH-042', 2, 'Stage 1→10+'),
  ('S10-FSH-004', 'Do you forecast by style, or by each size and colour separately?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-010', 'RC-FSH-043', 3, 'Stage 1→10+'),
  ('S10-FSH-005', 'How much warehouse space is taken up by slow moving variants?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-010', 'RC-FSH-044', 2, 'Stage 1→10+'),
  ('S10-FSH-006', 'How do your units compare on price, quality and delivery time?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-011', 'RC-FSH-046', 2, 'Stage 1→10+'),
  ('S10-FSH-007', 'How much do lead times vary between your manufacturers?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-011', 'RC-FSH-047', 2, 'Stage 1→10+'),
  ('S10-FSH-008', 'Do you score your vendors on anything, or judge by feel?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-011', 'RC-FSH-048', 2, 'Stage 1→10+'),
  ('S10-FSH-009', 'How do you decide which unit gets which order?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-011', 'RC-FSH-049', 2, 'Stage 1→10+'),
  ('S10-FSH-010', 'Can a customer tell which unit made their garment from the quality?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-011', 'RC-FSH-050', 3, 'Stage 1→10+'),
  ('S10-FSH-011', 'Does the same product sell at different prices in different places?', 'open_text', 'Sales & Revenue', 'CORE', 'FSH-012', 'RC-FSH-051', 2, 'Stage 1→10+'),
  ('S10-FSH-012', 'Is the marketplace discounting below your own store price?', 'open_text', 'Sales & Revenue', 'CORE', 'FSH-012', 'RC-FSH-052', 2, 'Stage 1→10+'),
  ('S10-FSH-013', 'Have retail partners complained about your online pricing?', 'open_text', 'Sales & Revenue', 'CORE', 'FSH-012', 'RC-FSH-053', 2, 'Stage 1→10+'),
  ('S10-FSH-014', 'Is there a minimum price every channel has to respect?', 'open_text', 'Sales & Revenue', 'CORE', 'FSH-012', 'RC-FSH-054', 2, 'Stage 1→10+'),
  ('S10-FSH-015', 'Which channel actually makes you the most profit per piece?', 'open_text', 'Financial Management', 'CORE', 'FSH-012', 'RC-FSH-055', 3, 'Stage 1→10+'),
  ('S10-FSH-016', 'How many months of stock are you holding right now?', 'open_text', 'Financial Management', 'CORE', 'FSH-013', 'RC-FSH-056', 2, 'Stage 1→10+'),
  ('S10-FSH-017', 'How long before a sale does your money go out for that stock?', 'open_text', 'Financial Management', 'CORE', 'FSH-013', 'RC-FSH-057', 3, 'Stage 1→10+'),
  ('S10-FSH-018', 'Is there any limit on how much inventory you will carry?', 'open_text', 'Financial Management', 'CORE', 'FSH-013', 'RC-FSH-058', 2, 'Stage 1→10+'),
  ('S10-FSH-019', 'Does growing sales make your cash position better or worse?', 'open_text', 'Financial Management', 'CORE', 'FSH-013', 'RC-FSH-059', 3, 'Stage 1→10+'),
  ('S10-FSH-020', 'If a buyer asked about your factory labour conditions, could you answer?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-014', 'RC-FSH-060', 3, 'Stage 1→10+'),
  ('S10-FSH-021', 'Are your labels fully compliant with what is legally required?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-014', 'RC-FSH-061', 2, 'Stage 1→10+'),
  ('S10-FSH-022', 'Can you prove the fabric or sustainability claims you make?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-014', 'RC-FSH-062', 3, 'Stage 1→10+'),
  ('S10-FSH-023', 'Has anyone visited or audited the units making your clothes?', 'open_text', 'Operations & Systems', 'CORE', 'FSH-014', 'RC-FSH-063', 2, 'Stage 1→10+'),
  ('S10-FSH-024', 'Do you launch collections because the season says so, or because data says so?', 'open_text', 'Strategy & Planning', 'CORE', 'FSH-015', 'RC-FSH-064', 2, 'Stage 1→10+'),
  ('S10-FSH-025', 'Before designing a new collection, do you review what actually sold?', 'open_text', 'Strategy & Planning', 'CORE', 'FSH-015', 'RC-FSH-065', 2, 'Stage 1→10+')
  ) AS t(question_code, question_text, question_type, category, priority,
         problem_code, root_cause_code, difficulty_level, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  JOIN new_root_causes nr ON nr.root_cause_code = t.root_cause_code
...
new_root_causes AS (
  ...
  ('RC-FNB-019', 'Wastage Percentage Not Measured', 'Nobody tracks how much food is thrown away each week.', 'FNB-005', 'external', 'Operational', 0.72, 'Stage 0→1'),
  ('RC-FNB-020', 'Production Quantity Set on Guesswork', 'How much to make is decided by feel rather than by demand data.', 'FNB-005', 'external', 'Behavioural', 0.70, 'Stage 0→1'),
  ('RC-FNB-021', 'Expiry Discovered Rather Than Planned', 'Stock nearing expiry is noticed too late to do anything with it.', 'FNB-005', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-FNB-022', 'No Use for Near Expiry Stock', 'There is no discount, staff meal or donation route for ageing stock.', 'FNB-005', 'external', 'Strategic', 0.65, 'Stage 0→1'),
  ('RC-FNB-023', 'Cost of Waste Not in Unit Cost', 'Thrown away food is never added into the price of what does sell.', 'FNB-005', 'external', 'Knowledge', 0.68, 'Stage 0→1'),
  ('RC-FNB-024', 'No Standard Recipe Card in the Kitchen', 'Staff cook from memory rather than a fixed written recipe.', 'FNB-006', 'external', 'Operational', 0.72, 'Stage 0→1'),
  ('RC-FNB-025', 'Different Staff Produce Different Results', 'Output depends on who is on shift that day.', 'FNB-006', 'external', 'Operational', 0.70, 'Stage 0→1'),
  ('RC-FNB-026', 'Ingredients Substituted Without Adjustment', 'Replacements are used without changing quantities or method.', 'FNB-006', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-FNB-027', 'No Taste Check Before Dispatch', 'Nothing is tasted or checked before it goes to a customer.', 'FNB-006', 'external', 'Operational', 0.66, 'Stage 0→1'),
  ('RC-FNB-028', 'Complaints About Inconsistency', 'Customers are reporting that it is not the same as last time.', 'FNB-006', 'external', 'Operational', 0.64, 'Stage 0→1'),
  ('RC-FNB-029', 'Most Orders From Delivery Platforms', 'Nearly all demand arrives through one or two apps.', 'FNB-007', 'external', 'Strategic', 0.73, 'Stage 0→1'),
  ('RC-FNB-030', 'Commission Eating Most of the Margin', 'Platform fees take a large share of every order.', 'FNB-007', 'external', 'Operational', 0.71, 'Stage 0→1'),
  ('RC-FNB-031', 'No Direct Ordering Channel', 'There is no way for a customer to order without the app.', 'FNB-007', 'external', 'Strategic', 0.69, 'Stage 0→1'),
  ('RC-FNB-032', 'Customer Details Held by the Platform', 'The brand cannot contact its own buyers.', 'FNB-007', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-FNB-033', 'Discounts Demanded by the Platform', 'Participation in offers is effectively compulsory to stay visible.', 'FNB-007', 'external', 'Strategic', 0.65, 'Stage 0→1'),
  ('RC-FNB-034', 'No Temperature Control in Transit', 'Food travels without any way to keep it at the right temperature.', 'FNB-008', 'external', 'Operational', 0.71, 'Stage 0→1'),
  ('RC-FNB-035', 'Delivery Time Not Tracked', 'How long orders actually take to reach customers is unknown.', 'FNB-008', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-FNB-036', 'Complaints About Condition on Arrival', 'Customers report food arriving warm, leaking or damaged.', 'FNB-008', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-FNB-037', 'No Process When a Delivery Fails', 'Each failed delivery is handled differently and ad hoc.', 'FNB-008', 'external', 'Operational', 0.65, 'Stage 0→1'),
  ('RC-FNB-038', 'Recipe Cost Not Recalculated', 'What a dish costs to make has not been updated as prices moved.', 'FNB-009', 'external', 'Knowledge', 0.72, 'Stage 0→1'),
  ('RC-FNB-039', 'Selling Price Unchanged for Months', 'Prices stay fixed while input costs keep rising.', 'FNB-009', 'external', 'Behavioural', 0.70, 'Stage 0→1'),
  ('RC-FNB-040', 'No Supplier Price Agreements', 'Nothing has been negotiated to hold prices steady.', 'FNB-009', 'external', 'Strategic', 0.66, 'Stage 0→1'),
  ('RC-FNB-041', 'Nothing Written Down to Hand Over', 'The original site runs on knowledge that exists only in peoples heads.', 'FNB-010', 'external', 'Operational', 0.73, 'Stage 1→10+'),
  ('RC-FNB-042', 'Founder Still Needed at the First Site', 'The original outlet cannot run without the founder present.', 'FNB-010', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-FNB-043', 'Different Suppliers Used Per Site', 'Each location buys its own ingredients, so output differs.', 'FNB-010', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-FNB-044', 'New Location Opened Before the First Was Systemised', 'Expansion happened before the original was repeatable.', 'FNB-010', 'external', 'Strategic', 0.71, 'Stage 1→10+'),
  ('RC-FNB-045', 'Customers Noticing the Difference', 'Reviews and feedback show the sites are not the same.', 'FNB-010', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-FNB-046', 'No Regular Hygiene Audits', 'Nobody inspects the kitchens on a fixed schedule.', 'FNB-011', 'external', 'Operational', 0.74, 'Stage 1→10+'),
  ('RC-FNB-047', 'Staff Food Safety Training Informal', 'New staff learn hygiene by watching rather than being trained.', 'FNB-011', 'external', 'Operational', 0.71, 'Stage 1→10+'),
  ('RC-FNB-048', 'No Temperature or Batch Records', 'Nothing is logged that could trace a problem back to its source.', 'FNB-011', 'external', 'Operational', 0.72, 'Stage 1→10+'),
  ('RC-FNB-049', 'No Recall Process', 'There is no plan for pulling a bad batch back from customers.', 'FNB-011', 'external', 'Strategic', 0.70, 'Stage 1→10+'),
  ('RC-FNB-050', 'Licence Renewals Tracked Ad Hoc', 'Renewal dates are remembered rather than managed.', 'FNB-011', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-FNB-051', 'High Kitchen Staff Turnover', 'Cooks and helpers leave frequently.', 'FNB-012', 'external', 'Operational', 0.71, 'Stage 1→10+'),
  ('RC-FNB-052', 'Training Done by Watching Others', 'New staff copy whoever is nearby rather than a standard.', 'FNB-012', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-FNB-053', 'No Documented Station Procedures', 'Each station has no written method to work from.', 'FNB-012', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-FNB-054', 'Skill Concentrated in One or Two People', 'Key capability sits with very few individuals.', 'FNB-012', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-FNB-055', 'Quality Dips After Every Departure', 'Output falls noticeably whenever someone leaves.', 'FNB-012', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-FNB-056', 'Single Supplier for Key Ingredients', 'Critical inputs come from only one source.', 'FNB-013', 'external', 'Operational', 0.73, 'Stage 1→10+'),
  ('RC-FNB-057', 'Seasonal Shortages Disrupt the Menu', 'Items become unavailable at predictable times of year.', 'FNB-013', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-FNB-058', 'No Buffer Stock for Critical Items', 'Nothing is held back against a supply interruption.', 'FNB-013', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-FNB-059', 'No Alternate Supplier Qualified', 'No second source has been tested and approved.', 'FNB-013', 'external', 'Strategic', 0.70, 'Stage 1→10+'),
  ('RC-FNB-060', 'Menu Grown Without Removing Items', 'New dishes keep being added and nothing is taken off.', 'FNB-014', 'external', 'Behavioural', 0.70, 'Stage 1→10+'),
  ('RC-FNB-061', 'Most Revenue From a Few Items', 'A small part of the menu carries nearly all sales.', 'FNB-014', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-FNB-062', 'Slow Items Requiring Dedicated Ingredients', 'Rarely ordered dishes force stock that mostly goes to waste.', 'FNB-014', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-FNB-063', 'No Item Level Profitability Review', 'Nobody knows which dishes make money and which lose it.', 'FNB-014', 'external', 'Knowledge', 0.71, 'Stage 1→10+'),
  ('RC-FNB-064', 'Most New Customers Come From Ratings', 'Demand depends heavily on public review scores.', 'FNB-015', 'external', 'Strategic', 0.71, 'Stage 1→10+'),
  ('RC-FNB-065', 'No Process for Responding to Reviews', 'Negative feedback goes unanswered and unexamined.', 'FNB-015', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-FNB-066', 'Negative Reviews Not Traced to a Cause', 'Complaints are read but never linked back to a kitchen or process issue.', 'FNB-015', 'external', 'Operational', 0.69, 'Stage 1→10+')
  ) AS t(root_cause_code, root_cause_name, explanation, problem_code, layer,
         root_cause_category, confidence_weight, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  CROSS JOIN z
...
new_questions AS (
  ...
  ('S01-FNB-001', 'What percentage of what you make ends up thrown away?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-005', 'RC-FNB-019', 2, 'Stage 0→1'),
  ('S01-FNB-002', 'How do you decide how much to make each day?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-005', 'RC-FNB-020', 2, 'Stage 0→1'),
  ('S01-FNB-003', 'Do you know in advance which stock is close to expiry?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-005', 'RC-FNB-021', 2, 'Stage 0→1'),
  ('S01-FNB-004', 'What do you do with food that is about to expire?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-005', 'RC-FNB-022', 2, 'Stage 0→1'),
  ('S01-FNB-005', 'Is the cost of wasted food included in your pricing?', 'open_text', 'Financial Management', 'CORE', 'FNB-005', 'RC-FNB-023', 3, 'Stage 0→1'),
  ('S01-FNB-006', 'Is there a written recipe card in the kitchen, or is it from memory?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-006', 'RC-FNB-024', 2, 'Stage 0→1'),
  ('S01-FNB-007', 'Does the food taste the same whoever is on shift?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-006', 'RC-FNB-025', 2, 'Stage 0→1'),
  ('S01-FNB-008', 'When an ingredient is unavailable, what happens?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-006', 'RC-FNB-026', 2, 'Stage 0→1'),
  ('S01-FNB-009', 'Does anyone taste or check an order before it is dispatched?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-006', 'RC-FNB-027', 2, 'Stage 0→1'),
  ('S01-FNB-010', 'Do customers ever say it was different from last time?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-006', 'RC-FNB-028', 2, 'Stage 0→1'),
  ('S01-FNB-011', 'What share of your orders comes through delivery apps?', 'open_text', 'Sales & Revenue', 'CORE', 'FNB-007', 'RC-FNB-029', 2, 'Stage 0→1'),
  ('S01-FNB-012', 'After platform commission, how much is left on one order?', 'open_text', 'Financial Management', 'CORE', 'FNB-007', 'RC-FNB-030', 2, 'Stage 0→1'),
  ('S01-FNB-013', 'Can a customer order from you directly without the app?', 'open_text', 'Sales & Revenue', 'CORE', 'FNB-007', 'RC-FNB-031', 2, 'Stage 0→1'),
  ('S01-FNB-014', 'Do you have the contact details of your own customers?', 'open_text', 'Sales & Revenue', 'CORE', 'FNB-007', 'RC-FNB-032', 2, 'Stage 0→1'),
  ('S01-FNB-015', 'Do you join platform discount schemes by choice or because you have to?', 'open_text', 'Sales & Revenue', 'CORE', 'FNB-007', 'RC-FNB-033', 3, 'Stage 0→1'),
  ('S01-FNB-016', 'Does your food stay at the right temperature until it reaches the customer?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-008', 'RC-FNB-034', 2, 'Stage 0→1'),
  ('S01-FNB-017', 'Do you know how long your orders actually take to arrive?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-008', 'RC-FNB-035', 2, 'Stage 0→1'),
  ('S01-FNB-018', 'What do customers complain about most when food arrives?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-008', 'RC-FNB-036', 2, 'Stage 0→1'),
  ('S01-FNB-019', 'When did you last recalculate what a dish costs you to make?', 'open_text', 'Financial Management', 'CORE', 'FNB-009', 'RC-FNB-038', 2, 'Stage 0→1'),
  ('S01-FNB-020', 'When did you last change your prices, and why then?', 'open_text', 'Financial Management', 'CORE', 'FNB-009', 'RC-FNB-039', 2, 'Stage 0→1'),
  ('S10-FNB-001', 'Does your newest location match the quality of your first one?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-010', 'RC-FNB-045', 2, 'Stage 1→10+'),
  ('S10-FNB-002', 'Is there anything written down that a new site could run from?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-010', 'RC-FNB-041', 2, 'Stage 1→10+'),
  ('S10-FNB-003', 'Can your original site run properly without you there?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-010', 'RC-FNB-042', 3, 'Stage 1→10+'),
  ('S10-FNB-004', 'Do all your sites buy from the same suppliers?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-010', 'RC-FNB-043', 2, 'Stage 1→10+'),
  ('S10-FNB-005', 'Was the first site fully systemised before you opened the second?', 'open_text', 'Strategy & Planning', 'CORE', 'FNB-010', 'RC-FNB-044', 3, 'Stage 1→10+'),
  ('S10-FNB-006', 'How often is each kitchen actually inspected for hygiene?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-011', 'RC-FNB-046', 2, 'Stage 1→10+'),
  ('S10-FNB-007', 'What food safety training does a new kitchen hire receive?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-011', 'RC-FNB-047', 2, 'Stage 1→10+'),
  ('S10-FNB-008', 'Do you keep temperature or batch records anywhere?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-011', 'RC-FNB-048', 3, 'Stage 1→10+'),
  ('S10-FNB-009', 'If a bad batch reached customers, what would you do?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-011', 'RC-FNB-049', 3, 'Stage 1→10+'),
  ('S10-FNB-010', 'Who tracks your licence renewal dates?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-011', 'RC-FNB-050', 2, 'Stage 1→10+'),
  ('S10-FNB-011', 'How many kitchen staff have left in the last year?', 'open_text', 'Team & Leadership', 'CORE', 'FNB-012', 'RC-FNB-051', 2, 'Stage 1→10+'),
  ('S10-FNB-012', 'How does a new cook learn your way of making things?', 'open_text', 'Team & Leadership', 'CORE', 'FNB-012', 'RC-FNB-052', 2, 'Stage 1→10+'),
  ('S10-FNB-013', 'Does each station have a written procedure?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-012', 'RC-FNB-053', 2, 'Stage 1→10+'),
  ('S10-FNB-014', 'If your head cook left tomorrow, what would break?', 'open_text', 'Team & Leadership', 'CORE', 'FNB-012', 'RC-FNB-054', 3, 'Stage 1→10+'),
  ('S10-FNB-015', 'Does quality drop for a while after someone leaves?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-012', 'RC-FNB-055', 2, 'Stage 1→10+'),
  ('S10-FNB-016', 'Is there any key ingredient you can only get from one supplier?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-013', 'RC-FNB-056', 2, 'Stage 1→10+'),
  ('S10-FNB-017', 'Which items become hard to get at certain times of year?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-013', 'RC-FNB-057', 2, 'Stage 1→10+'),
  ('S10-FNB-018', 'How many days could you keep operating if a supplier stopped?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-013', 'RC-FNB-058', 3, 'Stage 1→10+'),
  ('S10-FNB-019', 'Have you ever tested a second supplier for your main ingredients?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-013', 'RC-FNB-059', 2, 'Stage 1→10+'),
  ('S10-FNB-020', 'How many items are on your menu now, and how many two years ago?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-014', 'RC-FNB-060', 2, 'Stage 1→10+'),
  ('S10-FNB-021', 'How many of your items make up most of your sales?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-014', 'RC-FNB-061', 2, 'Stage 1→10+'),
  ('S10-FNB-022', 'Which items need special ingredients but rarely get ordered?', 'open_text', 'Operations & Systems', 'CORE', 'FNB-014', 'RC-FNB-062', 2, 'Stage 1→10+'),
  ('S10-FNB-023', 'Do you know which dishes actually make money and which lose it?', 'open_text', 'Financial Management', 'CORE', 'FNB-014', 'RC-FNB-063', 3, 'Stage 1→10+'),
  ('S10-FNB-024', 'What share of your new customers come from ratings and reviews?', 'open_text', 'Sales & Revenue', 'CORE', 'FNB-015', 'RC-FNB-064', 2, 'Stage 1→10+'),
  ('S10-FNB-025', 'When a bad review comes in, what happens next?', 'open_text', 'Sales & Revenue', 'CORE', 'FNB-015', 'RC-FNB-065', 2, 'Stage 1→10+')
  ) AS t(question_code, question_text, question_type, category, priority,
         problem_code, root_cause_code, difficulty_level, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  JOIN new_root_causes nr ON nr.root_cause_code = t.root_cause_code
...
new_root_causes AS (
  ...
  ('RC-GAM-019', 'Retention Not Measured', 'Nobody tracks how many players come back after day one or day seven.', 'GAM-005', 'external', 'Operational', 0.73, 'Stage 0→1'),
  ('RC-GAM-020', 'Most Players Never Finish the Tutorial', 'The opening minutes lose people before the game begins.', 'GAM-005', 'external', 'Operational', 0.71, 'Stage 0→1'),
  ('RC-GAM-021', 'Drop Off Points Unknown', 'Where players quit has never been identified.', 'GAM-005', 'external', 'Knowledge', 0.69, 'Stage 0→1'),
  ('RC-GAM-022', 'Nothing Brings Players Back', 'There is no reason or reminder to return the next day.', 'GAM-005', 'external', 'Strategic', 0.68, 'Stage 0→1'),
  ('RC-GAM-023', 'Growth Measured Only in Installs', 'Success is judged by downloads rather than by players who stay.', 'GAM-005', 'external', 'Behavioural', 0.66, 'Stage 0→1'),
  ('RC-GAM-024', 'Paying Player Share Not Measured', 'What percentage of players spend anything is unknown.', 'GAM-006', 'external', 'Operational', 0.72, 'Stage 0→1'),
  ('RC-GAM-025', 'Nothing Compelling to Buy', 'What is on sale does not matter enough to players.', 'GAM-006', 'external', 'Strategic', 0.70, 'Stage 0→1'),
  ('RC-GAM-026', 'Prices Set by Guesswork', 'Price points were chosen without testing or comparison.', 'GAM-006', 'external', 'Behavioural', 0.67, 'Stage 0→1'),
  ('RC-GAM-027', 'Purchase Moment Badly Placed', 'The buying offer appears before the player cares about it.', 'GAM-006', 'external', 'Operational', 0.68, 'Stage 0→1'),
  ('RC-GAM-028', 'Revenue Per Player Never Calculated', 'Average earnings per player has not been worked out.', 'GAM-006', 'external', 'Knowledge', 0.66, 'Stage 0→1'),
  ('RC-GAM-029', 'No Plan Beyond Launch Day', 'Marketing stopped the day the game went live.', 'GAM-007', 'external', 'Strategic', 0.72, 'Stage 0→1'),
  ('RC-GAM-030', 'No Community Built Before Release', 'Nobody was waiting for the game when it launched.', 'GAM-007', 'external', 'Strategic', 0.70, 'Stage 0→1'),
  ('RC-GAM-031', 'Store Page Treated as an Afterthought', 'The listing, screenshots and description were rushed.', 'GAM-007', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-GAM-032', 'Acquisition Cost Unknown', 'What it costs to get one new player has never been measured.', 'GAM-007', 'external', 'Knowledge', 0.68, 'Stage 0→1'),
  ('RC-GAM-033', 'Growth Stalled After the First Week', 'Nothing sustains installs once launch attention fades.', 'GAM-007', 'external', 'Operational', 0.65, 'Stage 0→1'),
  ('RC-GAM-034', 'Crashes on Common Devices', 'The game fails on hardware many players actually use.', 'GAM-008', 'external', 'Operational', 0.72, 'Stage 0→1'),
  ('RC-GAM-035', 'No Crash Reporting Set Up', 'Failures are invisible because nothing reports them.', 'GAM-008', 'external', 'Operational', 0.70, 'Stage 0→1'),
  ('RC-GAM-036', 'Bugs Found Through Reviews', 'Problems are learned about from angry players, not tools.', 'GAM-008', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-GAM-037', 'No Testing Across Device Types', 'The build is only tested on the team own devices.', 'GAM-008', 'external', 'Operational', 0.69, 'Stage 0→1'),
  ('RC-GAM-038', 'Updates Breaking Working Features', 'New releases introduce failures in parts that were fine.', 'GAM-008', 'external', 'Operational', 0.65, 'Stage 0→1'),
  ('RC-GAM-039', 'No Analytics in the Build', 'The game sends back no information about how it is played.', 'GAM-009', 'external', 'Operational', 0.73, 'Stage 0→1'),
  ('RC-GAM-040', 'Decisions Based on Opinion', 'Changes are made on what the team feels rather than evidence.', 'GAM-009', 'external', 'Behavioural', 0.70, 'Stage 0→1'),
  ('RC-GAM-041', 'No Way to Test a Change', 'There is no method to compare a change against the old version.', 'GAM-009', 'external', 'Operational', 0.67, 'Stage 0→1'),
  ('RC-GAM-042', 'Nearly All Revenue From One Game', 'A single title carries the entire business.', 'GAM-010', 'external', 'Strategic', 0.74, 'Stage 1→10+'),
  ('RC-GAM-043', 'Revenue From That Title Flattening', 'The one earning game has stopped growing or is declining.', 'GAM-010', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-GAM-044', 'No Second Title in Production', 'Nothing is being built that could replace the first.', 'GAM-010', 'external', 'Strategic', 0.72, 'Stage 1→10+'),
  ('RC-GAM-045', 'No Plan If the Game Declines', 'Nothing has been decided for the day revenue drops.', 'GAM-010', 'external', 'Strategic', 0.69, 'Stage 1→10+'),
  ('RC-GAM-046', 'Team Fully Committed to One Product', 'Every person is tied to the single title.', 'GAM-010', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-GAM-047', 'Team Permanently Shipping Events', 'There is no gap between one release and the next.', 'GAM-011', 'external', 'Operational', 0.72, 'Stage 1→10+'),
  ('RC-GAM-048', 'No Content Pipeline Planned Ahead', 'Content is created just before it is needed.', 'GAM-011', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-GAM-049', 'Burnout From Continuous Releases', 'Sustained delivery pressure is exhausting the team.', 'GAM-011', 'external', 'Operational', 0.68, 'Stage 1→10+'),
  ('RC-GAM-050', 'Quality Slipping Under Update Pressure', 'Speed is being bought at the cost of polish and stability.', 'GAM-011', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-GAM-051', 'No Buffer of Ready Content', 'Nothing is finished and waiting in reserve.', 'GAM-011', 'external', 'Operational', 0.65, 'Stage 1→10+'),
  ('RC-GAM-052', 'Nearly All Revenue Through One Store', 'One platform handles distribution and payment for everything.', 'GAM-012', 'external', 'Strategic', 0.74, 'Stage 1→10+'),
  ('RC-GAM-053', 'Store Policy Changes Affecting Income', 'Platform rule changes directly move revenue.', 'GAM-012', 'external', 'Strategic', 0.71, 'Stage 1→10+'),
  ('RC-GAM-054', 'Ranking Drops With No Explanation', 'Discovery can fall without warning or reason given.', 'GAM-012', 'external', 'Operational', 0.67, 'Stage 1→10+'),
  ('RC-GAM-055', 'No Direct Player Relationship', 'The studio cannot reach its own players outside the store.', 'GAM-012', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-GAM-056', 'Payment Rules Set by the Platform', 'Pricing and payment terms are dictated entirely by the store.', 'GAM-012', 'external', 'Strategic', 0.66, 'Stage 1→10+'),
  ('RC-GAM-057', 'Toxic Behaviour in Game or Channels', 'Player conduct is driving others away.', 'GAM-013', 'external', 'Operational', 0.70, 'Stage 1→10+'),
  ('RC-GAM-058', 'Cheating Affecting Fair Play', 'Exploits or cheats are damaging the experience for honest players.', 'GAM-013', 'external', 'Operational', 0.69, 'Stage 1→10+'),
  ('RC-GAM-059', 'No Moderation Policy or Team', 'Nothing defines what is allowed or who enforces it.', 'GAM-013', 'external', 'Operational', 0.71, 'Stage 1→10+'),
  ('RC-GAM-060', 'Community Managed by the Founder', 'Player relations sit personally with the founder.', 'GAM-013', 'external', 'Operational', 0.66, 'Stage 1→10+'),
  ('RC-GAM-061', 'Paid Mechanics Not Checked Against Regulation', 'In game purchase design has never had a legal review.', 'GAM-014', 'external', 'Knowledge', 0.73, 'Stage 1→10+'),
  ('RC-GAM-062', 'Age Rating Requirements Unclear', 'What rating applies and what it demands is not understood.', 'GAM-014', 'external', 'Knowledge', 0.69, 'Stage 1→10+'),
  ('RC-GAM-063', 'Rules Differ by Country and Not Tracked', 'Regulation varies across markets and nobody follows the changes.', 'GAM-014', 'external', 'Knowledge', 0.70, 'Stage 1→10+'),
  ('RC-GAM-064', 'No Plan If a Mechanic Becomes Restricted', 'Nothing is prepared for a paid feature being banned or limited.', 'GAM-014', 'external', 'Strategic', 0.68, 'Stage 1→10+'),
  ('RC-GAM-065', 'Knowledge Concentrated in Few People', 'Critical systems are understood by only one or two developers.', 'GAM-015', 'external', 'Operational', 0.73, 'Stage 1→10+'),
  ('RC-GAM-066', 'No Documentation of Systems', 'How the game works internally exists mostly in memory.', 'GAM-015', 'external', 'Operational', 0.71, 'Stage 1→10+'),
  ('RC-GAM-067', 'Compensation Not Compared to Market', 'Nobody has checked pay against what competitors offer.', 'GAM-015', 'external', 'Knowledge', 0.67, 'Stage 1→10+')
  ) AS t(root_cause_code, root_cause_name, explanation, problem_code, layer,
         root_cause_category, confidence_weight, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  CROSS JOIN z
...
new_questions AS (
  ...
  ('S01-GAM-001', 'Out of 100 people who install, how many are still playing a week later?', 'open_text', 'Sales & Revenue', 'CORE', 'GAM-005', 'RC-GAM-019', 2, 'Stage 0→1'),
  ('S01-GAM-002', 'How many players actually finish your tutorial?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-005', 'RC-GAM-020', 2, 'Stage 0→1'),
  ('S01-GAM-003', 'Do you know at which point most players stop playing?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-005', 'RC-GAM-021', 2, 'Stage 0→1'),
  ('S01-GAM-004', 'What brings a player back the next day?', 'open_text', 'Sales & Revenue', 'CORE', 'GAM-005', 'RC-GAM-022', 2, 'Stage 0→1'),
  ('S01-GAM-005', 'Are you judging success by downloads or by players who stay?', 'open_text', 'Strategy & Planning', 'CORE', 'GAM-005', 'RC-GAM-023', 2, 'Stage 0→1'),
  ('S01-GAM-006', 'What share of your players have ever spent money?', 'open_text', 'Sales & Revenue', 'CORE', 'GAM-006', 'RC-GAM-024', 2, 'Stage 0→1'),
  ('S01-GAM-007', 'What exactly can a player buy, and why would they want it?', 'open_text', 'Sales & Revenue', 'CORE', 'GAM-006', 'RC-GAM-025', 2, 'Stage 0→1'),
  ('S01-GAM-008', 'How did you decide your prices?', 'open_text', 'Sales & Revenue', 'CORE', 'GAM-006', 'RC-GAM-026', 2, 'Stage 0→1'),
  ('S01-GAM-009', 'At what point in the game do you first ask for money?', 'open_text', 'Sales & Revenue', 'CORE', 'GAM-006', 'RC-GAM-027', 2, 'Stage 0→1'),
  ('S01-GAM-010', 'How much does an average player earn you?', 'open_text', 'Financial Management', 'CORE', 'GAM-006', 'RC-GAM-028', 3, 'Stage 0→1'),
  ('S01-GAM-011', 'What was your plan for getting players after launch day?', 'open_text', 'Marketing & Growth', 'CORE', 'GAM-007', 'RC-GAM-029', 2, 'Stage 0→1'),
  ('S01-GAM-012', 'Was anyone waiting for this game before it launched?', 'open_text', 'Marketing & Growth', 'CORE', 'GAM-007', 'RC-GAM-030', 2, 'Stage 0→1'),
  ('S01-GAM-013', 'How much time went into your store page and screenshots?', 'open_text', 'Marketing & Growth', 'CORE', 'GAM-007', 'RC-GAM-031', 2, 'Stage 0→1'),
  ('S01-GAM-014', 'What does it cost you to get one new player?', 'open_text', 'Marketing & Growth', 'CORE', 'GAM-007', 'RC-GAM-032', 3, 'Stage 0→1'),
  ('S01-GAM-015', 'What happened to your installs after the first week?', 'open_text', 'Marketing & Growth', 'CORE', 'GAM-007', 'RC-GAM-033', 2, 'Stage 0→1'),
  ('S01-GAM-016', 'Does your game crash on any common devices?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-008', 'RC-GAM-034', 2, 'Stage 0→1'),
  ('S01-GAM-017', 'Do you get told when the game crashes, or do you find out from reviews?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-008', 'RC-GAM-035', 2, 'Stage 0→1'),
  ('S01-GAM-018', 'How many different devices do you test on before releasing?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-008', 'RC-GAM-037', 2, 'Stage 0→1'),
  ('S01-GAM-019', 'Has an update ever broken something that was working before?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-008', 'RC-GAM-038', 2, 'Stage 0→1'),
  ('S01-GAM-020', 'Does your game send back any data about how people play it?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-009', 'RC-GAM-039', 2, 'Stage 0→1'),
  ('S10-GAM-001', 'What share of your revenue comes from one game?', 'open_text', 'Sales & Revenue', 'CORE', 'GAM-010', 'RC-GAM-042', 2, 'Stage 1→10+'),
  ('S10-GAM-002', 'Is revenue from that game still growing, flat or falling?', 'open_text', 'Sales & Revenue', 'CORE', 'GAM-010', 'RC-GAM-043', 2, 'Stage 1→10+'),
  ('S10-GAM-003', 'Is anything else in production that could earn?', 'open_text', 'Strategy & Planning', 'CORE', 'GAM-010', 'RC-GAM-044', 2, 'Stage 1→10+'),
  ('S10-GAM-004', 'If that game halved in revenue next year, what would you do?', 'open_text', 'Strategy & Planning', 'CORE', 'GAM-010', 'RC-GAM-045', 3, 'Stage 1→10+'),
  ('S10-GAM-005', 'Could you free anyone from the main title to start something new?', 'open_text', 'Team & Leadership', 'CORE', 'GAM-010', 'RC-GAM-046', 3, 'Stage 1→10+'),
  ('S10-GAM-006', 'Is there ever a gap between one release and the next?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-011', 'RC-GAM-047', 2, 'Stage 1→10+'),
  ('S10-GAM-007', 'How far ahead is your content planned?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-011', 'RC-GAM-048', 2, 'Stage 1→10+'),
  ('S10-GAM-008', 'How is the team holding up under the release schedule?', 'open_text', 'Team & Leadership', 'CORE', 'GAM-011', 'RC-GAM-049', 2, 'Stage 1→10+'),
  ('S10-GAM-009', 'Has quality slipped because of update pressure?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-011', 'RC-GAM-050', 2, 'Stage 1→10+'),
  ('S10-GAM-010', 'How much finished content is sitting ready right now?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-011', 'RC-GAM-051', 2, 'Stage 1→10+'),
  ('S10-GAM-011', 'What share of revenue goes through one store?', 'open_text', 'Strategy & Planning', 'CORE', 'GAM-012', 'RC-GAM-052', 2, 'Stage 1→10+'),
  ('S10-GAM-012', 'Has a store policy change ever hit your income?', 'open_text', 'Strategy & Planning', 'CORE', 'GAM-012', 'RC-GAM-053', 2, 'Stage 1→10+'),
  ('S10-GAM-013', 'If your ranking dropped tomorrow, how would you reach players?', 'open_text', 'Strategy & Planning', 'CORE', 'GAM-012', 'RC-GAM-055', 3, 'Stage 1→10+'),
  ('S10-GAM-014', 'Do you have any way to contact your players directly?', 'open_text', 'Strategy & Planning', 'CORE', 'GAM-012', 'RC-GAM-056', 2, 'Stage 1→10+'),
  ('S10-GAM-015', 'Is toxic behaviour driving players away from your game?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-013', 'RC-GAM-057', 2, 'Stage 1→10+'),
  ('S10-GAM-016', 'Is cheating affecting fair play for honest players?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-013', 'RC-GAM-058', 2, 'Stage 1→10+'),
  ('S10-GAM-017', 'Do you have written rules for what is allowed, and someone enforcing them?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-013', 'RC-GAM-059', 2, 'Stage 1→10+'),
  ('S10-GAM-018', 'Who handles your community day to day?', 'open_text', 'Team & Leadership', 'CORE', 'GAM-013', 'RC-GAM-060', 2, 'Stage 1→10+'),
  ('S10-GAM-019', 'Has anyone checked your paid mechanics against current regulation?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-014', 'RC-GAM-061', 3, 'Stage 1→10+'),
  ('S10-GAM-020', 'Do you know what age rating applies and what it requires?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-014', 'RC-GAM-062', 2, 'Stage 1→10+'),
  ('S10-GAM-021', 'Do the rules differ in the countries you sell in, and who tracks that?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-014', 'RC-GAM-063', 3, 'Stage 1→10+'),
  ('S10-GAM-022', 'If one of your paid features was restricted, what would happen?', 'open_text', 'Strategy & Planning', 'CORE', 'GAM-014', 'RC-GAM-064', 3, 'Stage 1→10+'),
  ('S10-GAM-023', 'If your lead developer left tomorrow, what would break?', 'open_text', 'Team & Leadership', 'CORE', 'GAM-015', 'RC-GAM-065', 3, 'Stage 1→10+'),
  ('S10-GAM-024', 'Is how your game works written down anywhere?', 'open_text', 'Operations & Systems', 'CORE', 'GAM-015', 'RC-GAM-066', 2, 'Stage 1→10+'),
  ('S10-GAM-025', 'Do you know what competitors pay people in the same roles?', 'open_text', 'Team & Leadership', 'CORE', 'GAM-015', 'RC-GAM-067', 2, 'Stage 1→10+')
  ) AS t(question_code, question_text, question_type, category, priority,
         problem_code, root_cause_code, difficulty_level, primary_stage_group)
  JOIN new_problems np ON np.problem_code = t.problem_code
  JOIN new_root_causes nr ON nr.root_cause_code = t.root_cause_code
